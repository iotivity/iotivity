...
public enum OCStackResult {
    ...
    OC_STACK_OK, OC_STACK_RESOURCE_CREATED, OC_STACK_RESOURCE_DELETED, OC_STACK_CONTINUE,
    /* Success status code - END HERE */

    /* Error status code - START HERE */
    OC_STACK_INVALID_URI, OC_STACK_INVALID_QUERY, OC_STACK_INVALID_IP, OC_STACK_INVALID_PORT, OC_STACK_INVALID_CALLBACK, OC_STACK_INVALID_METHOD, OC_STACK_INVALID_PARAM, OC_STACK_INVALID_OBSERVE_PARAM, OC_STACK_NO_MEMORY, OC_STACK_COMM_ERROR, OC_STACK_NOTIMPL, OC_STACK_NO_RESOURCE, /*
                                                                                                                                                                                                                                                                                            * resource
                                                                                                                                                                                                                                                                                            * not
                                                                                                                                                                                                                                                                                            * found
                                                                                                                                                                                                                                                                                            */
    OC_STACK_RESOURCE_ERROR, /* ex: not supported method or interface */
    OC_STACK_SLOW_RESOURCE, OC_STACK_REPEATED_REQUEST, OC_STACK_NO_OBSERVERS, /*
                                                                               * resource
                                                                               * has
                                                                               * no
                                                                               * registered
                                                                               * observers
                                                                               */
    OC_STACK_OBSERVER_NOT_FOUND, OC_STACK_VIRTUAL_DO_NOT_HANDLE, OC_STACK_INVALID_OPTION, OC_STACK_MALFORMED_RESPONSE, /*
                                                                                                                        * the
                                                                                                                        * remote
                                                                                                                        * reply
                                                                                                                        * contained
