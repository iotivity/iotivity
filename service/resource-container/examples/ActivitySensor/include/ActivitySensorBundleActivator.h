...
#ifndef ACTIVITYSENSOR_BUNDLE_ACTIVATOR_H_
#define ACTIVITYSENSOR_BUNDLE_ACTIVATOR_H_
...
class ActivitySensorBundleActivator : public BundleActivator
{
    public:
        ActivitySensorBundleActivator();
        ~ActivitySensorBundleActivator();
