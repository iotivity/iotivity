...
#ifndef ACTIVITYSENSORAPP_H_
#define ACTIVITYSENSORAPP_H_
...
class ActivityResource
{
    ...
    public:
        // Constructor
        ActivityResource() : heartrate(INIT_VAL), m_resourceHandle(0)
        {
            m_resourceUri = "/Thing_ActivitySensor";
