...
#ifndef ACNESENSOR_BUNDLE_ACTIVATOR_H_
#define ACNESENSOR_BUNDLE_ACTIVATOR_H_
...
class AcneSensorBundleActivator : public BundleActivator
{
    public:
        AcneSensorBundleActivator();
        ~AcneSensorBundleActivator();
...
#endif /* ACNESENSOR_BUNDLE_ACTIVATOR_H_ */
