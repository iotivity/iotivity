...
#ifndef MOISTSENSORAPP_H_
#define MOISTSENSORAPP_H_
...
#define COAP_SERVICE       OC::ServiceType::InProc

#define RESOURCE_TYPE_NAME "oic.r.sensor.moist"

#define INIT_VAL           30
#define INTERVAL_FOR_CHECK 10
#define INTERVAL_FOR_MEASUREMENT 8
...
class MoistResource
{
    ...
    public:
        MoistResource() : m_moist(INIT_VAL), m_resourceHandle(0)
        {
            m_resourceUri = "/MoistSensor";
