...
#ifndef TEMPSENSORAPP_H_
#define TEMPSENSORAPP_H_
...
#define RESOURCE_TYPE_NAME          "oic.r.sensor.temp"

#define INIT_VAL                    36.5   // default value
...
class TempResource
{
    ...
    public:
        // Constructor
        TempResource() : m_temp(INIT_VAL), m_resourceHandle(0)
        {
            m_resourceUri = "/TempSensor";
