...
void OilResource::registerResource()
{
    ...
    {
        cout << "OilResource creation was unsuccessful\n";
    }
    else
    {
        cout << "OilResource creation is successful" << endl;
    }
}

OCResourceHandle OilResource::getHandle()
{
    return m_resourceHandle;
}

void OilResource::setResourceRepresentation(OCRepresentation &rep)
{
    double tempOil;

    rep.getValue("oil", tempOil);
...
OCRepresentation OilResource::getResourceRepresentation()
{
    m_resourceRep.setValue("oil", std::to_string(m_oil));

    cout << "oil is set to " << m_oil << endl;

    return m_resourceRep;
}

OilResource g_myResource;
...
void *TestSensorVal(void *param)
{
    ...
    std::cout << "[OilSensorAPP] ::" << __func__ << " is called."
              << std::endl;
    ...
    while (1)
    {
        ...
        if (g_Observation)
        {
            ...
            cout << "\n oil updated to : " << g_myResource.m_oil << endl;
...
OCEntityHandlerResult entityHandler(std::shared_ptr< OCResourceRequest > request)
{
    cout << "\tIn Oil Server CPP entity handler:\n";
