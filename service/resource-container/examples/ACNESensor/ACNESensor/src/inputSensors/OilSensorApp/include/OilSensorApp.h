...
#ifndef OILSENSORAPP_H_
#define OILSENSORAPP_H_
...
#define RESOURCE_TYPE_NAME          "oic.r.sensor.oil"

#define INIT_VAL                    50   // default value
...
class OilResource
{
    ...
    public:
        // Constructor
        OilResource() : m_oil(INIT_VAL), m_resourceHandle(0)
        {
            m_resourceUri = "/OilSensor";
