...
#ifndef IASENSOR_BUNDLE_ACTIVATOR_H_
#define IASENSOR_BUNDLE_ACTIVATOR_H_
...
class IASensorBundleActivator : public BundleActivator
{
    public:
        IASensorBundleActivator();
        ~IASensorBundleActivator();
...
#endif /* IASENSOR_BUNDLE_ACTIVATOR_H_ */
