...
#ifndef SYNCHLOCALIZATIONSENSORRESOURCE_H_
#define SYNCHLOCALIZATIONSENSORRESOURCE_H_

#include "SoftSensorResource.h"
#include "SynchLocalizationSensor.h"

using namespace SynchLocalizationSensorName;
using namespace OIC::Service;

class SynchLocalizationSensorResource : public SoftSensorResource
{
    public:
        SynchLocalizationSensorResource();
        ~SynchLocalizationSensorResource();
    ...
    private:
        SynchLocalizationSensor *m_pSynchLocalizationSensor;
