 ...
 */
public class AndroidSoundResource extends AndroidBundleResource {
    private static final String LOG_TAG = AndroidSoundResource.class.getSimpleName();
    public AndroidSoundResource(Context context){
        super(context);
        this.setResourceType("oic.r.sound");
        this.setName("androidSoundResource");
    }
    @Override
