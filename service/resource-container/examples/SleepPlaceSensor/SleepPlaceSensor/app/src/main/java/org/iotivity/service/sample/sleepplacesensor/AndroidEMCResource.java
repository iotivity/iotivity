 ...
 */
public class AndroidEMCResource extends AndroidBundleResource {
    private static final String LOG_TAG = AndroidEMCResource.class.getSimpleName();
    public AndroidEMCResource(Context context){
        super(context);
        this.setResourceType("oic.r.emc");
        this.setName("androidEMCResource");
    }
    @Override
