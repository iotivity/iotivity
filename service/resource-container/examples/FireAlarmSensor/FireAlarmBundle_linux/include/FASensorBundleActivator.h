...
#ifndef FASensor_BUNDLE_ACTIVATOR_H_
#define FASensor_BUNDLE_ACTIVATOR_H_
...
class FASensorBundleActivator : public BundleActivator
{
    public:
        FASensorBundleActivator();
        ~FASensorBundleActivator();
...
#endif /* FASensor_BUNDLE_ACTIVATOR_H_ */
