...
#ifndef FireAlarmSENSORRESOURCE_H_
#define FireAlarmSENSORRESOURCE_H_
...
class FireAlarmSensorResource : public SoftSensorResource
{
    public:
        FireAlarmSensorResource();
        ~FireAlarmSensorResource();
    ...
    private:
        FireAlarmSensor *m_pFireAlarmSensor;
