...
void THLResource::registerResource()
{
...
OCResourceHandle THLResource::getHandle()
{
    return m_resourceHandle;
}

void THLResource::setResourceRepresentation(OCRepresentation &rep)
{
    double tempHumid;
    double tempTemp;
    double tempLight;

    rep.getValue("humidity", tempHumid);
    rep.getValue("temperature", tempTemp);
...
OCRepresentation THLResource::getResourceRepresentation()
{
...
// Create the instance of the THLResource class
THLResource g_myResource;
...
void *TestSensorVal(void *param)
{
    ...
    g_myResource.m_light = 300;

    /* TODO: test function implementation (or not) */
