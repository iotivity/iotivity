 ...
 * MediaSourceOutputResource.
 */

#ifndef SMARTHOME_API_SERVER_MEDIASOURCEOUTPUT_H_
#define SMARTHOME_API_SERVER_MEDIASOURCEOUTPUT_H_
...
namespace OIC
{
    namespace Service
    {
        namespace SH
        {
             ...
             * for MediaSourceOutputResource class
             */
            class MediaSourceOutputResourceDelegate: public MediaSourceResourceDelegate
            {
            public:
                virtual ~MediaSourceOutputResourceDelegate() {}
             ...
             * MediaSourceOutputResource
             */
            class MediaSourceOutputResource: public MediaSourceResource
            {
            public:
                MediaSourceOutputResource();
                virtual ~MediaSourceOutputResource();
                 ...
                 */
                void setDelegate(MediaSourceOutputResourceDelegate *delegate);
            };
        }
    }
}
#endif /* SMARTHOME_API_SERVER_MEDIASOURCEOUTPUT_H_ */
