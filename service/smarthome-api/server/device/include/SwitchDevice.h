...
/**
 * This file contains the declaration of a class and its members related to SwitchDevice.
 */

#ifndef SMARTHOME_API_SERVER_SWITCH_H_
#define SMARTHOME_API_SERVER_SWITCH_H_
...
#endif /* SMARTHOME_API_SERVER_SWITCH_H_ */
