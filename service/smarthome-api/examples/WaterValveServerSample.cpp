...
{
    std::cout << "[WaterValveDevice][OpenLevelResource] onChangeLevel.." << endl;
    return SUCCESS;
}

static WaterValveDevice *myDevice = NULL;
...
int main()
{
    std::cout << "#1. Create Predefined WaterValue Device" << endl;
    myDevice = new WaterValveDevice;
