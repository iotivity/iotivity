...
namespace OC
{
    namespace Cm
    {
        namespace Notification
        {
            ...
            NotificationResponse::NotificationResponse(std::string resourcePath, std::string notificationType, std::string uuid, OC::Cm::Serialization::ISerializable *notificationData)
            {
