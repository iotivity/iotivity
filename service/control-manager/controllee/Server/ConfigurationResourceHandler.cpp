...
#include "ConfigurationResourceHandler.h"

ConfigurationResourceHandler::ConfigurationResourceHandler(
...
bool ConfigurationResourceHandler::handleSyncResource(std::string methodId,
    ...
    if (0 == methodId.compare("GET"))
    {
        if (false
            == OC::Cm::Server::ResourceHandler::SyncResourceHandler::validateRepresentation(
                response, EN_CONFIGURATION))
        {
            statusCode = 404;
            return true;
        }
        this->onGET(statusCode, (::Configuration *) response);
    }
    else if (0 == methodId.compare("PUT"))
    {
        if (false
            == OC::Cm::Server::ResourceHandler::SyncResourceHandler::validateRepresentation(
                request, EN_CONFIGURATION))
        {
            statusCode = 404;
            return true;
        }
        this->onPUT(statusCode, (::Configuration *) request);
    }
    else
    {
        statusCode = 405;
...
bool ConfigurationResourceHandler::onGET(int &statusCode,
...
bool ConfigurationResourceHandler::onPUT(int &statusCode,
