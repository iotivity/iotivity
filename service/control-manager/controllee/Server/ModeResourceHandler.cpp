...
#include "ModeResourceHandler.h"

ModeResourceHandler::ModeResourceHandler(OC::Cm::IContext *pContext) :
    OC::Cm::Server::ResourceHandler::SyncResourceHandler(pContext)
{
}

ModeResourceHandler::~ModeResourceHandler()
{
}

bool ModeResourceHandler::handleSyncResource(std::string methodId,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    if (0 == methodId.compare("GET"))
    {
        ...
        this->onGET(statusCode, (::Mode *) response);
    }
    else if (0 == methodId.compare("PUT"))
    {
        ...
        this->onPUT(statusCode, (::Mode *) request);
    }
    else
    {
        statusCode = 405;
...
bool ModeResourceHandler::onGET(int &statusCode, ::Mode *respData)
{
...
bool ModeResourceHandler::onPUT(int &statusCode, ::Mode *reqData)
{
    // TODO: Autogenerated code. Add Resource implementation here
    // TODO: Default Status Code is: 501 - Not Implemented.  Replace Default Status Code based on implementation!
    statusCode = 501;
