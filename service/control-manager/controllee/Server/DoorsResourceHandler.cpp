...
#include "DoorsResourceHandler.h"

DoorsResourceHandler::DoorsResourceHandler(OC::Cm::IContext *pContext) :
    OC::Cm::Server::ResourceHandler::SyncResourceHandler(pContext)
{
}

DoorsResourceHandler::~DoorsResourceHandler()
{
}

bool DoorsResourceHandler::handleSyncResource(std::string methodId,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    if (0 == methodId.compare("GET"))
    {
        ...
        this->onGET(statusCode, (::Doors *) response);
    }
    else if (0 == methodId.compare("PUT"))
    {
        ...
        this->onPUT(statusCode, (::Doors *) request);
    }
    else
    {
        statusCode = 405 ;
...
bool DoorsResourceHandler::onGET(int &statusCode, ::Doors *respData)
{
...
bool DoorsResourceHandler::onPUT(int &statusCode, ::Doors *reqData)
{
    // TODO: Autogenerated code. Add Resource implementation here
    // TODO: Default Status Code is: 501 - Not Implemented.  Replace Default Status Code based on implementation!
    statusCode = 501;
