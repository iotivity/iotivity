...
#include "AlarmsResourceHandler.h"

AlarmsResourceHandler::AlarmsResourceHandler(OC::Cm::IContext *pContext) :
    OC::Cm::Server::ResourceHandler::SyncResourceHandler(pContext)
{
}

AlarmsResourceHandler::~AlarmsResourceHandler()
{
}

bool AlarmsResourceHandler::handleSyncResource(std::string methodId,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    if (0 == methodId.compare("GET"))
    {
        ...
        this->onGET(statusCode, (::Alarms *) response);
    }
    else
    {
        statusCode = 405;
...
bool AlarmsResourceHandler::onGET(int &statusCode, ::Alarms *respData)
{
