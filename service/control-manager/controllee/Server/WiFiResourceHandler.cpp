...
#include "WiFiResourceHandler.h"

WiFiResourceHandler::WiFiResourceHandler(OC::Cm::IContext *pContext) :
    OC::Cm::Server::ResourceHandler::SyncResourceHandler(pContext)
{
}

WiFiResourceHandler::~WiFiResourceHandler()
{
}

bool WiFiResourceHandler::handleSyncResource(std::string methodId,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    if (0 == methodId.compare("GET"))
    {
        ...
        this->onGET(statusCode, (::WiFi *) response);
    }
    else if (0 == methodId.compare("PUT"))
    {
        ...
        this->onPUT(statusCode, (::WiFi *) request);
    }
    else
    {
        statusCode = 405;
...
bool WiFiResourceHandler::onGET(int &statusCode, ::WiFi *respData)
{
...
bool WiFiResourceHandler::onPUT(int &statusCode, ::WiFi *reqData)
{
    // TODO: Autogenerated code. Add Resource implementation here
    // TODO: Default Status Code is: 501 - Not Implemented.  Replace Default Status Code based on implementation!
    statusCode = 501;
