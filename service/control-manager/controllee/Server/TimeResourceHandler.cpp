...
#include "TimeResourceHandler.h"

TimeResourceHandler::TimeResourceHandler(OC::Cm::IContext *pContext) :
    OC::Cm::Server::ResourceHandler::SyncResourceHandler(pContext)
{
}

TimeResourceHandler::~TimeResourceHandler()
{
}

bool TimeResourceHandler::handleSyncResource(std::string methodId,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    if (0 == methodId.compare("GET"))
    {
        ...
        this->onGET(statusCode, (::Time *) response);
    }
    else if (0 == methodId.compare("PUT"))
    {
        ...
        this->onPUT(statusCode, (::Time *) request);
    }
    else
    {
        statusCode = 405;
...
bool TimeResourceHandler::onGET(int &statusCode, ::Time *respData)
{
...
bool TimeResourceHandler::onPUT(int &statusCode, ::Time *reqData)
{
    // TODO: Autogenerated code. Add Resource implementation here
    // TODO: Default Status Code is: 501 - Not Implemented.  Replace Default Status Code based on implementation!
    statusCode = 501;
