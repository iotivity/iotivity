...
bool DeviceResourceHandler::handleSyncResource(std::string methodId,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    if (0 == methodId.compare("GET"))
    {
        ...
        this->onGET(statusCode, (::Device *) response);
    }
    else if (0 == methodId.compare("PUT"))
    {
        ...
        this->onPUT(statusCode, (::Device *) request);
    }
...
bool DeviceResourceHandler::onGET(int &statusCode, ::Device *respData)
{
    return false;
}

bool DeviceResourceHandler::onPUT(int &statusCode, ::Device *reqData)
{
...
bool DeviceResourceHandler::onDELETE(int &statusCode)
{
    // TODO: Autogenerated code. Add Resource implementation here
    // TODO: Default Status Code is: 501 - Not Implemented.  Replace Default Status Code based on implementation!
    statusCode = 501;
