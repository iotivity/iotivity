...
#include "UsagesResourceHandler.h"

UsagesResourceHandler::UsagesResourceHandler(OC::Cm::IContext *pContext) :
    OC::Cm::Server::ResourceHandler::SyncResourceHandler(pContext)
{
}

UsagesResourceHandler::~UsagesResourceHandler()
{
}

bool UsagesResourceHandler::handleSyncResource(std::string methodId,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    if (0 == methodId.compare("GET"))
    {
        ...
        this->onGET(statusCode, (::Usages *) response);
    }
    else
    {
        statusCode = 405;
...
bool UsagesResourceHandler::onGET(int &statusCode, ::Usages *respData)
{
