...
#include "VersionResourceHandler.h"

VersionResourceHandler::VersionResourceHandler(OC::Cm::IContext *pContext) :
    OC::Cm::Server::ResourceHandler::SyncResourceHandler(pContext)
{
}

VersionResourceHandler::~VersionResourceHandler()
{
}

bool VersionResourceHandler::handleSyncResource(std::string methodId,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    if (0 == methodId.compare("GET"))
    {
        ...
        this->onGET(statusCode, (::Version *) response);
    }
    else if (0 == methodId.compare("PUT"))
    {
        ...
        this->onPUT(statusCode, (::Version *) request);
    }
    else
    {
        statusCode = 405;
...
bool VersionResourceHandler::onGET(int &statusCode, ::Version *respData)
{
...
bool VersionResourceHandler::onPUT(int &statusCode, ::Version *reqData)
{
    // TODO: Autogenerated code. Add Resource implementation here
    // TODO: Default Status Code is: 501 - Not Implemented.  Replace Default Status Code based on implementation!
    statusCode = 501;
