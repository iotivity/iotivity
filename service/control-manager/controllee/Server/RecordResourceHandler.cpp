...
#include "RecordResourceHandler.h"

RecordResourceHandler::RecordResourceHandler(OC::Cm::IContext *pContext) :
    OC::Cm::Server::ResourceHandler::SyncResourceHandler(pContext)
{
}

RecordResourceHandler::~RecordResourceHandler()
{
}

/******************************** NOTE: DO NOT modify below code ********************************/
bool RecordResourceHandler::handleSyncResource(std::string methodId,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    if (0 == methodId.compare("GET"))
    {
        ...
        this->onGET(statusCode, (::Record *) response);
    }
...
bool RecordResourceHandler::onGET(int &statusCode, ::Record *respData)
{
...
bool RecordResourceHandler::onDELETE(int &statusCode)
{
    // TODO: Autogenerated code. Add Resource implementation here
    // TODO: Default Status Code is: 501 - Not Implemented.  Replace Default Status Code based on implementation!
    statusCode = 501;
