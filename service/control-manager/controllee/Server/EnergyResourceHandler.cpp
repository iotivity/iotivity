...
#include "EnergyResourceHandler.h"

EnergyResourceHandler::EnergyResourceHandler(OC::Cm::IContext *pContext) :
    OC::Cm::Server::ResourceHandler::SyncResourceHandler(pContext)
{
}

EnergyResourceHandler::~EnergyResourceHandler()
{
}

bool EnergyResourceHandler::handleSyncResource(std::string methodId,
...
bool EnergyResourceHandler::onGET(int &statusCode,
...
bool EnergyResourceHandler::onPUT(int &statusCode,
