...
#include "NetworkResourceHandler.h"

NetworkResourceHandler::NetworkResourceHandler(OC::Cm::IContext *pContext) :
    OC::Cm::Server::ResourceHandler::SyncResourceHandler(pContext)
{
}

NetworkResourceHandler::~NetworkResourceHandler()
{
}

bool NetworkResourceHandler::handleSyncResource(std::string methodId,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    if (0 == methodId.compare("GET"))
    {
        ...
        this->onGET(statusCode, (::Network *) response);
    }
    else if (0 == methodId.compare("PUT"))
    {
        ...
        this->onPUT(statusCode, (::Network *) request);
    }
    else
    {
        statusCode = 405;
...
bool NetworkResourceHandler::onGET(int &statusCode, ::Network *respData)
{
...
bool NetworkResourceHandler::onPUT(int &statusCode, ::Network *reqData)
{
    // TODO: Autogenerated code. Add Resource implementation here
    // TODO: Default Status Code is: 501 - Not Implemented.  Replace Default Status Code based on implementation!
    statusCode = 501;
