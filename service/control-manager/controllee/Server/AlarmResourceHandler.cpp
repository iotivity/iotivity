...
#include "AlarmResourceHandler.h"

AlarmResourceHandler::AlarmResourceHandler(OC::Cm::IContext *pContext) :
    OC::Cm::Server::ResourceHandler::SyncResourceHandler(pContext)
{
}

AlarmResourceHandler::~AlarmResourceHandler()
{
}

bool AlarmResourceHandler::handleSyncResource(std::string methodId,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    if (0 == methodId.compare("GET"))
    {
        ...
        this->onGET(statusCode, (::Alarm *) response);
    }
    else
    {
        statusCode = 405;
...
bool AlarmResourceHandler::onGET(int &statusCode, ::Alarm *respData)
{
