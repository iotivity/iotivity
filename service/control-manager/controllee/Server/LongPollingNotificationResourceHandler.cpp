...
#include "LongPollingNotificationResourceHandler.h"

LongPollingNotificationResourceHandler::LongPollingNotificationResourceHandler(
...
bool LongPollingNotificationResourceHandler::handleSyncResource(
    std::string methodId, int &statusCode,
    ...
    if (0 == methodId.compare("GET"))
    {
        if (false
            == OC::Cm::Server::ResourceHandler::SyncResourceHandler::validateRepresentation(
                response, EN_LONGPOLLINGNOTIFICATION))
        {
            statusCode = 404;
            return true;
        }
        this->onGET(statusCode, (::LongPollingNotification *) response);
    }
    else
    {
        statusCode = 405;
...
bool LongPollingNotificationResourceHandler::onGET(int &statusCode,
        ::LongPollingNotification *respData)
{
