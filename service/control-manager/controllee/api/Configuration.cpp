...
namespace OC
{
    namespace Cm
    {
        ...
        bool
        Configuration::setSerializableDataFactory(OC::Cm::Serialization::SerializableDataFactory *serializableDataFactory)
        {
        ...
        bool
        Configuration::setResourceHandlerFactory(OC::Cm::Server::ResourceHandler::ResourceHandlerFactory *handlerFactory)
        {
        ...
        void
        Configuration::addDataFormat( std::string contentType,
                                      OC::Cm::Serialization::ISerializer &serializer,
                                      OC::Cm::Serialization::IDeserializer &deserializer)
        {

            m_serializers.insert(std::pair<std::string, OC::Cm::Serialization::ISerializer *>(contentType, &serializer));

            m_deSerializers.insert(std::pair<std::string, OC::Cm::Serialization::IDeserializer *>(contentType, &deserializer));
        }
        ...
        {
            if ((appType != ApplicationType_Controller) && (appType != ApplicationType_Controllable) && (appType != ApplicationType_Both))
            {
                return false;
            }
            m_app_type = appType;
