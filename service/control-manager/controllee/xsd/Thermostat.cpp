...
Thermostat::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("thermostatMode"))
    {
        ...
        if (false == deserializer.getPropertyValue("thermostatMode", &(mpThermostatMode->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  thermostatMode"); return false ;}
    ...
    if (true == deserializer.hasProperty("fanMode"))
    {
        ...
        if (false == deserializer.getPropertyValue("fanMode", &(mpFanMode->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  fanMode"); return false ;}
    ...
    if (true == deserializer.hasProperty("operatingState"))
    {
        ...
        if (false == deserializer.getPropertyValue("operatingState", &(mpOperatingState->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  operatingState"); return false ;}
