...
EnergyConsumption::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("instantaneousPower"))
    {
        ...
        if (false == deserializer.getPropertyValue("instantaneousPower", &(mpInstantaneousPower->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  instantaneousPower"); return false ;}
    ...
    if (true == deserializer.hasProperty("cumulativeConsumption"))
    {
        ...
        if (false == deserializer.getPropertyValue("cumulativeConsumption", &(mpCumulativeConsumption->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  cumulativeConsumption"); return false ;}
    ...
    if (true == deserializer.hasProperty("hourlyConsumption"))
    {
        ...
        if (false == deserializer.getPropertyValue("hourlyConsumption", &(mpHourlyConsumption->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  hourlyConsumption"); return false ;}
    ...
    if (true == deserializer.hasProperty("dailyConsumption"))
    {
        ...
        if (false == deserializer.getPropertyValue("dailyConsumption", &(mpDailyConsumption->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  dailyConsumption"); return false ;}
    ...
    if (true == deserializer.hasProperty("weeklyConsumption"))
    {
        ...
        if (false == deserializer.getPropertyValue("weeklyConsumption", &(mpWeeklyConsumption->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  weeklyConsumption"); return false ;}
    ...
    if (true == deserializer.hasProperty("monthlyConsumption"))
    {
        ...
        if (false == deserializer.getPropertyValue("monthlyConsumption", &(mpMonthlyConsumption->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  monthlyConsumption"); return false ;}
    ...
    if (true == deserializer.hasProperty("usageThreshold"))
    {
        ...
        if (false == deserializer.getPropertyValue("usageThreshold", &(mpUsageThreshold->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  usageThreshold"); return false ;}
