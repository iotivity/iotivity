...
Operation::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("state"))
    {
        ...
        if (false == deserializer.getPropertyValue("state", &(mpState->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  state"); return false ;}
    ...
    if (true == deserializer.hasProperty("progress"))
    {
        ...
        if (false == deserializer.getPropertyValue("progress", &(mpProgress->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  progress"); return false ;}
    ...
    if (true == deserializer.hasProperty("operationTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("operationTime", &(mpOperationTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  operationTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("operationTimeMin"))
    {
        ...
        if (false == deserializer.getPropertyValue("operationTimeMin", &(mpOperationTimeMin->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  operationTimeMin"); return false ;}
    ...
    if (true == deserializer.hasProperty("operationTimeMax"))
    {
        ...
        if (false == deserializer.getPropertyValue("operationTimeMax", &(mpOperationTimeMax->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  operationTimeMax"); return false ;}
    ...
    if (true == deserializer.hasProperty("remainingTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("remainingTime", &(mpRemainingTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  remainingTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("runningTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("runningTime", &(mpRunningTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  runningTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("delayStartTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("delayStartTime", &(mpDelayStartTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  delayStartTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("delayEndTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("delayEndTime", &(mpDelayEndTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  delayEndTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("kidsLock"))
    {
        ...
        if (false == deserializer.getPropertyValue("kidsLock", &(mpKidsLock->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  kidsLock"); return false ;}
    ...
    if (true == deserializer.hasProperty("reset"))
    {
        ...
        if (false == deserializer.getPropertyValue("reset", &(mpReset->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  reset"); return false ;}
