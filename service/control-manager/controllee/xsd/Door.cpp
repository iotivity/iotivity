...
Door::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("openState"))
    {
        ...
        if (false == deserializer.getPropertyValue("openState", &(mpOpenState->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  openState"); return false ;}
    ...
    if (true == deserializer.hasProperty("openElapsedTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("openElapsedTime", &(mpOpenElapsedTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  openElapsedTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("openTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("openTime", &(mpOpenTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  openTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("password"))
    {
        ...
        if (false == deserializer.getPropertyValue("password", &(mpPassword->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  password"); return false ;}
    ...
    if (true == deserializer.hasProperty("oneTimePassword"))
    {
        ...
        if (false == deserializer.getPropertyValue("oneTimePassword", &(mpOneTimePassword->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  oneTimePassword"); return false ;}
