...
bool
ArrayOfUuid::serializeContents(OC::Cm::Serialization::ISerializer &serializer)
{
    bool bRet = true ;

    serializer.startListProperty(this->getInstanceName()) ;

    for ( std::list< OC::Cm::Serialization::Xsd::UuidType >::iterator itr = members.begin(); itr != members.end(); itr++)
    {
...
bool
ArrayOfUuid::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    bool bRet = true ;
