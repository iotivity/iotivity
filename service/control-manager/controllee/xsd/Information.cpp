...
Information::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("manufacturer"))
    {
        ...
        if (false == deserializer.getPropertyValue("manufacturer", &(mpManufacturer->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  manufacturer"); return false ;}
    ...
    if (true == deserializer.hasProperty("deviceSubType"))
    {
        ...
        if (false == deserializer.getPropertyValue("deviceSubType", &(mpDeviceSubType->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  deviceSubType"); return false ;}
    ...
    if (true == deserializer.hasProperty("modelID"))
    {
        ...
        if (false == deserializer.getPropertyValue("modelID", &(mpModelID->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  modelID"); return false ;}
    ...
    if (true == deserializer.hasProperty("serialNumber"))
    {
        ...
        if (false == deserializer.getPropertyValue("serialNumber", &(mpSerialNumber->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  serialNumber"); return false ;}
    ...
    if (true == deserializer.hasProperty("salesLocation"))
    {
        ...
        if (false == deserializer.getPropertyValue("salesLocation", &(mpSalesLocation->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  salesLocation"); return false ;}
