...
Remote::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("authCode"))
    {
        ...
        if (false == deserializer.getPropertyValue("authCode", &(mpAuthCode->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  authCode"); return false ;}
    ...
    if (true == deserializer.hasProperty("accountID"))
    {
        ...
        if (false == deserializer.getPropertyValue("accountID", &(mpAccountID->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  accountID"); return false ;}
    ...
    if (true == deserializer.hasProperty("peerID"))
    {
        ...
        if (false == deserializer.getPropertyValue("peerID", &(mpPeerID->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  peerID"); return false ;}
    ...
    if (true == deserializer.hasProperty("peerGroupID"))
    {
        ...
        if (false == deserializer.getPropertyValue("peerGroupID", &(mpPeerGroupID->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  peerGroupID"); return false ;}
    ...
    if (true == deserializer.hasProperty("countryCode"))
    {
        ...
        if (false == deserializer.getPropertyValue("countryCode", &(mpCountryCode->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  countryCode"); return false ;}
