...
#ifndef ENERGYCONSUMPTIONRESOURCEHANDLER_H_
#define ENERGYCONSUMPTIONRESOURCEHANDLER_H_
...
/**
 * @class   EnergyConsumptionResourceHandler
 * @brief   Defines methods required to handle requests received
 *
 * This class defines methods to handle requests received corresponding to a EnergyConsumption resource.
 */
class EnergyConsumptionResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        EnergyConsumptionResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of EnergyConsumption class.
         */
        virtual ~EnergyConsumptionResourceHandler();
         ...
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[out] respData EnergyConsumption object to be returned to the server through the serializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::EnergyConsumption *respData);

        /**
         * This method will be invoked to handle a PUT request.
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[in] reqData   Received EnergyConsumption object through the deserializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onPUT(int &statusCode, ::EnergyConsumption *reqData);

};

#endif /* ENERGYCONSUMPTIONRESOURCEHANDLER_H_ */
