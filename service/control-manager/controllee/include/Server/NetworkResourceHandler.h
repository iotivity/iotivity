...
#ifndef NETWORKRESOURCEHANDLER_H_
#define NETWORKRESOURCEHANDLER_H_
 ...
 *
 * This class defines methods to handle requests received corresponding to a Network resource.
 */
class NetworkResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        NetworkResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of Network class.
         */
        virtual ~NetworkResourceHandler();
         ...
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[out] respData Network object to be returned to the server through the serializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::Network *respData);

        /**
         * This method will be invoked to handle a PUT request.
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[in] reqData   Received Network object through the deserializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onPUT(int &statusCode, ::Network *reqData);

};

#endif /* NETWORKRESOURCEHANDLER_H_ */
