...
#ifndef TEMPERATURESRESOURCEHANDLER_H_
#define TEMPERATURESRESOURCEHANDLER_H_
...
/**
 * @class   TemperaturesResourceHandler
 * @brief   Defines methods required to handle requests received
 *
 * This class defines methods to handle requests received corresponding to a Temperatures resource.
 */
class TemperaturesResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        TemperaturesResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of Temperatures class.
         */
        virtual ~TemperaturesResourceHandler();
         ...
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[out] respData Temperatures object to be returned to the server through the serializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::Temperatures *respData);

        /**
         * This method will be invoked to handle a PUT request.
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[in] reqData   Received Temperatures object through the deserializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onPUT(int &statusCode, ::Temperatures *reqData);

};

#endif /* TEMPERATURESRESOURCEHANDLER_H_ */
