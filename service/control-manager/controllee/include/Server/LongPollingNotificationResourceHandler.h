...
#ifndef LONGPOLLINGNOTIFICATIONRESOURCEHANDLER_H_
#define LONGPOLLINGNOTIFICATIONRESOURCEHANDLER_H_
...
/**
 * @class   LongPollingNotificationResourceHandler
 * @brief   Defines methods required to handle requests received
 *
 * This class defines methods to handle requests received corresponding to a LongPollingNotification resource.
 */
class LongPollingNotificationResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        LongPollingNotificationResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of LongPollingNotification class.
         */
        virtual ~LongPollingNotificationResourceHandler();
         ...
         * @param[in] session   Server session to which the request belongs
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[out] respData LongPollingNotification object to be returned to the server through the serializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::LongPollingNotification *respData);

};

#endif /* LONGPOLLINGNOTIFICATIONRESOURCEHANDLER_H_ */
