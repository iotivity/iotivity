...
#ifndef ENERGYRESOURCEHANDLER_H_
#define ENERGYRESOURCEHANDLER_H_
...
/**
 * @class   EnergyResourceHandler
 * @brief   Defines methods required to handle requests received
 *
 * This class defines methods to handle requests received corresponding to a Energy resource.
 */
class EnergyResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        EnergyResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of Energy class.
         */
        virtual ~EnergyResourceHandler();
...
#endif /* ENERGYRESOURCEHANDLER_H_ */
