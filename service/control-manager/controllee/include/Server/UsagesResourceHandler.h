...
#ifndef USAGESRESOURCEHANDLER_H_
#define USAGESRESOURCEHANDLER_H_
...
/**
 * @class   UsagesResourceHandler
 * @brief   Defines methods required to handle requests received
 *
 * This class defines methods to handle requests received corresponding to a Usages resource.
 */
class UsagesResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        UsagesResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of Usages class.
         */
        virtual ~UsagesResourceHandler();
         ...
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[out] respData Usages object to be returned to the server through the serializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::Usages *respData);

};

#endif /* USAGESRESOURCEHANDLER_H_ */
