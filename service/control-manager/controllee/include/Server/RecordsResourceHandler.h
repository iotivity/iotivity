...
#ifndef RECORDSRESOURCEHANDLER_H_
#define RECORDSRESOURCEHANDLER_H_
...
/**
 * @class   RecordsResourceHandler
 * @brief   Defines methods required to handle requests received
 *
 * This class defines methods to handle requests received corresponding to a Records resource.
 */
class RecordsResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        RecordsResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of Records class.
         */
        virtual ~RecordsResourceHandler();
         ...
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[out] respData Records object to be returned to the server through the serializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::Records *respData);
...
#endif /* RECORDSRESOURCEHANDLER_H_ */
