...
#ifndef DRLCRESOURCEHANDLER_H_
#define DRLCRESOURCEHANDLER_H_
...
/**
 * @class   DRLCResourceHandler
 * @brief   Defines methods required to handle requests received
 *
 * This class defines methods to handle requests received corresponding to a DRLC resource.
 */
class DRLCResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        DRLCResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of DRLC class.
         */
        virtual ~DRLCResourceHandler();
         ...
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[out] respData DRLC object to be returned to the server through the serializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::DRLC *respData);

        /**
         * This method will be invoked to handle a PUT request.
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[in] reqData   Received DRLC object through the deserializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onPUT(int &statusCode, ::DRLC *reqData);

};

#endif /* DRLCRESOURCEHANDLER_H_ */
