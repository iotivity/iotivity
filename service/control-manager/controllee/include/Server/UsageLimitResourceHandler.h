...
#ifndef USAGELIMITRESOURCEHANDLER_H_
#define USAGELIMITRESOURCEHANDLER_H_
...
#include "Elements.h"
/**
 * @class   UsageLimitResourceHandler
 * @brief   Defines methods required to handle requests received
 *
 * This class defines methods to handle requests received corresponding to a UsageLimit resource.
 */
class UsageLimitResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        UsageLimitResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of UsageLimit class.
         */
        virtual ~UsageLimitResourceHandler();
         ...
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[out] respData UsageLimit object to be returned to the server through the serializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::UsageLimit *respData);

        /**
         * This method will be invoked to handle a PUT request.
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[in] reqData   Received UsageLimit object through the deserializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onPUT(int &statusCode, ::UsageLimit *reqData);
...
#endif /* USAGELIMITRESOURCEHANDLER_H_ */
