...
#ifndef CONFIGURATIONRESOURCEHANDLER_H_
#define CONFIGURATIONRESOURCEHANDLER_H_
...
/**
 * @class   ConfigurationResourceHandler
 * @brief   Defines methods required to handle requests received
 *
 * This class defines methods to handle requests received corresponding to a Configuration resource.
 */
class ConfigurationResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         * @return -none
         */
        ConfigurationResourceHandler(OC::Cm::IContext *pContext);
         ...
         * @return -none
         */
        virtual ~ConfigurationResourceHandler();
         ...
         * @return type:bool True If the request is properly handled, False In case of any error occurred
         */
        bool onGET(int &statusCode, ::Configuration *respData);
         ...
         * @return type:bool True If the request is properly handled, False In case of any error occurred
         */
        bool onPUT(int &statusCode, ::Configuration *reqData);

};

#endif /* CONFIGURATIONRESOURCEHANDLER_H_ */
