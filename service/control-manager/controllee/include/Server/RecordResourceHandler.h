...
#ifndef RECORDRESOURCEHANDLER_H_
#define RECORDRESOURCEHANDLER_H_
...
/**
 * @class   RecordResourceHandler
 * @brief   Defines methods required to handle requests received
 *
 * This class defines methods to handle requests received corresponding to a Record resource.
 */
class RecordResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        RecordResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of Record class.
         */
        virtual ~RecordResourceHandler();
         ...
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[out] respData Record object to be returned to the server through the serializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::Record *respData);
...
#endif /* RECORDRESOURCEHANDLER_H_ */
