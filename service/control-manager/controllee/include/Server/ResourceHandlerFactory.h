    ...
    namespace Cm
    {
        namespace Server
        {
            namespace ResourceHandler
            {
                 ...
                 *
                 * SHP-SDK generates a empty resource handler stubs which extends OC::Cm::Server::ResourceHandler::IResourceHandler
                 * class. Developers can use these empty resource handler stubs to implement Resource handlers
                 *
                 * SHP-SDK also generates a class which extends ResourceHandlerFactory class. This class can instantiate the generated
                ...
                class ResourceHandlerFactory
                {
                    public:
                         ...
                         * returns instance of a resource handler class which is related to specified resource.
                         *
                         * @param[in] handler   The instance to the handler to delete
                         * @param[in] resourceType  Represents the type of the resource
                         *
                         * @return instance of a resource handler
                         */
                    ...
                    protected:
                        ...
                        OC::Cm::IContext *p_context; /**< Represents the instance of the SHP Context where SHP has started */
                };
            }
        }
    }
