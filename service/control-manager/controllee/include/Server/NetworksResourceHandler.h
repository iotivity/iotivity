...
#ifndef NETWORKSRESOURCEHANDLER_H_
#define NETWORKSRESOURCEHANDLER_H_
 ...
 */
class NetworksResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        NetworksResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of Networks class.
         */
        virtual ~NetworksResourceHandler();
         ...
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::Networks *respData);
         ...
         *          @c False In case of any error occurred
         */
        bool onPUT(int &statusCode, ::Networks *reqData);

};

#endif /* NETWORKSRESOURCEHANDLER_H_ */
