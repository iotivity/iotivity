...
#ifndef DOORRESOURCEHANDLER_H_
#define DOORRESOURCEHANDLER_H_
...
/**
 * @class   DoorResourceHandler
 * @brief   Defines methods required to handle requests received
 *
 * This class defines methods to handle requests received corresponding to a Door resource.
 */
class DoorResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        DoorResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of Door class.
         */
        virtual ~DoorResourceHandler();
         ...
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[out] respData Door object to be returned to the server through the serializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::Door *respData);
         ...
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[in] reqData   Received Door object through the deserializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onPUT(int &statusCode, ::Door *reqData);

};

#endif /* DOORRESOURCEHANDLER_H_ */
