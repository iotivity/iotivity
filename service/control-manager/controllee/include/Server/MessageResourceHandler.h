...
#ifndef MESSAGERESOURCEHANDLER_H_
#define MESSAGERESOURCEHANDLER_H_
 ...
 *
 * This class defines methods to handle requests received corresponding to a Message resource.
 */
class MessageResourceHandler: public OC::Cm::Server::ResourceHandler::SyncResourceHandler
{
    ...
    public:
         ...
         */
        MessageResourceHandler(OC::Cm::IContext *pContext);

        /**
         * Default virtual destructor of Message class.
         */
        virtual ~MessageResourceHandler();
         ...
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[out] respData Message object to be returned to the server through the serializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onGET(int &statusCode, ::Message *respData);

        /**
         * This method will be invoked to handle a PUT request.
         *
         * @param[out] statusCode   Http status code to be returned to the client
         * @param[in] reqData   Received Message object through the deserializer. This object should not be re-initialized by a user.
         *
         * @return  @c True If the request is properly handled @n
         *          @c False In case of any error occurred
         */
        bool onPUT(int &statusCode, ::Message *reqData);
...
#endif /* MESSAGERESOURCEHANDLER_H_ */
