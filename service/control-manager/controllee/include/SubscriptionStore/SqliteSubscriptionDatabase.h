...
namespace OC
{
    namespace Cm
    {
        namespace Notification
        {
             ...
             */
            class SqliteSubscriptionDatabase : public ISubscriptionDB
            {
                ...
                public:
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    virtual bool savePendingMySubscription( int requestId, OC::Cm::Notification::SubscriptionRecord &subscription ) ;
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    virtual bool updateMySubscriptionBySubscriptionUri( std::string &subscriptionUri, std::string &resourcePaths ) ;
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    virtual bool deleteMySubscriptionBySubscriptionUri( std::string &deviceId, std::string &subscriptionUri ) ;
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    virtual bool getMySubscriptionByDeviceId( std::string &deviceId, std::list<OC::Cm::Notification::SubscriptionRecord>& subscriptions ) ;
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    virtual bool getMySubscriptionByResourcePaths(std::string &deviceId, std::string &subscribedResourcePath,
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    virtual bool getMySubscriptionContainingResourceList( std::string deviceUUID, std::list<std::string> resourcePathList,
                ...
                private:
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    bool executeSQLSelectStatement( std::string sqlQueryStr, std::list<OC::Cm::Notification::SubscriptionRecord>& subscriptions ) ;
