        ...
        namespace Notification
        {
            ...
            class ISubscriptionDB
            {
                ...
                public:
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    virtual bool savePendingMySubscription( int requestId, OC::Cm::Notification::SubscriptionRecord &subscription ) = 0;
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    virtual bool updateMySubscriptionBySubscriptionUri( std::string &subscriptionUri, std::string &resourcePaths ) = 0;
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    virtual bool deleteMySubscriptionBySubscriptionUri( std::string &deviceId, std::string &subscriptionUri ) = 0;
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    virtual bool getMySubscriptionByDeviceId( std::string &deviceId, std::list<OC::Cm::Notification::SubscriptionRecord>& subscriptions ) = 0;
                     ...
                     * @return Returns  @c true if success@n    @c false if failure
                     */
                    virtual bool getSubscriptions(std::list<OC::Cm::Notification::SubscriptionRecord>& subscriptions) = 0;
            };
