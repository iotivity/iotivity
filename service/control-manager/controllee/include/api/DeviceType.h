...
namespace OC
{
    namespace Cm
    {
        extern const char *DeviceType_Strings[]; /**< Represents array of supported device type strings */

        /**
         * @enum        DeviceType
         * @brief       This enumeration defines types of devices. To add a new device to SHP, developer needs to add the device to DeviceType enumeration.
         *          This enumeration consists of all devices supported by SHP and can be a Controller or Controllable or Both.
         */
        enum DeviceType
        {
