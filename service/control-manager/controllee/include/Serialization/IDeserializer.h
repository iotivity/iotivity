...
namespace OC
{
    namespace Cm
    {
        namespace Serialization
        {
             ...
             *              This interface defines methods of a deserializer. SHP framework uses deserializer
             *              to parse request/response payload data. SHP framework implements an internal JSON deserializer
            ...
            class IDeserializer
            {
                ...
                public:
                    ...
                    /**
                     * This method will return the instance of IContext where SHP is running on.
                     *
                ...
                private:
                    ...
                    IContext *p_context ; /**< Represents instance of SHP Context */
