...
namespace OC
{
    namespace Cm
    {
        namespace Notification
        {
             ...
             * @brief       Listener for SHP Notifications which are subscribed
             *
             * @since       1.0
             *
             * This interface provides listener methods to receive SHP Notifications.
             ...
             * SHP-SDK. SHP-SDK also generates resource specific listener interfaces. It is advisable to use
            ...
            class INotificationListener
            {
                ...
                public:
                    ...
                    /**
                     * Listener for SHP Notifications
                     *
                     ...
                     * by SHP SDK using  OC::Cm::Serialization::ISerializable::getElementName().
                     *
                    ...
                    virtual void onNotificationReceived(std::string &uuid,
                                                        std::string &resource, std::string &eventType,
                                                        OC::Cm::Serialization::ISerializable *notification,
