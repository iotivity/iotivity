...
#ifndef ACCESSPOINTS_H_
#define ACCESSPOINTS_H_
...
class AccessPoints: public ::List
{
    public:
        ...
        /**
         * Default virtual destructor of AccessPoints class.
         */
        ...
        /**
         * Creates a new AccessPoints object of the same class as this object. It then initializes each of the new object's fields by assigning it the same value as the corresponding field in this object.
         *
         * @param[out] pSrcObject   Source AccessPoints object to be cloned.
         *
         * @return  @c True if cloning is successful @n
         *          @c False if cloning is failed
         */
        bool clone(::AccessPoints *pSrcObject);
        std::list< ::AccessPoint * >     mpAccessPoint;
};

#endif /* ACCESSPOINTS_H_ */
