...
class Messages: public ::List
{
    public:
        ...
        /**
         * Creates a new Messages object of the same class as this object. It then initializes each of the new object's fields by assigning it the same value as the corresponding field in this object.
         *
