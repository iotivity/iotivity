...
class List: public ::Resource
{
    public:
        ...
        /**
         * Default virtual destructor of List class.
         */
        virtual ~List();

        /**
         * Serializes the contents of List object.
         *
        ...
        /**
         * Deserializes data and prepares the List object contents.
         *
        ...
        /**
         * Creates a new List object of the same class as this object. It then initializes each of the new object's fields by assigning it the same value as the corresponding field in this object.
         *
         * @param[out] pSrcObject   Source List object to be cloned.
         *
         * @return  @c True if cloning is successful @n
         *          @c False if cloning is failed
         */
        bool clone(::List *pSrcObject);
};
