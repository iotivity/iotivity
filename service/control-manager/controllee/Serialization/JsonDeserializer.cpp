            ...
            namespace Serialization
            {
                namespace Json
                {
                    ...
                    bool JsonDeserializer::getDoublePropertyValue(string propertyName, double &propValue)
                    {
                        ...
                        if (currentPropertyValue.isDouble() || currentPropertyValue.isInt() || currentPropertyValue.isUInt())
                        {
...
//  }
                    ...
                    bool
                    JsonDeserializer::getArrayPropertyValue(std::string arrayName, std::string propertyName, int index, std::string &value)
                    {
                    ...
                    bool
                    JsonDeserializer::getArrayPropertyValue(std::string arrayName, std::string propertyName, int index, bool &value)
                    {
                        const ::Json::Value array = root[arrayName];
