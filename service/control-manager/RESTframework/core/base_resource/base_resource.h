...
#ifndef WEBSERVICE_BASE_RESOURCE_H_
#define WEBSERVICE_BASE_RESOURCE_H_
...
namespace webservice
{
    ...
    class BaseResource : public IHTTPMethod
    {
        public:
            BaseResource(void);
    ...
    {
        public:
            RegisterResource(std::string uri_name, BaseResource * (*pCreateFunc)())
            {
                CreatorResource &creator = CreatorResource::GetInstance();
...
#endif /* WEBSERVICE_BASE_RESOURCE_H_ */