...
#ifndef WEBSERVICE_SIMPLE_LIST_H_
#define WEBSERVICE_SIMPLE_LIST_H_
...
namespace webservice
{
    ...
    class SimpleList : public BaseSimpleObject
    {
        public:
            /**
              * Constructor
              ...
              */
            SimpleList(std::string key_str, std::string str) : BaseSimpleObject(key_str, str) {}
...
#endif /* WEBSERVICE_SIMPLE_LIST_H_ */