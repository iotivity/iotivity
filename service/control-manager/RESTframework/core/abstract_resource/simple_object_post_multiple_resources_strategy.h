...
#ifndef WEBSERVICE_SIMPLE_OBJECT_MULTIPLE_POST_STRATEGY_H_
#define WEBSERVICE_SIMPLE_OBJECT_MULTIPLE_POST_STRATEGY_H_
...
namespace webservice
{
    ...
    class SimpleObjectPostMultipleResourcesStrategy : public ISimpleObjectStrategy
    {
        public:
            /**
              * Destructor
              */
            virtual ~SimpleObjectPostMultipleResourcesStrategy(void) {}
...
#endif /* WEBSERVICE_SIMPLE_OBJECT_MULTIPLE_POST_STRATEGY_H_ */
