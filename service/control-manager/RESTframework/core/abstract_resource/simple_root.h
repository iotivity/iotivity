...
#ifndef WEBSERVICE_SIMPLE_ROOT_H_
#define WEBSERVICE_SIMPLE_ROOT_H_
...
namespace webservice
{
    ...
    class IHTTPMethod;  /* Forward Declaration */
    class SimpleRoot : public BaseSimpleObject
    {
        public:
            /**
              * Destructor
              */
            virtual ~SimpleRoot(void) {}
            /**
              * Get the instance of this object
              * @return SimpleRoot&
              */
            static SimpleRoot &GetInstance(void);
        ...
        private:
            ...
            SimpleRoot(std::string key_str, std::string str) : BaseSimpleObject(key_str, str) {}
            /* Block cloning */
            SimpleRoot(const SimpleRoot &);
            /* Block cloning using operator = */
            void operator= (const SimpleRoot &);
    };
}

#endif /* WEBSERVICE_SIMPLE_ROOT_H_ */