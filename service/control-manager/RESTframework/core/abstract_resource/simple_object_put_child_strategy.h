...
#ifndef WEBSERVICE_SIMPLE_OBJECT_PUT_CHILD_STRATEGY_H_
#define WEBSERVICE_SIMPLE_OBJECT_PUT_CHILD_STRATEGY_H_
...
namespace webservice
{
    ...
    class SimpleObjectPutChildStrategy : public ISimpleObjectStrategy
    {
        public:
            virtual ~SimpleObjectPutChildStrategy(void) {}
...
#endif /* WEBSERVICE_SIMPLE_OBJECT_PUT_CHILD_STRATEGY_H_ */
