...
namespace webservice
{
    ...
    /**
      ...
      */
    CreatorLinkedChild &CreatorLinkedChild::GetInstance()
    {
        static CreatorLinkedChild instance;
        return instance;
    }
    ...
    /**
      ...
      * @return void
      */
    void CreatorLinkedChild::RegisterObject( std::string name, Creator creator )
    {
    ...
    /**
      ...
      */
    BaseLinkedChild *CreatorLinkedChild::CreateObject(std::string name)
    {
        BaseLinkedChild *p = 0;
