...
namespace webservice
{
    ...
    /**
      ...
      */
    IHTTPMethod *SimpleResource::CreateObject(std::string option = "")
    {
        DLOG(INFO) << "SimpleResource::CreateObject";

        CreatorResource &factory = CreatorResource::GetInstance();
    ...
    /**
      ...
      */
    const SimpleObjectType SimpleResource::GetSimpleObjectType()
    {
        return enSimpleResource;
    }
    ...
    /**
      ...
      * @return void
      */
    void SimpleResource::SetChildResponseBody(base::Value *p_value, base::Value *p_value_child,
    ...
    /**
      ...
      */
    HTTPResponseType SimpleResource::ProcessRequest(const HTTPRequestLine &request_line,
            ...
            std::map<std::string, std::string> &id_deps, const std::string &current_uri)
    {
        ...
        IHTTPMethod *pObj = NULL;

        // Set Origin URI
        const std::string &origin_uri = request_line.GetOriginUri();
        DLOG(ERROR) << "Origin Uri : " << origin_uri << ", Current Uri : " << current_uri;
        ...
        if (NULL == pObj) return RT_501_RESOURCE_OBJECT;
        response_error_code = pObj->ProcessHTTPRequestMethod(request_line, request_header, request_body,
