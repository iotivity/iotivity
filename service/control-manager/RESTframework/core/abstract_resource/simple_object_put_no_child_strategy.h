...
#ifndef WEBSERVICE_SIMPLE_OBJECT_PUT_NO_CHILD_STRATEGY_H_
#define WEBSERVICE_SIMPLE_OBJECT_PUT_NO_CHILD_STRATEGY_H_
...
namespace webservice
{
    ...
    class SimpleObjectPutNoChildStrategy : public ISimpleObjectStrategy
    {
        public:
            /**
              * Destructor
              */
            virtual ~SimpleObjectPutNoChildStrategy(void) {}
        ...
        private:
            /**
              ...
              * @return HTTPResponseType
              */
            HTTPResponseType FindAndProcessChildObjectForLinkedChild(const HTTPRequestLine &request_line,
                    const HTTPRequestHeader &request_header, base::Value *request_body,
                    HTTPResponseHeader &response_header, base::Value *response_body,
                    std::map<std::string, std::string> &id_deps, const std::string &current_uri,
                    BaseSimpleObject *p_simple_obj);
            ...
            /**
              ...
              * @return HTTPResponseType
              */
            HTTPResponseType FindAndProcessChildObjectForIdentifiedObject(const HTTPRequestLine &request_line,
                    const HTTPRequestHeader &request_header, base::Value *request_body,
                    HTTPResponseHeader &response_header, base::Value *response_body,
                    std::map<std::string, std::string> &id_deps, const std::string &current_uri,
                    BaseSimpleObject *p_simple_obj);
...
#endif /* WEBSERVICE_SIMPLE_OBJECT_PUT_NO_CHILD_STRATEGY_H_ */
