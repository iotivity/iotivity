...
namespace webservice
{
    ...
    /**
      ...
      * @return CreatorList&
      */
    CreatorList &CreatorList::GetInstance()
    {
        static CreatorList instance;
        return instance;
    }
    ...
    /**
      ...
      * @return void
      */
    void CreatorList::RegisterObject( std::string name, Creator creator )
    {
    ...
    /**
      ...
      * @return BaseList*
      */
    BaseList *CreatorList::CreateObject( std::string name )
    {
        BaseList *p = 0;
