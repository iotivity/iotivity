...
#ifndef WEBSERVICE_SIMPLE_LINKED_CHILD_H_
#define WEBSERVICE_SIMPLE_LINKED_CHILD_H_
...
namespace webservice
{
    ...
    class SimpleLinkedChild : public BaseSimpleObject
    {
        public:
            /**
              * Constructor
              ...
              */
            SimpleLinkedChild(std::string key_str, std::string str) : BaseSimpleObject(key_str, str) {}

            /**
              * Destructor
              */
            virtual ~SimpleLinkedChild(void) {}
...
#endif /* WEBSERVICE_SIMPLE_LINKED_CHILD_H_ */
