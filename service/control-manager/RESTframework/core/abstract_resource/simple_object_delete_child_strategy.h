...
#ifndef WEBSERVICE_SIMPLE_OBJECT_DELETE_CHILD_STRATEGY_H_
#define WEBSERVICE_SIMPLE_OBJECT_DELETE_CHILD_STRATEGY_H_
...
namespace webservice
{
    ...
    class SimpleObjectDeleteChildStrategy : public ISimpleObjectStrategy
    {
        public:
            /**
              * Destructor
              */
            virtual ~SimpleObjectDeleteChildStrategy(void) {}
...
#endif /* WEBSERVICE_SIMPLE_OBJECT_DELETE_CHILD_STRATEGY_H_ */
