...
#ifndef WEBSERVICE_SIMPLE_OBJECT_COMMON_STRATEGY_H_
#define WEBSERVICE_SIMPLE_OBJECT_COMMON_STRATEGY_H_
...
namespace webservice
{
    ...
    class SimpleObjectCommonStrategy : public ISimpleObjectStrategy
    {
        public:
            /**
              * Destructor
              */
            virtual ~SimpleObjectCommonStrategy(void) {}
...
#endif /* WEBSERVICE_SIMPLE_OBJECT_COMMON_STRATEGY_H_ */
