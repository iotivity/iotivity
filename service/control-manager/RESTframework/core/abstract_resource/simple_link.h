...
#ifndef WEBSERVICE_SIMPLE_LINK_H_
#define WEBSERVICE_SIMPLE_LINK_H_
...
namespace webservice
{
    ...
    class SimpleLink : public BaseSimpleObject
    {
        public:
            /**
              * Constructor
              ...
              */
            SimpleLink(std::string key_str, std::string str) : BaseSimpleObject(key_str, str) {}

            /**
              * Destructor
              */
            virtual ~SimpleLink(void) {}
        ...
        private:
            ...
            /**
              ...
              * @return std::string
              */
            std::string ProcessAndCheckException(const std::string &uri) const ;
            ...
            /**
              ...
              * @return bool
              */
            bool IsListType(const std::string &object_name);
    };
}
