...
#ifndef WEBSERVICE_SIMPLE_IDENTIFIED_OBJECT_H_
#define WEBSERVICE_SIMPLE_IDENTIFIED_OBJECT_H_
...
namespace webservice
{
    ...
    class SimpleIdentifiedObject : public BaseSimpleObject
    {
        public:
            /**
              * Constructor
              ...
              */
            SimpleIdentifiedObject(std::string key_str, std::string str) : BaseSimpleObject(key_str, str) {}
            /**
              * Destructor
              */
            virtual ~SimpleIdentifiedObject(void) {}
        ...
        private:
            ...
            /**
              ...
              */
            virtual IHTTPMethod *CreateObject(std::string id);
    };

}
#endif /* WEBSERVICE_SIMPLE_IDENTIFIED_OBJECT_H_ */