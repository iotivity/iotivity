...
#ifndef WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_NETWORK_H_
#define WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_NETWORK_H_
...
namespace webservice
{
    ...
    class IdentifiedObjectNetwork : public BaseIdentifiedObject
    {
        public:
            IdentifiedObjectNetwork(std::string id, std::string object_name);
            virtual ~IdentifiedObjectNetwork(void);
            /**
              * Create this class.
        ...
        private:
            ...
            _boolean *connected_;
            UInt8 *priority_;
            _boolean *dhcpEnabled_;
            String50 *ipAddress_;
            String20 *subnetMask_;
            String50 *gateway_;
            String50 *dnsPrimary_;
            String50 *dnsSecondary_;
            String20 *macAddress_;
    };

}

#endif /* WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_NETWORK_H_ */