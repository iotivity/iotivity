...
#ifndef WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_VERSION_H_
#define WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_VERSION_H_
...
namespace webservice
{
    ...
    class IdentifiedObjectVersion : public BaseIdentifiedObject
    {
        public:
            IdentifiedObjectVersion(std::string id, std::string object_name);
            virtual ~IdentifiedObjectVersion(void);
            /**
              * Create this class.
        ...
        private:
            ...
            String50 *name_;
            String20 *number_;
            _boolean *newVersionAvailable_;
            _boolean *userAgreement_;
    };

}

#endif /* WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_VERSION_H_ */