...
#ifndef WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_ACCESSPOINT_H_
#define WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_ACCESSPOINT_H_
...
namespace webservice
{
    ...
    class IdentifiedObjectAccessPoint : public BaseIdentifiedObject
    {
        public:
            IdentifiedObjectAccessPoint(std::string id, std::string object_name);
            virtual ~IdentifiedObjectAccessPoint(void);
            /**
              * Create this class.
...
#endif /* WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_ACCESSPOINT_H_ */