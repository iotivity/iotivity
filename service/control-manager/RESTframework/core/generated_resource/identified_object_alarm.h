...
#ifndef WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_ALARM_H_
#define WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_ALARM_H_
...
namespace webservice
{
    ...
    class IdentifiedObjectAlarm : public BaseIdentifiedObject
    {
        public:
            IdentifiedObjectAlarm(std::string id, std::string object_name);
            virtual ~IdentifiedObjectAlarm(void);
            /**
              * Create this class.
        ...
        private:
            DateTimeType *triggeredTime_;
            AlarmCodeType *alarmType_;
            String20 *code_;
            _boolean *multicastEnabled_;
    };

}

#endif /* WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_ALARM_H_ */