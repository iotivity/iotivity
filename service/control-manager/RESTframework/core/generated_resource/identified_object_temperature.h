...
#ifndef WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_TEMPERATURE_H_
#define WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_TEMPERATURE_H_
...
namespace webservice
{
    ...
    class IdentifiedObjectTemperature : public BaseIdentifiedObject
    {
        public:
            IdentifiedObjectTemperature(std::string id, std::string object_name);
            virtual ~IdentifiedObjectTemperature(void);
            /**
              * Create this class.
        ...
        private:
            ...
            Float32 *maximum_;
            Float32 *minimum_;
            TemperatureUnitType *unit_;
    };

}

#endif /* WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_TEMPERATURE_H_ */