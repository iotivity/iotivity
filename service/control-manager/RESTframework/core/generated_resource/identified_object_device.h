...
#ifndef WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_DEVICE_H_
#define WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_DEVICE_H_
...
namespace webservice
{
    ...
    class IdentifiedObjectDevice : public BaseIdentifiedObject
    {
        public:
            IdentifiedObjectDevice(std::string id, std::string object_name);
            virtual ~IdentifiedObjectDevice(void);
            /**
              * Create this class.
        ...
        private:
            ...
            String30 *name_;
            DeviceType *type_;
            ArrayOfResourceType *resources_;
            _boolean *connected_;
    };

}

#endif /* WEBSERVICE_SRC_NEW_RESOURCE_HANDLER_GENERATED_RESOURCE_IDENTIFIED_OBJECT_DEVICE_H_ */