...
#ifndef WEBSERVICE_NETWORK_ID_MANAGER_H_
#define WEBSERVICE_NETWORK_ID_MANAGER_H_
...
namespace webservice
{
    ...
    class NetworkIDManager : public IObjectIDManager
    {
        public:
...
#endif /* WEBSERVICE_NETWORK_ID_MANAGER_H_ */
