...
class BASE_EXPORT Pickle {
 public:
  ...
  bool ReadData(PickleIterator* iter, const char** _data, int* _length) const {
    return iter->ReadData(_data, _length);
  }
  bool ReadBytes(PickleIterator* iter, const char** _data, int _length) const {
    return iter->ReadBytes(_data, _length);
  }
