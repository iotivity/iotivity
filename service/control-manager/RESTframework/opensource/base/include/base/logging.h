...
const LogSeverity LOG_INTERNAL_DETAILED_INFO = 0;  // added for SLEP project
const LogSeverity LOG_INTERNAL_INFO = 1; // added for SLEP project
const LogSeverity LOG_INFO = 2;
const LogSeverity LOG_WARNING =3;
const LogSeverity LOG_ERROR = 4;
const LogSeverity LOG_ERROR_REPORT = 5;
const LogSeverity LOG_FATAL = 6;
const LogSeverity LOG_NUM_SEVERITIES = 7;
...
#define COMPACT_GOOGLE_LOG_EX_INTERNAL_DETAILED_INFO(ClassName, ...) \
  logging::ClassName(__FILE__, __LINE__, logging::LOG_INTERNAL_DETAILED_INFO , ##__VA_ARGS__)
#define COMPACT_GOOGLE_LOG_EX_INTERNAL_INFO(ClassName, ...) \
  logging::ClassName(__FILE__, __LINE__, logging::LOG_INTERNAL_INFO , ##__VA_ARGS__)
...
#define COMPACT_GOOGLE_LOG_INTERNAL_DETAILED_INFO \
  COMPACT_GOOGLE_LOG_EX_INTERNAL_DETAILED_INFO(LogMessage)
#define COMPACT_GOOGLE_LOG_INTERNAL_INFO \
    COMPACT_GOOGLE_LOG_EX_INTERNAL_INFO(LogMessage)
