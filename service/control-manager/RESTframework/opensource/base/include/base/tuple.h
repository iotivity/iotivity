...
struct Tuple1 {
 public:
  ...
  Tuple1() {}
  explicit Tuple1(typename TupleTraits<A>::ParamType _a) : a(_a) {}
...
struct Tuple2 {
 public:
  ...
  Tuple2() {}
  Tuple2(typename TupleTraits<A>::ParamType _a,
         typename TupleTraits<B>::ParamType _b)
      : a(_a), b(_b) {
  }
...
struct Tuple3 {
 public:
  ...
  Tuple3() {}
  Tuple3(typename TupleTraits<A>::ParamType _a,
         typename TupleTraits<B>::ParamType _b,
         typename TupleTraits<C>::ParamType _c)
      : a(_a), b(_b), c(_c){
  }
...
struct Tuple4 {
 public:
  ...
  Tuple4() {}
  Tuple4(typename TupleTraits<A>::ParamType _a,
         typename TupleTraits<B>::ParamType _b,
         typename TupleTraits<C>::ParamType _c,
         typename TupleTraits<D>::ParamType _d)
      : a(_a), b(_b), c(_c), d(_d) {
  }
...
struct Tuple5 {
 public:
  ...
  Tuple5() {}
  Tuple5(typename TupleTraits<A>::ParamType _a,
    typename TupleTraits<B>::ParamType _b,
    typename TupleTraits<C>::ParamType _c,
    typename TupleTraits<D>::ParamType _d,
    typename TupleTraits<E>::ParamType _e)
...
struct Tuple6 {
 public:
  ...
  Tuple6() {}
  Tuple6(typename TupleTraits<A>::ParamType _a,
    typename TupleTraits<B>::ParamType _b,
    typename TupleTraits<C>::ParamType _c,
    typename TupleTraits<D>::ParamType _d,
    typename TupleTraits<E>::ParamType _e,
    typename TupleTraits<F>::ParamType _f)
...
struct Tuple7 {
 public:
  ...
  Tuple7() {}
  Tuple7(typename TupleTraits<A>::ParamType _a,
    typename TupleTraits<B>::ParamType _b,
    typename TupleTraits<C>::ParamType _c,
    typename TupleTraits<D>::ParamType _d,
    typename TupleTraits<E>::ParamType _e,
    typename TupleTraits<F>::ParamType _f,
    typename TupleTraits<G>::ParamType _g)
...
struct Tuple8 {
 public:
  ...
  Tuple8() {}
  Tuple8(typename TupleTraits<A>::ParamType _a,
    typename TupleTraits<B>::ParamType _b,
    typename TupleTraits<C>::ParamType _c,
    typename TupleTraits<D>::ParamType _d,
    typename TupleTraits<E>::ParamType _e,
    typename TupleTraits<F>::ParamType _f,
    typename TupleTraits<G>::ParamType _g,
    typename TupleTraits<H>::ParamType _h)
