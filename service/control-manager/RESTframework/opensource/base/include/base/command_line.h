...
class BASE_EXPORT CommandLine {
 public:
  ...
  // Get all arguments including the ones with switches
  StringVector GetAllArgs() const;

  // Helper functions to get non slep arguments
  StringVector GetNonSlepCommandLineVector() const;
  int GetNonSlepCommandLineArgsCount() const;
  
  // Remove the given slep related arguments
  bool RemoveSlepCommandLineArg(const StringType& slep_arg);
 ...
 private:
  ...
  // Maintain the non slep command line arguments
  int non_slep_argc_;
  StringVector non_slep_argv_;
};
