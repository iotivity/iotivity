...
override CPP_INC_DIR += -I"${TIZEN_SDK_LOCATION}/platforms/tizen2.2/rootstraps/tizen-emulator-2.2.native/usr/include/osp"
override LDFLAGS += -L"${TIZEN_SDK_LOCATION}/platforms/tizen2.2/rootstraps/tizen-emulator-2.2.native/usr/lib/osp"
