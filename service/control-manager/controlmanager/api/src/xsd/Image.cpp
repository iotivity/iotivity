...
Image::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    if (true == deserializer.hasProperty("imageFormat"))
    {
        ...
        if (false == deserializer.getPropertyValue("imageFormat",
                &(mpImageFormat->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  imageFormat"); return false ;}
    ...
    if (true == deserializer.hasProperty("imageSize"))
    {
        ...
        if (false == deserializer.getPropertyValue("imageSize",
                &(mpImageSize->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  imageSize"); return false ;}
