...
Temperature::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("current"))
    {
        ...
        if (false == deserializer.getPropertyValue("current",
                &(mpCurrent->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  current"); return false ;}
    ...
    if (true == deserializer.hasProperty("desired"))
    {
        ...
        if (false == deserializer.getPropertyValue("desired",
                &(mpDesired->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  desired"); return false ;}
    ...
    if (true == deserializer.hasProperty("increment"))
    {
        ...
        if (false == deserializer.getPropertyValue("increment",
                &(mpIncrement->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  increment"); return false ;}
    ...
    if (true == deserializer.hasProperty("maximum"))
    {
        ...
        if (false == deserializer.getPropertyValue("maximum",
                &(mpMaximum->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  maximum"); return false ;}
    ...
    if (true == deserializer.hasProperty("minimum"))
    {
        ...
        if (false == deserializer.getPropertyValue("minimum",
                &(mpMinimum->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  minimum"); return false ;}
