...
Light::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("lightPower"))
    {
        ...
        if (false == deserializer.getPropertyValue("lightPower",
                &(mpLightPower->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  lightPower"); return false ;}
    ...
    if (true == deserializer.hasProperty("activatePatternID"))
    {
        ...
        if (false == deserializer.getPropertyValue("activatePatternID",
                &(mpActivatePatternID->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  activatePatternID"); return false ;}
    ...
    if (true == deserializer.hasProperty("onPatternID"))
    {
        ...
        if (false == deserializer.getPropertyValue("onPatternID",
                &(mpOnPatternID->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  onPatternID"); return false ;}
