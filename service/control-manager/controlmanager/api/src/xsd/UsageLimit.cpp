...
UsageLimit::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("efficiency"))
    {
        ...
        if (false == deserializer.getPropertyValue("efficiency",
                &(mpEfficiency->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  efficiency"); return false ;}
