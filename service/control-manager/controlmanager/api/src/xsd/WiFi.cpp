...
WiFi::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("operationType"))
    {
        ...
        if (false == deserializer.getPropertyValue("operationType",
                &(mpOperationType->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  operationType"); return false ;}
    ...
    if (true == deserializer.hasProperty("securityKey"))
    {
        ...
        if (false == deserializer.getPropertyValue("securityKey",
                &(mpSecurityKey->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  securityKey"); return false ;}
    ...
    if (true == deserializer.hasProperty("wifiDirectStatus"))
    {
        ...
        if (false == deserializer.getPropertyValue("wifiDirectStatus",
                &(mpWifiDirectStatus->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  wifiDirectStatus"); return false ;}
    ...
    if (true == deserializer.hasProperty("wpsStatus"))
    {
        ...
        if (false == deserializer.getPropertyValue("wpsStatus",
                &(mpWpsStatus->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  wpsStatus"); return false ;}
