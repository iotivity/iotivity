...
DRLC::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("drlcStartTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("drlcStartTime",
                &(mpDrlcStartTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  drlcStartTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("override"))
    {
        ...
        if (false == deserializer.getPropertyValue("override",
                &(mpOverride->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  override"); return false ;}
