...
Message::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("duration"))
    {
        ...
        if (false == deserializer.getPropertyValue("duration",
                &(mpDuration->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  duration"); return false ;}
    ...
    if (true == deserializer.hasProperty("writer"))
    {
        ...
        if (false == deserializer.getPropertyValue("writer",
                &(mpWriter->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  writer"); return false ;}
    ...
    if (true == deserializer.hasProperty("title"))
    {
        ...
        if (false == deserializer.getPropertyValue("title",
                &(mpTitle->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  title"); return false ;}
    ...
    if (true == deserializer.hasProperty("messageType"))
    {
        ...
        if (false == deserializer.getPropertyValue("messageType",
                &(mpMessageType->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  messageType"); return false ;}
