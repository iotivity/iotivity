...
Network::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("ipAddress"))
    {
        ...
        if (false == deserializer.getPropertyValue("ipAddress",
                &(mpIpAddress->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  ipAddress"); return false ;}
    ...
    if (true == deserializer.hasProperty("subnetMask"))
    {
        ...
        if (false == deserializer.getPropertyValue("subnetMask",
                &(mpSubnetMask->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  subnetMask"); return false ;}
    ...
    if (true == deserializer.hasProperty("gateway"))
    {
        ...
        if (false == deserializer.getPropertyValue("gateway",
                &(mpGateway->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  gateway"); return false ;}
    ...
    if (true == deserializer.hasProperty("dnsPrimary"))
    {
        ...
        if (false == deserializer.getPropertyValue("dnsPrimary",
                &(mpDnsPrimary->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  dnsPrimary"); return false ;}
    ...
    if (true == deserializer.hasProperty("dnsSecondary"))
    {
        ...
        if (false == deserializer.getPropertyValue("dnsSecondary",
                &(mpDnsSecondary->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  dnsSecondary"); return false ;}
