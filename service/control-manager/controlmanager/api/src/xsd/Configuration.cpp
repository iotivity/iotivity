...
Configuration::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("installedLocation"))
    {
        ...
        if (false == deserializer.getPropertyValue("installedLocation",
                &(mpInstalledLocation->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  installedLocation"); return false ;}
    ...
    if (true == deserializer.hasProperty("region"))
    {
        ...
        if (false == deserializer.getPropertyValue("region",
                &(mpRegion->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  region"); return false ;}
    ...
    if (true == deserializer.hasProperty("currency"))
    {
        ...
        if (false == deserializer.getPropertyValue("currency",
                &(mpCurrency->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  currency"); return false ;}
    ...
    if (true == deserializer.hasProperty("pairingStart"))
    {
        ...
        if (false == deserializer.getPropertyValue("pairingStart",
                &(mpPairingStart->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  pairingStart"); return false ;}
    ...
    if (true == deserializer.hasProperty("unpairingStart"))
    {
        ...
        if (false == deserializer.getPropertyValue("unpairingStart",
                &(mpUnpairingStart->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  unpairingStart"); return false ;}
    ...
    if (true == deserializer.hasProperty("connectedDeviceType"))
    {
        ...
        if (false == deserializer.getPropertyValue("connectedDeviceType",
                &(mpConnectedDeviceType->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  connectedDeviceType"); return false ;}
