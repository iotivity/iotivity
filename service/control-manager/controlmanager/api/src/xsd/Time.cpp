...
Time::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("currentTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("currentTime",
                &(mpCurrentTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  currentTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("dstStartTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("dstStartTime",
                &(mpDstStartTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  dstStartTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("dstOffset"))
    {
        ...
        if (false == deserializer.getPropertyValue("dstOffset",
                &(mpDstOffset->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  dstOffset"); return false ;}
    ...
    if (true == deserializer.hasProperty("dstEndTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("dstEndTime",
                &(mpDstEndTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  dstEndTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("tzOffset"))
    {
        ...
        if (false == deserializer.getPropertyValue("tzOffset",
                &(mpTzOffset->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  tzOffset"); return false ;}
    ...
    if (true == deserializer.hasProperty("utcTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("utcTime",
                &(mpUtcTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  utcTime"); return false ;}
