...
bool
Temperatures::serializeContents(OC::Cm::Serialization::ISerializer &serializer)
{
...
bool
Temperatures::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
...

    {
        ...
        else
        {
            ...
            {
                if ((deserializer.isInFilteringMode("Temperatures") == false) ) { deserializer.setErrorMessage("Failed To deserialize : Temperatures"); return false; }
            }
        }
    }
...
std::string
Temperatures::getElementName()
{
    return EN_TEMPERATURES;
}

bool
Temperatures::clone(::Temperatures *pSrcObject)
{
    if (pSrcObject == NULL)
    {
        return false ;
...

    {
        ...
        mpTemperature.clear();
        for ( std::list< ::Temperature * >::const_iterator itr = pSrcObject->mpTemperature.begin();
