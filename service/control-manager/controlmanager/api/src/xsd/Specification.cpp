...
Specification::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("display"))
    {
        ...
        if (false == deserializer.getPropertyValue("display",
                &(mpDisplay->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  display"); return false ;}
    ...
    if (true == deserializer.hasProperty("sound"))
    {
        ...
        if (false == deserializer.getPropertyValue("sound",
                &(mpSound->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  sound"); return false ;}
    ...
    if (true == deserializer.hasProperty("resetFactoryDefaultSupported"))
    {
        ...
        if (false == deserializer.getPropertyValue("resetFactoryDefaultSupported",
                mpResetFactoryDefaultSupported)) { deserializer.setErrorMessage("Failed to deserialize parameter :  resetFactoryDefaultSupported"); return false ;}
    }
    {
