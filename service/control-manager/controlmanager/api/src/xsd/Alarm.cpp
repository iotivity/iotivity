...
Alarm::deSerializeContents(OC::Cm::Serialization::IDeserializer &deserializer)
{
    ...
    if (true == deserializer.hasProperty("triggeredTime"))
    {
        ...
        if (false == deserializer.getPropertyValue("triggeredTime",
                &(mpTriggeredTime->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  triggeredTime"); return false ;}
    ...
    if (true == deserializer.hasProperty("alarmType"))
    {
        ...
        if (false == deserializer.getPropertyValue("alarmType",
                &(mpAlarmType->value))) {deserializer.setErrorMessage("Failed to deserialize parameter :  alarmType"); return false ;}
