    ...
    namespace Cm
    {
        namespace Serialization
        {
            ...
            ISerializable::deSerialize(OC::Cm::Serialization::IDeserializer  &deserializer)
            {
                if (mIsList == false)
                {
                    ...
                    if (bRet)
                    {
                        ...
                        {
                            OC::Cm::Core::CMContext *pContext = (OC::Cm::Core::CMContext *)deserializer.getContext() ;
                            ...
                            {
                                if ( false == factory->createSerializable( this->m_schema_instance_type,
                                        &( this->m_pSchema_instance_data )))
                                {
                                    return false ;
                                }
            ...
            ISerializable::validateContent()
            {
                ...
                {
                    return error.setErrorCode(CM_MEMORY_ALLOCATION_FAILED);
                }
                ...
                if (false == this->serialize(*p_serializer))
                {
                    ...
                    CM_LOG_ERROR_A(CM_API, "%s", "Error in serialization");
                    CM_LOG_ERROR_A(CM_API, "%s", errorMessage.c_str());
                ...
                delete p_serializer ;
                return error.setErrorCode(CM_SUCCESS);
            }
