...
bool caseInsensitiveCompareLess::operator() (const std::string &string1,
...
namespace OC
{
    namespace Cm
    {
        namespace Connector
        {
            ...
            {
                std::map<std::string, std::string, caseInsensitiveCompareLess>::iterator item = m_headers.find(
                            name) ;
