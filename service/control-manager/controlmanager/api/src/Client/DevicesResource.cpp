...
DevicesResource::DevicesResource(OC::Cm::IContext *context, std::string &protocol,
                                 std::string &deviceAddress)
    : OC::Cm::Client::Resource::Resource(context, protocol, deviceAddress)
{
    p_respListener = NULL ;
    p_internalResponseListener = new DevicesResourceListenerInternal(this);
}
...
void
DevicesResource::addResponseListener (IDevicesResourceResponseListener &respListener)
{
    p_respListener = &respListener ;
}

IDevicesResourceResponseListener *
DevicesResource::getResponseListener ()
{
    return p_respListener;
}

bool
DevicesResource::getDevices( int &requestId )
...
bool
DevicesResource::postDevices( int &requestId , ::Device &reqData)
...
void
DevicesResource::buildPath(  )

{
    buildTemplatePath("/devices");
}
