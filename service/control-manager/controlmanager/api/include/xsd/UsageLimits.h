...
#ifndef USAGELIMITS_H_
#define USAGELIMITS_H_
 ...
 * @class   UsageLimits
 *
 * This function set provides a mechanism to allow the server to push down targets or challenges to help consumers manage their budgets within a certain time frame.
 * Also, this class defines methods that serialize and/or deserialize contents of XSD complex/list type UsageLimits.
 * @since   1.0.0
 */

class UsageLimits: public ::List
{

    protected:

        /**
         * Serializes the contents of UsageLimits object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new UsageLimits object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
         * @param[out]  pSrcObject  Source UsageLimits object to be cloned.
         *
         * @return  @c  True    if cloning is successful@n
         *          @c  False   if cloning failed
         * @since   1.0.0
         */
        bool clone(::UsageLimits *pSrcObject);

        /**
         * [Optional] Variable that contains UsageLimit objects in the List.
         */
        std::list< ::UsageLimit *> mpUsageLimit;
};
/** @} */
#endif /* USAGELIMITS_H_ */
