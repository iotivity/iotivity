 ...
 * @class   Alarms
 *
 * This class manages list of Alarm object and defines methods that serialize and/or deserialize contents of XSD complex/list type Alarms.
 * @since   1.0.0
 */
...
class Alarms: public ::List
{
    ...
    protected:
        ...
        /**
         * Serializes the contents of Alarms object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new Alarms object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
        ...
        /**
         * [Optional] Variable that contains Alarm objects in the List.
         */
