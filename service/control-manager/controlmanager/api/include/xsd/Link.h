 ...
 * Also, this class defines methods that serialize and/or deserialize contents of XSD complex/list type Link.
 * @since   1.0.0
 */
...
class Link: public OC::Cm::Serialization::ISerializable
{
    ...
    protected:
        ...
        /**
         * Serializes the contents of Link object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new Link object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
        ...
        /**
         * [Mandatory] Variable of std::string object.
         */
        std::string *mpHref;
};
/** @} */
