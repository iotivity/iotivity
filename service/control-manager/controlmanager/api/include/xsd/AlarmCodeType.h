...
#ifndef ALARMCODETYPE_H_
#define ALARMCODETYPE_H_
 ...
 * @class AlarmCodeType
 *
 * The enumeration set of alarm code type which the device supports.
 */
class AlarmCodeType
{
    public:
        ...
        /**
         * Variable that contains AlarmCodeType type value.
         */
        std::string value;
