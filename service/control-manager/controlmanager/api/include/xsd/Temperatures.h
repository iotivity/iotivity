 ...
 * @class   Temperatures
 *
 * This class manages list of Temperature object and defines methods that serialize and/or deserialize contents of XSD complex/list type Temperatures.
 * @since   1.0.0
 */
class Temperatures: public ::List
{

    protected:

        /**
         * Serializes the contents of Temperatures object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new Temperatures object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
         * @param[out]  pSrcObject  Source Temperatures object to be cloned.
         *
         * @return  @c  True    if cloning is successful@n
         *          @c  False   if cloning failed
         * @since   1.0.0
         */
        bool clone(::Temperatures *pSrcObject);

        /**
         * [Optional] Variable that contains Temperature objects in the List.
         */
        std::list< ::Temperature *> mpTemperature;
};
/** @} */
#endif /* TEMPERATURES_H_ */
