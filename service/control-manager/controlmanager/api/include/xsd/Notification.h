 ...
 * @class   Notification
 *
 * This class defines methods that serialize and/or deserialize contents of XSD complex/list type Notification.
 * @since   1.0.0
 */
...
class Notification: public ::IdentifiedObject
{
    ...
    protected:
        ...
        /**
         * Serializes the contents of Notification object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new Notification object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
        ...
        /**
         * [Optional] The subscription from which this notification was triggered. (e.g., �/devices/167261211391/subscriptions/3�)
         */
