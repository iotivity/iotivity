 ...
 * @class   AccessPoints
 *
 * This class manages list of AccessPoint object and defines methods that serialize and/or deserialize contents of XSD complex/list type AccessPoints.
 * @since   1.0.0
 */
...
class AccessPoints: public ::List
{
    ...
    protected:
        ...
        /**
         * Serializes the contents of AccessPoints object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new AccessPoints object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
        ...
        /**
         * [Optional] Variable that contains AccessPoint objects in the List.
         */
