 ...
 * @class   Networks
 *
 * This class manages list of Network object and defines methods that serialize and/or deserialize contents of XSD complex/list type Networks.
 * @since   1.0.0
 */
...
class Networks: public ::List
{
    ...
    protected:
        ...
        /**
         * Serializes the contents of Networks object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new Networks object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
        ...
        /**
         * [Optional] Variable that contains Network objects in the List.
         */
