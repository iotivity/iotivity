 ...
 * @class   Records
 *
 * This resource provides an interface for a history record.
 * Also, this class defines methods that serialize and/or deserialize contents of XSD complex/list type Records.
 * @since   1.0.0
 */

class Records: public ::List
{

    protected:

        /**
         * Serializes the contents of Records object using the specified serializer.
    ...
    public:
        ...
        /**
         * Default virtual destructor of Records class.
         * @since   1.0.0
         */
        virtual ~Records();
        ...
        /**
         * Creates a new Records object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
         * @param[out]  pSrcObject  Source Records object to be cloned.
         *
         * @return  @c  True    if cloning is successful@n
         *          @c  False   if cloning failed
         * @since   1.0.0
         */
        bool clone(::Records *pSrcObject);

        /**
         * [Optional] Variable that contains Record objects in the List.
         */
        std::list< ::Record *> mpRecord;
};
/** @} */
#endif /* RECORDS_H_ */
