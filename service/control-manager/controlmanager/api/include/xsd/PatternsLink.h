 ...
 * @class   PatternsLink
 *
 * This class defines methods that serialize and/or deserialize contents of XSD complex/list type PatternsLink.
 * @since   1.0.0
 */
...
class PatternsLink: public ::Link
{
    ...
    protected:
        ...
        /**
         * Serializes the contents of PatternsLink object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new PatternsLink object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
