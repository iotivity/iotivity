 ...
 * @class   ArrayOfString
 *
 * ArrayOfString class implements OC::Cm::Serialization::ISerializable, defines methods to serialize and deserialize content of XSD Simple Type ArrayOfString List.
 * @since   1.0.0
 */
