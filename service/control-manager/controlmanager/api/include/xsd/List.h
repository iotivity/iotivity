 ...
 * Also, this class defines methods that serialize and/or deserialize contents of XSD complex/list type List.
 * @since   1.0.0
 */
...
class List: public ::Resource
{
    ...
    protected:
        ...
        /**
         * Serializes the contents of List object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new List object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
