 ...
 * @class   Versions
 *
 * This class manages list of Version object and defines methods that serialize and/or deserialize contents of XSD complex/list type Versions.
 * @since   1.0.0
 */
...
class Versions: public ::List
{
    ...
    protected:
        ...
        /**
         * Serializes the contents of Versions object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new Versions object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
        ...
        /**
         * [Optional] Variable that contains Version objects in the List.
         */
