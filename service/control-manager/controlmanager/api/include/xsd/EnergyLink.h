...
#ifndef ENERGYLINK_H_
#define ENERGYLINK_H_
 ...
 * @class   EnergyLink
 *
 * This class defines methods that serialize and/or deserialize contents of XSD complex/list type EnergyLink.
 * @since   1.0.0
 */

class EnergyLink: public ::Link
{

    protected:

        /**
         * Serializes the contents of EnergyLink object using the specified serializer.
        ...
        /**
         * Deserializes data and prepares the EnergyLink object contents.
    ...
    public:
        ...
        /**
         * Default constructor of EnergyLink class.
         * @since   1.0.0
         */
        EnergyLink();

        /**
         * Default virtual destructor of EnergyLink class.
         * @since   1.0.0
         */
        virtual ~EnergyLink();
        ...
        /**
         * Creates a new EnergyLink object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
         * @param[out]  pSrcObject  Source EnergyLink object to be cloned.
         *
         * @return  @c  True    if cloning is successful@n
         *          @c  False   if cloning failed
         * @since   1.0.0
         */
        bool clone(::EnergyLink *pSrcObject);
};
/** @} */
#endif /* ENERGYLINK_H_ */
