 ...
 * Also, this class defines methods that serialize and/or deserialize contents of XSD complex/list type Resource.
 * @since   1.0.0
 */

class Resource: public OC::Cm::Serialization::ISerializable
{

    protected:

        /**
         * Serializes the contents of Resource object using the specified serializer.
        ...
        /**
         * Deserializes data and prepares the Resource object contents.
    ...
    public:
        ...
        /**
         * Default constructor of Resource class.
         * @since   1.0.0
         */
        Resource();
        ...
        /**
         * Creates a new Resource object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
         * @param[out]  pSrcObject  Source Resource object to be cloned.
         *
         * @return  @c  True    if cloning is successful@n
         *          @c  False   if cloning failed
         * @since   1.0.0
         */
        bool clone(::Resource *pSrcObject);
};
/** @} */
#endif /* RESOURCE_H_ */
