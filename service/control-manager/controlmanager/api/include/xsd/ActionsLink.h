...
#ifndef ACTIONSLINK_H_
#define ACTIONSLINK_H_
 ...
 * @class   ActionsLink
 *
 * This class defines methods that serialize and/or deserialize contents of XSD complex/list type ActionsLink.
 * @since   1.0.0
 */

class ActionsLink: public ::Link
{

    protected:

        /**
         * Serializes the contents of ActionsLink object using the specified serializer.
    ...
    public:
        ...
        /**
         * Default virtual destructor of ActionsLink class.
         * @since   1.0.0
         */
        virtual ~ActionsLink();
        ...
        /**
         * Creates a new ActionsLink object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
         * @param[out]  pSrcObject  Source ActionsLink object to be cloned.
         *
         * @return  @c  True    if cloning is successful@n
         *          @c  False   if cloning failed
         * @since   1.0.0
         */
        bool clone(::ActionsLink *pSrcObject);
};
/** @} */
#endif /* ACTIONSLINK_H_ */
