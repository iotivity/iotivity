...
#ifndef RECORDSLINK_H_
#define RECORDSLINK_H_
 ...
 * @class   RecordsLink
 *
 * This class defines methods that serialize and/or deserialize contents of XSD complex/list type RecordsLink.
 * @since   1.0.0
 */

class RecordsLink: public ::Link
{

    protected:

        /**
         * Serializes the contents of RecordsLink object using the specified serializer.
    ...
    public:
        ...
        /**
         * Default virtual destructor of RecordsLink class.
         * @since   1.0.0
         */
        virtual ~RecordsLink();
        ...
        /**
         * Creates a new RecordsLink object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
         * @param[out]  pSrcObject  Source RecordsLink object to be cloned.
         *
         * @return  @c  True    if cloning is successful@n
         *          @c  False   if cloning failed
         * @since   1.0.0
         */
        bool clone(::RecordsLink *pSrcObject);
};
/** @} */
#endif /* RECORDSLINK_H_ */
