 ...
 *
 * ArrayOfResourceType class implements OC::Cm::Serialization::ISerializable, defines methods to serialize and deserialize content of XSD Simple Type ArrayOfResourceType List.
 * @since   1.0.0
 */
