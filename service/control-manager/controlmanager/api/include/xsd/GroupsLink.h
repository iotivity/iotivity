 ...
 * @class   GroupsLink
 *
 * This class defines methods that serialize and/or deserialize contents of XSD complex/list type GroupsLink.
 * @since   1.0.0
 */
...
class GroupsLink: public ::Link
{
    ...
    protected:
        ...
        /**
         * Serializes the contents of GroupsLink object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new GroupsLink object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
