 ...
 * @class   Doors
 *
 * This class manages list of Door object and defines methods that serialize and/or deserialize contents of XSD complex/list type Doors.
 * @since   1.0.0
 */
...
class Doors: public ::List
{
    ...
    protected:
        ...
        /**
         * Serializes the contents of Doors object using the specified serializer.
    ...
    public:
        ...
        /**
         * Creates a new Doors object of the same class as this object. It then initializes each of the new object's fields by assigning it with the same value as the corresponding field in this object.
         *
        ...
        /**
         * [Optional] Variable that contains Door objects in the List.
         */
