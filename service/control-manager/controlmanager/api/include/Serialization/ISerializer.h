    ...
    namespace Cm
    {
        namespace Serialization
        {
            ...
            */
             ...
             * This interface defines methods of a serializer. Control Manager framework uses serializer
             * to encode request/response objects to payload data fromat.
             * Control Manager framework implements an internal JSON serializer which can serialize objects to json data
             *
             * @since       1.0
             */
            class CMAPI ISerializer
            {
