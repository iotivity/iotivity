...
#ifndef ITIMERESOURCERESPONSELISTENER_H_
#define ITIMERESOURCERESPONSELISTENER_H_
...
/**
 * @interface   ITimeResourceResponseListener
 * @brief       ITimeResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::TimeResource class.<br><br>
 *
...
class ITimeResourceResponseListener
{

    public:

        virtual ~ITimeResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::TimeResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::TimeResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::TimeResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetTime( int &requestId , int status, ::Time *respData) = 0;


        virtual bool onputTime( int &requestId, int status ) = 0;
...
/** @} */
#endif /* ITIMERESOURCERESPONSELISTENER_H_ */
