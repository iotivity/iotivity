...
#ifndef IUSAGELIMITRESOURCERESPONSELISTENER_H_
#define IUSAGELIMITRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IUsageLimitResourceResponseListener
 * @brief       IUsageLimitResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::UsageLimitResource class.<br><br>
 *
...
class IUsageLimitResourceResponseListener
{

    public:

        virtual ~IUsageLimitResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::UsageLimitResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::UsageLimitResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::UsageLimitResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetUsageLimit( int &requestId , int status, ::UsageLimit *respData) = 0;


        virtual bool onputUsageLimit( int &requestId, int status ) = 0;


        virtual bool ondeleteUsageLimit( int &requestId, int status ) = 0;
...
#endif /* IUSAGELIMITRESOURCERESPONSELISTENER_H_ */
