...
#ifndef IENERGYCONSUMPTIONRESOURCERESPONSELISTENER_H_
#define IENERGYCONSUMPTIONRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IEnergyConsumptionResourceResponseListener
 * @brief       IEnergyConsumptionResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::EnergyConsumptionResource class.<br><br>
 *
...
class IEnergyConsumptionResourceResponseListener
{

    public:

        virtual ~IEnergyConsumptionResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::EnergyConsumptionResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::EnergyConsumptionResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::EnergyConsumptionResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetEnergyConsumption( int &requestId , int status,
                                             ::EnergyConsumption *respData) = 0;


        virtual bool onputEnergyConsumption( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IENERGYCONSUMPTIONRESOURCERESPONSELISTENER_H_ */
