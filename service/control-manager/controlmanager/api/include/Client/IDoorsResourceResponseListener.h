...
#ifndef IDOORSRESOURCERESPONSELISTENER_H_
#define IDOORSRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IDoorsResourceResponseListener
 * @brief       IDoorsResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::DoorsResource class.<br><br>
 *
...
class IDoorsResourceResponseListener
{

    public:

        virtual ~IDoorsResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DoorsResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DoorsResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::DoorsResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetDoors( int &requestId , int status, ::Doors *respData) = 0;


        virtual bool onputDoors( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IDOORSRESOURCERESPONSELISTENER_H_ */
