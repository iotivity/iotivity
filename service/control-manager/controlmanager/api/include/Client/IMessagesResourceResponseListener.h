...
#ifndef IMESSAGESRESOURCERESPONSELISTENER_H_
#define IMESSAGESRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IMessagesResourceResponseListener
 * @brief       IMessagesResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::MessagesResource class.<br><br>
 *
...
class IMessagesResourceResponseListener
{

    public:

        virtual ~IMessagesResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::MessagesResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::MessagesResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::MessagesResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetMessages( int &requestId , int status, ::Messages *respData) = 0;


        virtual bool onputMessages( int &requestId, int status ) = 0;


        virtual bool onpostMessages( int &requestId , int status, std::string &location) = 0;


        virtual bool ondeleteMessages( int &requestId, int status ) = 0;
...
#endif /* IMESSAGESRESOURCERESPONSELISTENER_H_ */
