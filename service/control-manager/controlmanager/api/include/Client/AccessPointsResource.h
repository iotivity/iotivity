...
#ifndef ACCESSPOINTSRESOURCE_H_
#define ACCESSPOINTSRESOURCE_H_

#include "CMClientResource.h"
#include "xsd/Elements.h"

#include "IAccessPointsResourceResponseListener.h"
 ...
 * @brief   AccessPointsResource class implements OC::Cm::Client::Resource::Resource and OC::Cm::Client::Resource::IResourceResponseListener @n
 ...
 */
class AccessPointsResource : public OC::Cm::Client::Resource::Resource
{
    public:

        /**
         * Constructor of AccessPointsResource class.
         *
         ...
         */
        AccessPointsResource(OC::Cm::IContext *context, std::string &protocol, std::string &deviceAddress);

        /**
         * Default virtual destructor of AccessPointsResource class.
         */
        virtual ~AccessPointsResource();
         ...
         *
         * @param[in]   AccessPointsResourceResponseListener    Object that implements IAccessPointsResourceResponseListener interface
         */

        void addResponseListener (IAccessPointsResourceResponseListener &respListener) ;

        IAccessPointsResourceResponseListener *getResponseListener ();


        bool getAccessPoints( int &requestId );
    ...
    private:
        ...
        class AccessPointsResourceListenerInternal : public
            OC::Cm::Client::Resource::IResourceResponseListener
        {
            public:

                AccessPointsResource *resource;

                AccessPointsResourceListenerInternal(AccessPointsResource *res)
                {
                    resource = res;
                }

                ~AccessPointsResourceListenerInternal()
                {
                }
                ...
                {
                    IAccessPointsResourceResponseListener *p_respListener = resource->getResponseListener();
                    if (p_respListener != NULL)
                    {
                        if (response != NULL)
                        {
                            ...
                            if ( 0 == elementName.compare(EN_ACCESSPOINTS))
                            {
                                ::AccessPoints *respData = (::AccessPoints *)response ;
                                p_respListener->ongetAccessPoints(clientSessionId, status,  respData) ;
                            }
                            else
                            {
                                p_respListener->ongetAccessPoints(clientSessionId, 400,  NULL) ;
                            }
                        }
                        else
                        {
                            p_respListener->ongetAccessPoints(clientSessionId, status,  NULL) ;
                        }
        ...
        /**
         * Variable that contains IAccessPointsResourceResponseListener object.
         */
        IAccessPointsResourceResponseListener *p_respListener ;
