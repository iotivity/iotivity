...
#ifndef IRECORDSRESOURCERESPONSELISTENER_H_
#define IRECORDSRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IRecordsResourceResponseListener
 * @brief       IRecordsResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::RecordsResource class.<br><br>
 *
...
class IRecordsResourceResponseListener
{

    public:

        virtual ~IRecordsResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::RecordsResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::RecordsResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::RecordsResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetRecords( int &requestId , int status, ::Records *respData) = 0;


        virtual bool ondeleteRecords( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IRECORDSRESOURCERESPONSELISTENER_H_ */
