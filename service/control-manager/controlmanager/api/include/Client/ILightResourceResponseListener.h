...
#ifndef ILIGHTRESOURCERESPONSELISTENER_H_
#define ILIGHTRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   ILightResourceResponseListener
 * @brief       ILightResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::LightResource class.<br><br>
 *
...
class ILightResourceResponseListener
{

    public:

        virtual ~ILightResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::LightResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::LightResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::LightResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetLight( int &requestId , int status, ::Light *respData) = 0;


        virtual bool onputLight( int &requestId, int status ) = 0;
...
/** @} */
#endif /* ILIGHTRESOURCERESPONSELISTENER_H_ */
