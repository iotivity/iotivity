...
#ifndef IDRLCRESOURCERESPONSELISTENER_H_
#define IDRLCRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IDRLCResourceResponseListener
 * @brief       IDRLCResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::DRLCResource class.<br><br>
 *
...
class IDRLCResourceResponseListener
{

    public:

        virtual ~IDRLCResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DRLCResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DRLCResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::DRLCResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetDRLC( int &requestId , int status, ::DRLC *respData) = 0;


        virtual bool onputDRLC( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IDRLCRESOURCERESPONSELISTENER_H_ */
