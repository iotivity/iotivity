...
#ifndef IUSAGELIMITSRESOURCERESPONSELISTENER_H_
#define IUSAGELIMITSRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IUsageLimitsResourceResponseListener
 * @brief       IUsageLimitsResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::UsageLimitsResource class.<br><br>
 *
...
class IUsageLimitsResourceResponseListener
{

    public:

        virtual ~IUsageLimitsResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::UsageLimitsResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::UsageLimitsResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::UsageLimitsResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetUsageLimits( int &requestId , int status, ::UsageLimits *respData) = 0;


        virtual bool onputUsageLimits( int &requestId, int status ) = 0;


        virtual bool onpostUsageLimits( int &requestId , int status, std::string &location) = 0;


        virtual bool ondeleteUsageLimits( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IUSAGELIMITSRESOURCERESPONSELISTENER_H_ */
