...
#ifndef IMESSAGERESOURCERESPONSELISTENER_H_
#define IMESSAGERESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IMessageResourceResponseListener
 * @brief       IMessageResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::MessageResource class.<br><br>
 *
...
class IMessageResourceResponseListener
{

    public:

        virtual ~IMessageResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::MessageResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::MessageResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::MessageResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetMessage( int &requestId , int status, ::Message *respData) = 0;


        virtual bool onputMessage( int &requestId, int status ) = 0;


        virtual bool ondeleteMessage( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IMESSAGERESOURCERESPONSELISTENER_H_ */
