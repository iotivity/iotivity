...
#ifndef ITEMPERATURERESOURCERESPONSELISTENER_H_
#define ITEMPERATURERESOURCERESPONSELISTENER_H_
...
/**
 * @interface   ITemperatureResourceResponseListener
 * @brief       ITemperatureResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::TemperatureResource class.<br><br>
 *
...
class ITemperatureResourceResponseListener
{

    public:

        virtual ~ITemperatureResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::TemperatureResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::TemperatureResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::TemperatureResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetTemperature( int &requestId , int status, ::Temperature *respData) = 0;


        virtual bool onputTemperature( int &requestId, int status ) = 0;
...
#endif /* ITEMPERATURERESOURCERESPONSELISTENER_H_ */
