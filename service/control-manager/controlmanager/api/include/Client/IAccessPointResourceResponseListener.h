...
#ifndef IACCESSPOINTRESOURCERESPONSELISTENER_H_
#define IACCESSPOINTRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IAccessPointResourceResponseListener
 * @brief       IAccessPointResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::AccessPointResource class.<br><br>
 *
...
class IAccessPointResourceResponseListener
{

    public:

        virtual ~IAccessPointResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::AccessPointResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::AccessPointResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::AccessPointResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetAccessPoint( int &requestId , int status, ::AccessPoint *respData) = 0;
...
/** @} */
#endif /* IACCESSPOINTRESOURCERESPONSELISTENER_H_ */
