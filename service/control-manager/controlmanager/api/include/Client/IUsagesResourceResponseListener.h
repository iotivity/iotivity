...
#ifndef IUSAGESRESOURCERESPONSELISTENER_H_
#define IUSAGESRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IUsagesResourceResponseListener
 * @brief       IUsagesResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::UsagesResource class.<br><br>
 *
...
class IUsagesResourceResponseListener
{

    public:

        virtual ~IUsagesResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::UsagesResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::UsagesResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::UsagesResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetUsages( int &requestId , int status, ::Usages *respData) = 0;
...
/** @} */
#endif /* IUSAGESRESOURCERESPONSELISTENER_H_ */
