...
#ifndef INOTIFICATIONRESOURCERESPONSELISTENER_H_
#define INOTIFICATIONRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   INotificationResourceResponseListener
 * @brief       INotificationResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::NotificationResource class.<br><br>
 *
...
class INotificationResourceResponseListener
{

    public:

        virtual ~INotificationResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::NotificationResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::NotificationResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::NotificationResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
...
/** @} */
#endif /* INOTIFICATIONRESOURCERESPONSELISTENER_H_ */
