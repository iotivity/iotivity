...
#ifndef LONGPOLLINGNOTIFICATIONRESOURCE_H_
#define LONGPOLLINGNOTIFICATIONRESOURCE_H_

#include "CMClientResource.h"
#include "xsd/Elements.h"

#include "ILongPollingNotificationResourceResponseListener.h"
...
/**
 * @class   LongPollingNotificationResource
 * @brief   LongPollingNotificationResource class implements OC::Cm::Client::Resource::Resource and OC::Cm::Client::Resource::IResourceResponseListener @n
 ...
 */
class LongPollingNotificationResource : public OC::Cm::Client::Resource::Resource
{

    public:

        /**
         * Constructor of LongPollingNotificationResource class.
         *
         ...
         */
        LongPollingNotificationResource(OC::Cm::IContext *context, std::string &protocol,
                                        std::string &deviceAddress);

        /**
         * Default virtual destructor of LongPollingNotificationResource class.
         */
        virtual ~LongPollingNotificationResource();
         ...
         *
         * @param[in]   LongPollingNotificationResourceResponseListener Object that implements ILongPollingNotificationResourceResponseListener interface
         */

        void addResponseListener (ILongPollingNotificationResourceResponseListener &respListener) ;

        ILongPollingNotificationResourceResponseListener *getResponseListener ();

        bool getLongPollingNotification( int &requestId );

        void buildPath( );

    private:
        class LongPollingNotificationResourceListenerInternal : public
            OC::Cm::Client::Resource::IResourceResponseListener
        {
            public:

                LongPollingNotificationResource *resource;

                LongPollingNotificationResourceListenerInternal(LongPollingNotificationResource *res)
                {
                    resource = res;
                }

                ~LongPollingNotificationResourceListenerInternal()
                {
                }
                ...
                {
                    ILongPollingNotificationResourceResponseListener *p_respListener = resource->getResponseListener();
                    if (p_respListener != NULL)
                    {
                        if (response != NULL)
                        {
                            ...
                            if ( 0 == elementName.compare(EN_LONGPOLLINGNOTIFICATION))
                            {
                                ::LongPollingNotification *respData = (::LongPollingNotification *)response ;
                                p_respListener->ongetLongPollingNotification(clientSessionId, status,  respData) ;
                            }
                            else
                            {
                                p_respListener->ongetLongPollingNotification(clientSessionId, 400,  NULL) ;
                            }
                        }
                        else
                        {
                            p_respListener->ongetLongPollingNotification(clientSessionId, status,  NULL) ;
                        }
        ...
        /**
         * Variable that contains ILongPollingNotificationResourceResponseListener object.
         */
        ILongPollingNotificationResourceResponseListener *p_respListener ;

        OC::Cm::Client::Resource::IResourceResponseListener *p_internalResponseListener ;

};
/** @} */
#endif /* LONGPOLLINGNOTIFICATIONRESOURCE_H_ */
