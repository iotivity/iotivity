...
#ifndef IENERGYRESOURCERESPONSELISTENER_H_
#define IENERGYRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IEnergyResourceResponseListener
 * @brief       IEnergyResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::EnergyResource class.<br><br>
 *
...
class IEnergyResourceResponseListener
{

    public:

        virtual ~IEnergyResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::EnergyResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::EnergyResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::EnergyResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
...
/** @} */
#endif /* IENERGYRESOURCERESPONSELISTENER_H_ */
