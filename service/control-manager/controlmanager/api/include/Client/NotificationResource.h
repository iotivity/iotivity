...
#include "INotificationResourceResponseListener.h"
 ...
 * @brief   NotificationResource class implements OC::Cm::Client::Resource::Resource and OC::Cm::Client::Resource::IResourceResponseListener @n
 ...
 */
class NotificationResource : public OC::Cm::Client::Resource::Resource
{

    public:

        /**
         * Constructor of NotificationResource class.
         *
         ...
         */
        NotificationResource(OC::Cm::IContext *context, std::string &protocol, std::string &deviceAddress);

        /**
         * Default virtual destructor of NotificationResource class.
         */
         ...
         *
         * @param[in]   NotificationResourceResponseListener    Object that implements INotificationResourceResponseListener interface
         */

        void addResponseListener (INotificationResourceResponseListener &respListener) ;

        INotificationResourceResponseListener *getResponseListener ();

        void buildPath(std::string notificationId);

    private:
        class NotificationResourceListenerInternal : public
            OC::Cm::Client::Resource::IResourceResponseListener
        {
            public:
                ...
                NotificationResourceListenerInternal(NotificationResource *res)
                {
                    resource = res;
                }

                ~NotificationResourceListenerInternal()
                {
                }
                ...
                {
                    INotificationResourceResponseListener *p_respListener = resource->getResponseListener();
        ...
        /**
         * Variable that contains INotificationResourceResponseListener object.
         */
        INotificationResourceResponseListener *p_respListener ;
