...
#ifndef ENERGYCONSUMPTIONRESOURCE_H_
#define ENERGYCONSUMPTIONRESOURCE_H_

#include "CMClientResource.h"
#include "xsd/Elements.h"

#include "IEnergyConsumptionResourceResponseListener.h"
...
/**
 * @class   EnergyConsumptionResource
 * @brief   EnergyConsumptionResource class implements OC::Cm::Client::Resource::Resource and OC::Cm::Client::Resource::IResourceResponseListener @n
 ...
 */
class EnergyConsumptionResource : public OC::Cm::Client::Resource::Resource
{

    public:

        /**
         * Constructor of EnergyConsumptionResource class.
         *
         ...
         */
        EnergyConsumptionResource(OC::Cm::IContext *context, std::string &protocol,
                                  std::string &deviceAddress);

        /**
         * Default virtual destructor of EnergyConsumptionResource class.
         */
        virtual ~EnergyConsumptionResource();
         ...
         *
         * @param[in]   EnergyConsumptionResourceResponseListener   Object that implements IEnergyConsumptionResourceResponseListener interface
         */
        void addResponseListener (IEnergyConsumptionResourceResponseListener &respListener) ;

        IEnergyConsumptionResourceResponseListener *getResponseListener ();

        bool getEnergyConsumption( int &requestId );


        bool putEnergyConsumption( int &requestId , ::EnergyConsumption &reqData);


        void buildPath(std::string deviceId);

    private:
        class EnergyConsumptionResourceListenerInternal : public
            OC::Cm::Client::Resource::IResourceResponseListener
        {
            public:

                EnergyConsumptionResource *resource;

                EnergyConsumptionResourceListenerInternal(EnergyConsumptionResource *res)
                {
                    resource = res;
                }

                ~EnergyConsumptionResourceListenerInternal()
                {
                }
                ...
                {
                    IEnergyConsumptionResourceResponseListener *p_respListener = resource->getResponseListener();
                    if (p_respListener != NULL)
                    {
                        if (response != NULL)
                        {
                            ...
                            if ( 0 == elementName.compare(EN_ENERGYCONSUMPTION))
                            {
                                ::EnergyConsumption *respData = (::EnergyConsumption *)response ;
                                p_respListener->ongetEnergyConsumption(clientSessionId, status,  respData) ;
                            }
                            else
                            {
                                p_respListener->ongetEnergyConsumption(clientSessionId, 400,  NULL) ;
                            }
                        }
                        else
                        {
                            p_respListener->ongetEnergyConsumption(clientSessionId, status,  NULL) ;
                        }
                                      ...
                                      OC::Cm::Serialization::ISerializable *response)
                {
                    ...
                    if (p_respListener != NULL)
                    {
                        p_respListener->onputEnergyConsumption( clientSessionId, status ) ;
                    }
        ...
        /**
         * Variable that contains IEnergyConsumptionResourceResponseListener object.
         */
        IEnergyConsumptionResourceResponseListener *p_respListener ;

        OC::Cm::Client::Resource::IResourceResponseListener *p_internalResponseListener ;

};
/** @} */
#endif /* ENERGYCONSUMPTIONRESOURCE_H_ */
