...
#ifndef IMODERESOURCERESPONSELISTENER_H_
#define IMODERESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IModeResourceResponseListener
 * @brief       IModeResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::ModeResource class.<br><br>
 *
...
class IModeResourceResponseListener
{

    public:

        virtual ~IModeResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::ModeResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::ModeResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::ModeResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetMode( int &requestId , int status, ::Mode *respData) = 0;


        virtual bool onputMode( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IMODERESOURCERESPONSELISTENER_H_ */
