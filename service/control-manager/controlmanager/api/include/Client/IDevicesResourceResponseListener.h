...
#ifndef IDEVICESRESOURCERESPONSELISTENER_H_
#define IDEVICESRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IDevicesResourceResponseListener
 * @brief       IDevicesResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::DevicesResource class.<br><br>
 *
...
class IDevicesResourceResponseListener
{

    public:

        virtual ~IDevicesResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DevicesResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DevicesResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::DevicesResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetDevices( int &requestId , int status, ::Devices *respData) = 0;


        virtual bool onpostDevices( int &requestId , int status, std::string &location) = 0;
...
#endif /* IDEVICESRESOURCERESPONSELISTENER_H_ */
