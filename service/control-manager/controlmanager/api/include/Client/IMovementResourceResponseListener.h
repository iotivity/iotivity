...
#ifndef IMOVEMENTRESOURCERESPONSELISTENER_H_
#define IMOVEMENTRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IMovementResourceResponseListener
 * @brief       IMovementResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::MovementResource class.<br><br>
 *
...
class IMovementResourceResponseListener
{

    public:

        virtual ~IMovementResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::MovementResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::MovementResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::MovementResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetMovement( int &requestId , int status, ::Movement *respData) = 0;


        virtual bool onputMovement( int &requestId, int status ) = 0;
...
#endif /* IMOVEMENTRESOURCERESPONSELISTENER_H_ */
