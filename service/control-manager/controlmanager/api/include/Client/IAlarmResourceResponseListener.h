...
#ifndef IALARMRESOURCERESPONSELISTENER_H_
#define IALARMRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IAlarmResourceResponseListener
 * @brief       IAlarmResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::AlarmResource class.<br><br>
 *
...
class IAlarmResourceResponseListener
{

    public:

        virtual ~IAlarmResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::AlarmResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::AlarmResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::AlarmResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetAlarm( int &requestId , int status, ::Alarm *respData) = 0;
...
/** @} */
#endif /* IALARMRESOURCERESPONSELISTENER_H_ */
