...
#ifndef IVERSIONSRESOURCERESPONSELISTENER_H_
#define IVERSIONSRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IVersionsResourceResponseListener
 * @brief       IVersionsResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::VersionsResource class.<br><br>
 *
...
class IVersionsResourceResponseListener
{

    public:

        virtual ~IVersionsResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::VersionsResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::VersionsResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::VersionsResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetVersions( int &requestId , int status, ::Versions *respData) = 0;


        virtual bool onputVersions( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IVERSIONSRESOURCERESPONSELISTENER_H_ */
