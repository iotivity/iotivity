...
#ifndef ICONFIGURATIONRESOURCERESPONSELISTENER_H_
#define ICONFIGURATIONRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IConfigurationResourceResponseListener
 * @brief       IConfigurationResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::ConfigurationResource class.<br><br>
 *
...
class IConfigurationResourceResponseListener
{

    public:

        virtual ~IConfigurationResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::ConfigurationResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::ConfigurationResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::ConfigurationResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetConfiguration( int &requestId , int status, ::Configuration *respData) = 0;


        virtual bool onputConfiguration( int &requestId, int status ) = 0;
...
/** @} */
#endif /* ICONFIGURATIONRESOURCERESPONSELISTENER_H_ */
