...
#ifndef IWIFIRESOURCERESPONSELISTENER_H_
#define IWIFIRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IWiFiResourceResponseListener
 * @brief       IWiFiResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::WiFiResource class.<br><br>
 *
...
class IWiFiResourceResponseListener
{

    public:

        virtual ~IWiFiResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::WiFiResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::WiFiResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::WiFiResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetWiFi( int &requestId , int status, ::WiFi *respData) = 0;


        virtual bool onputWiFi( int &requestId, int status ) = 0;
...
#endif /* IWIFIRESOURCERESPONSELISTENER_H_ */
