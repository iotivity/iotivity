...
#ifndef ILONGPOLLINGNOTIFICATIONRESOURCERESPONSELISTENER_H_
#define ILONGPOLLINGNOTIFICATIONRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   ILongPollingNotificationResourceResponseListener
 * @brief       ILongPollingNotificationResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::LongPollingNotificationResource class.<br><br>
 *
...
class ILongPollingNotificationResourceResponseListener
{

    public:

        virtual ~ILongPollingNotificationResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::LongPollingNotificationResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::LongPollingNotificationResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::LongPollingNotificationResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetLongPollingNotification( int &requestId , int status,
                ::LongPollingNotification *respData) = 0;
...
/** @} */
#endif /* ILONGPOLLINGNOTIFICATIONRESOURCERESPONSELISTENER_H_ */
