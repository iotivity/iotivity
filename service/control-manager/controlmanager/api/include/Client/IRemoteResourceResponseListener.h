...
#ifndef IREMOTERESOURCERESPONSELISTENER_H_
#define IREMOTERESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IRemoteResourceResponseListener
 * @brief       IRemoteResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::RemoteResource class.<br><br>
 *
...
class IRemoteResourceResponseListener
{

    public:

        virtual ~IRemoteResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::RemoteResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::RemoteResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::RemoteResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool onputRemote( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IREMOTERESOURCERESPONSELISTENER_H_ */
