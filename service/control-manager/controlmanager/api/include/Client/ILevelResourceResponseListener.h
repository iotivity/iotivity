...
#ifndef ILEVELRESOURCERESPONSELISTENER_H_
#define ILEVELRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   ILevelResourceResponseListener
 * @brief       ILevelResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::LevelResource class.<br><br>
 *
...
class ILevelResourceResponseListener
{

    public:

        virtual ~ILevelResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::LevelResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::LevelResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::LevelResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetLevel( int &requestId , int status, ::Level *respData) = 0;


        virtual bool onputLevel( int &requestId, int status ) = 0;
...
#endif /* ILEVELRESOURCERESPONSELISTENER_H_ */
