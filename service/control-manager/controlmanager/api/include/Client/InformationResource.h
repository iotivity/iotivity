...
#ifndef INFORMATIONRESOURCE_H_
#define INFORMATIONRESOURCE_H_

#include "CMClientResource.h"
#include "xsd/Elements.h"

#include "IInformationResourceResponseListener.h"
 ...
 * @brief   InformationResource class implements OC::Cm::Client::Resource::Resource and OC::Cm::Client::Resource::IResourceResponseListener @n
 ...
 */
class InformationResource : public OC::Cm::Client::Resource::Resource
{

    public:

        /**
         * Constructor of InformationResource class.
         *
         ...
         */
        InformationResource(OC::Cm::IContext *context, std::string &protocol, std::string &deviceAddress);

        /**
         * Default virtual destructor of InformationResource class.
         */
         ...
         *
         * @param[in]   InformationResourceResponseListener Object that implements IInformationResourceResponseListener interface
         */

        void addResponseListener (IInformationResourceResponseListener &respListener) ;

        IInformationResourceResponseListener *getResponseListener ();

        bool getInformation( int &requestId );


        void buildPath(std::string deviceId);

    private:
        class InformationResourceListenerInternal : public
            OC::Cm::Client::Resource::IResourceResponseListener
        {
            public:
                ...
                InformationResourceListenerInternal(InformationResource *res)
                {
                    resource = res;
                }

                ~InformationResourceListenerInternal()
                {
                }
                ...
                {
                    IInformationResourceResponseListener *p_respListener = resource->getResponseListener();
                    if (p_respListener != NULL)
                    {
                        if (response != NULL)
                        {
                            ...
                            if ( 0 == elementName.compare(EN_INFORMATION))
                            {
                                ::Information *respData = (::Information *)response ;
                                p_respListener->ongetInformation(clientSessionId, status,  respData) ;
                            }
                            else
                            {
                                p_respListener->ongetInformation(clientSessionId, 400,  NULL) ;
                            }
                        }
                        else
                        {
                            p_respListener->ongetInformation(clientSessionId, status,  NULL) ;
                        }
        ...
        /**
         * Variable that contains IInformationResourceResponseListener object.
         */
        IInformationResourceResponseListener *p_respListener ;

        OC::Cm::Client::Resource::IResourceResponseListener *p_internalResponseListener ;
};
/** @} */
#endif /* INFORMATIONRESOURCE_H_ */
