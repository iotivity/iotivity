...
#ifndef IHUMIDITYRESOURCERESPONSELISTENER_H_
#define IHUMIDITYRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IHumidityResourceResponseListener
 * @brief       IHumidityResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::HumidityResource class.<br><br>
 *
...
class IHumidityResourceResponseListener
{

    public:

        virtual ~IHumidityResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::HumidityResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::HumidityResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::HumidityResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetHumidity( int &requestId , int status, ::Humidity *respData) = 0;


        virtual bool onputHumidity( int &requestId, int status ) = 0;
...
#endif /* IHUMIDITYRESOURCERESPONSELISTENER_H_ */
