...
#ifndef IDETECTIONRESOURCERESPONSELISTENER_H_
#define IDETECTIONRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IDetectionResourceResponseListener
 * @brief       IDetectionResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::DetectionResource class.<br><br>
 *
...
class IDetectionResourceResponseListener
{

    public:

        virtual ~IDetectionResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DetectionResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DetectionResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::DetectionResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetDetection( int &requestId , int status, ::Detection *respData) = 0;


        virtual bool onputDetection( int &requestId, int status ) = 0;
...
#endif /* IDETECTIONRESOURCERESPONSELISTENER_H_ */
