...
#ifndef IALARMSRESOURCERESPONSELISTENER_H_
#define IALARMSRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IAlarmsResourceResponseListener
 * @brief       IAlarmsResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::AlarmsResource class.<br><br>
 *
...
class IAlarmsResourceResponseListener
{

    public:

        virtual ~IAlarmsResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::AlarmsResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::AlarmsResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::AlarmsResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetAlarms( int &requestId , int status, ::Alarms *respData) = 0;
...
/** @} */
#endif /* IALARMSRESOURCERESPONSELISTENER_H_ */
