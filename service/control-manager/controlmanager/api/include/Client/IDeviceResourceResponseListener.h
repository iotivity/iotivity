...
#ifndef IDEVICERESOURCERESPONSELISTENER_H_
#define IDEVICERESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IDeviceResourceResponseListener
 * @brief       IDeviceResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::DeviceResource class.<br><br>
 *
...
class IDeviceResourceResponseListener
{

    public:

        virtual ~IDeviceResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DeviceResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DeviceResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::DeviceResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetDevice( int &requestId , int status, ::Device *respData) = 0;


        virtual bool onputDevice( int &requestId, int status ) = 0;


        virtual bool ondeleteDevice( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IDEVICERESOURCERESPONSELISTENER_H_ */
