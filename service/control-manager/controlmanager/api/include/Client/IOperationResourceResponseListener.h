...
#ifndef IOPERATIONRESOURCERESPONSELISTENER_H_
#define IOPERATIONRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IOperationResourceResponseListener
 * @brief       IOperationResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::OperationResource class.<br><br>
 *
...
class IOperationResourceResponseListener
{

    public:

        virtual ~IOperationResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::OperationResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::OperationResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::OperationResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetOperation( int &requestId , int status, ::Operation *respData) = 0;


        virtual bool onputOperation( int &requestId, int status ) = 0;
...
#endif /* IOPERATIONRESOURCERESPONSELISTENER_H_ */
