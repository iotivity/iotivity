...
#ifndef IINFORMATIONRESOURCERESPONSELISTENER_H_
#define IINFORMATIONRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IInformationResourceResponseListener
 * @brief       IInformationResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::InformationResource class.<br><br>
 *
...
class IInformationResourceResponseListener
{

    public:

        virtual ~IInformationResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::InformationResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::InformationResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::InformationResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetInformation( int &requestId , int status, ::Information *respData) = 0;
...
/** @} */
#endif /* IINFORMATIONRESOURCERESPONSELISTENER_H_ */
