...
#ifndef INETWORKSRESOURCERESPONSELISTENER_H_
#define INETWORKSRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   INetworksResourceResponseListener
 * @brief       INetworksResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::NetworksResource class.<br><br>
 *
...
class INetworksResourceResponseListener
{

    public:

        virtual ~INetworksResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::NetworksResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::NetworksResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::NetworksResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetNetworks( int &requestId , int status, ::Networks *respData) = 0;


        virtual bool onputNetworks( int &requestId, int status ) = 0;
...
/** @} */
#endif /* INETWORKSRESOURCERESPONSELISTENER_H_ */
