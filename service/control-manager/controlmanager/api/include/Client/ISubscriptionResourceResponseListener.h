...
#ifndef ISUBSCRIPTIONRESOURCERESPONSELISTENER_H_
#define ISUBSCRIPTIONRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   ISubscriptionResourceResponseListener
 * @brief       ISubscriptionResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::SubscriptionResource class.<br><br>
 *
...
class ISubscriptionResourceResponseListener
{

    public:

        virtual ~ISubscriptionResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::SubscriptionResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::SubscriptionResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::SubscriptionResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetSubscription( int &requestId , int status, ::Subscription *respData) = 0;


        virtual bool onputSubscription( int &requestId, int status ) = 0;


        virtual bool ondeleteSubscription( int &requestId, int status ) = 0;
...
#endif /* ISUBSCRIPTIONRESOURCERESPONSELISTENER_H_ */
