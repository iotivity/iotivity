...
#ifndef INETWORKRESOURCERESPONSELISTENER_H_
#define INETWORKRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   INetworkResourceResponseListener
 * @brief       INetworkResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::NetworkResource class.<br><br>
 *
...
class INetworkResourceResponseListener
{

    public:

        virtual ~INetworkResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::NetworkResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::NetworkResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::NetworkResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetNetwork( int &requestId , int status, ::Network *respData) = 0;


        virtual bool onputNetwork( int &requestId, int status ) = 0;
...
/** @} */
#endif /* INETWORKRESOURCERESPONSELISTENER_H_ */
