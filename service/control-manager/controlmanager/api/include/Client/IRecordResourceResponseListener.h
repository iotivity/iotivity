...
#ifndef IRECORDRESOURCERESPONSELISTENER_H_
#define IRECORDRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IRecordResourceResponseListener
 * @brief       IRecordResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::RecordResource class.<br><br>
 *
...
class IRecordResourceResponseListener
{

    public:

        virtual ~IRecordResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::RecordResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::RecordResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::RecordResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetRecord( int &requestId , int status, ::Record *respData) = 0;


        virtual bool ondeleteRecord( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IRECORDRESOURCERESPONSELISTENER_H_ */
