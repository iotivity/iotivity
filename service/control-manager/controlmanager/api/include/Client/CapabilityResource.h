...
#ifndef CAPABILITYRESOURCE_H_
#define CAPABILITYRESOURCE_H_

#include "CMClientResource.h"
#include "xsd/Elements.h"

#include "ICapabilityResourceResponseListener.h"
 ...
 * @brief   CapabilityResource class implements OC::Cm::Client::Resource::Resource and OC::Cm::Client::Resource::IResourceResponseListener @n
 ...
 */
class CapabilityResource : public OC::Cm::Client::Resource::Resource
{

    public:

        /**
         * Constructor of CapabilityResource class.
         *
         ...
         */
        CapabilityResource(OC::Cm::IContext *context, std::string &protocol, std::string &deviceAddress);

        /**
         * Default virtual destructor of CapabilityResource class.
         */
        virtual ~CapabilityResource();
         ...
         *
         * @param[in]   CapabilityResourceResponseListener  Object that implements ICapabilityResourceResponseListener interface
         */

        void addResponseListener (ICapabilityResourceResponseListener &respListener) ;

        ICapabilityResourceResponseListener *getResponseListener ();

        bool getCapability( int &requestId );


        void buildPath( );

    private:
        class CapabilityResourceListenerInternal : public
            OC::Cm::Client::Resource::IResourceResponseListener
        {
            public:
                ...
                CapabilityResourceListenerInternal(CapabilityResource *res)
                {
                    resource = res;
                }

                ~CapabilityResourceListenerInternal()
                {
                }
                ...
                {
                    ICapabilityResourceResponseListener *p_respListener = resource->getResponseListener();
                    if (p_respListener != NULL)
                    {
                        if (response != NULL)
                        {
                            ...
                            {
                                ::Capability *respData = (::Capability *)response ;
                                p_respListener->ongetCapability(clientSessionId, status,  respData) ;
                            }
                            else
                            {
                                p_respListener->ongetCapability(clientSessionId, 400,  NULL) ;
                            }
                        }
                        else
                        {
                            p_respListener->ongetCapability(clientSessionId, status,  NULL) ;
                        }
        ...
        /**
         * Variable that contains ICapabilityResourceResponseListener object.
         */
        ICapabilityResourceResponseListener *p_respListener ;
