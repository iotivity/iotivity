...
#ifndef IDOORRESOURCERESPONSELISTENER_H_
#define IDOORRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IDoorResourceResponseListener
 * @brief       IDoorResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::DoorResource class.<br><br>
 *
...
class IDoorResourceResponseListener
{

    public:

        virtual ~IDoorResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DoorResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::DoorResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::DoorResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetDoor( int &requestId , int status, ::Door *respData) = 0;


        virtual bool onputDoor( int &requestId, int status ) = 0;
...
/** @} */
#endif /* IDOORRESOURCERESPONSELISTENER_H_ */
