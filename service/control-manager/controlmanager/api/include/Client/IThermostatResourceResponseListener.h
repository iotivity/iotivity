...
#ifndef ITHERMOSTATRESOURCERESPONSELISTENER_H_
#define ITHERMOSTATRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IThermostatResourceResponseListener
 * @brief       IThermostatResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::ThermostatResource class.<br><br>
 *
...
class IThermostatResourceResponseListener
{

    public:

        virtual ~IThermostatResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::ThermostatResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::ThermostatResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::ThermostatResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetThermostat( int &requestId , int status, ::Thermostat *respData) = 0;


        virtual bool onputThermostat( int &requestId, int status ) = 0;
...
#endif /* ITHERMOSTATRESOURCERESPONSELISTENER_H_ */
