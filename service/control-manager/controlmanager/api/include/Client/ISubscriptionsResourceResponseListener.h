...
#ifndef ISUBSCRIPTIONSRESOURCERESPONSELISTENER_H_
#define ISUBSCRIPTIONSRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   ISubscriptionsResourceResponseListener
 * @brief       ISubscriptionsResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::SubscriptionsResource class.<br><br>
 *
...
class ISubscriptionsResourceResponseListener
{

    public:

        virtual ~ISubscriptionsResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::SubscriptionsResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::SubscriptionsResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::SubscriptionsResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetSubscriptions( int &requestId , int status, ::Subscriptions *respData) = 0;


        virtual bool onpostSubscriptions( int &requestId , int status, std::string &location) = 0;
...
/** @} */
#endif /* ISUBSCRIPTIONSRESOURCERESPONSELISTENER_H_ */
