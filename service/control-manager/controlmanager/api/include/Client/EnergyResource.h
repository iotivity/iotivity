...
#ifndef ENERGYRESOURCE_H_
#define ENERGYRESOURCE_H_

#include "CMClientResource.h"
#include "xsd/Elements.h"

#include "IEnergyResourceResponseListener.h"
 ...
 * @brief   EnergyResource class implements OC::Cm::Client::Resource::Resource and OC::Cm::Client::Resource::IResourceResponseListener @n
 ...
 */
class EnergyResource : public OC::Cm::Client::Resource::Resource
{

    public:

        /**
         * Constructor of EnergyResource class.
         *
         ...
         */
        EnergyResource(OC::Cm::IContext *context, std::string &protocol, std::string &deviceAddress);

        /**
         * Default virtual destructor of EnergyResource class.
         */
         ...
         *
         * @param[in]   EnergyResourceResponseListener  Object that implements IEnergyResourceResponseListener interface
         */

        void addResponseListener (IEnergyResourceResponseListener &respListener) ;

        IEnergyResourceResponseListener *getResponseListener ();

        void buildPath( );

    private:
        class EnergyResourceListenerInternal : public OC::Cm::Client::Resource::IResourceResponseListener
        {
            public:

                EnergyResource *resource;

                EnergyResourceListenerInternal(EnergyResource *res)
                {
                    resource = res;
                }

                ~EnergyResourceListenerInternal()
                {
                }
                ...
                {
                    IEnergyResourceResponseListener *p_respListener = resource->getResponseListener();
        ...
        /**
         * Variable that contains IEnergyResourceResponseListener object.
         */
        IEnergyResourceResponseListener *p_respListener ;

        OC::Cm::Client::Resource::IResourceResponseListener *p_internalResponseListener ;

};
/** @} */
#endif /* ENERGYRESOURCE_H_ */
