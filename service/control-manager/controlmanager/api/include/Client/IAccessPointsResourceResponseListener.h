...
#ifndef IACCESSPOINTSRESOURCERESPONSELISTENER_H_
#define IACCESSPOINTSRESOURCERESPONSELISTENER_H_
...
/**
 * @interface   IAccessPointsResourceResponseListener
 * @brief       IAccessPointsResourceResponseListener interface provides listener methods to@n
 *              receive response of Control Manager requests which are sent using OC::Cm::Client::Resource::AccessPointsResource class.<br><br>
 *
...
class IAccessPointsResourceResponseListener
{

    public:

        virtual ~IAccessPointsResourceResponseListener() {} ;

        /**
         * Listener method to receive a response of add subscription request.<br>
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::AccessPointsResource.onSubscribeResponseReceived() method.
         *
         ...
         * In order to make this function to be called, please see the OC::Cm::Client::Resource::AccessPointsResource.onUnSubscribeResponseReceived() method.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
         * @param[in]   status      Http status code of the response
         */
        ...
        /**
         * Error callback method for the HTTP requests sent using OC::Cm::Client::Resource::AccessPointsResource class.
         *
         * @param[in]   requestId   Id of the request to which current response belongs
        ...
        virtual bool ongetAccessPoints( int &requestId , int status, ::AccessPoints *respData) = 0;
...
/** @} */
#endif /* IACCESSPOINTSRESOURCERESPONSELISTENER_H_ */
