...
public class ArrayOfUuid extends OC.Cm.Serialization.ISerializable {

    /**
     * Variable that contains UuidType objects in the List.
     */
    public java.util.List<OC.Cm.Serialization.Xsd.UuidType> members = new java.util.ArrayList<OC.Cm.Serialization.Xsd.UuidType>();
    ...
    public boolean serializeContents(ISerializer serializer) {
        ...
        try {
            ...
            for (OC.Cm.Serialization.Xsd.UuidType itr : members) {
        ...
        try {
            ...
            if (isArray) {
                ...
                for (int i = 0; i < sizeOfArray; i++) {
                    ...
                    OC.Cm.Serialization.Xsd.UuidType el;

                    el = new OC.Cm.Serialization.Xsd.UuidType();
