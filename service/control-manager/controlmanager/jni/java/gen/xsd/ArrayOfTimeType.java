...
public class ArrayOfTimeType extends OC.Cm.Serialization.ISerializable {

    /**
     * Variable that contains TimeType objects in the List.
     */
    public java.util.List<OC.Cm.Serialization.Xsd.TimeType> members = new java.util.ArrayList<OC.Cm.Serialization.Xsd.TimeType>();
    ...
    public boolean serializeContents(ISerializer serializer) {
        ...
        try {
            ...
            for (OC.Cm.Serialization.Xsd.TimeType itr : members) {
        ...
        try {
            ...
            if (isArray) {
                ...
                for (int i = 0; i < sizeOfArray; i++) {
                    ...
                    el = new OC.Cm.Serialization.Xsd.TimeType();
