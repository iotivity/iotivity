 ...
 * which are sent using gen.client.resource.NetworkResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface INetworkResourceResponseListener {
    /**
     ...
     * gen.client.resource.NetworkResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.NetworkResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.NetworkResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetNetwork(int clientSessionId, int statusCode,
            gen.xsd.Network respData);
     ...
     *            Http status code of the response
     */
    boolean onPutNetwork(int clientSessionId, int statusCode);
}
