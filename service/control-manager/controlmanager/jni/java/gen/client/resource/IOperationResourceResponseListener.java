 ...
 * which are sent using gen.client.resource.OperationResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IOperationResourceResponseListener {
    /**
     ...
     * gen.client.resource.OperationResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.OperationResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.OperationResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetOperation(int clientSessionId, int statusCode,
            gen.xsd.Operation respData);
     ...
     *            Http status code of the response
     */
    boolean onPutOperation(int clientSessionId, int statusCode);
}
