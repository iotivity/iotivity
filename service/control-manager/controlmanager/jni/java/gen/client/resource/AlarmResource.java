 ...
 * @since 1.0.0
 */
public class AlarmResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public AlarmResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param AlarmResourceResponseListener
     *            Object that implements IAlarmResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(IAlarmResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Alarm object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_ALARM)) {
                    gen.xsd.Alarm device = (gen.xsd.Alarm) respData;
                    p_respListener.onGetAlarm(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetAlarm(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetAlarm(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    /**
     * This method sends a http GET request to the Alarm resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.AlarmResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method will designate a resource path corresponds to this Alarm
     * resource.
     * 
     * @param deviceId
     *            DeviceId that represents [/devices] resource.
     * @param alarmId
     *            AlarmId that represents [/alarms] resource.
     */
    public void buildPath(String deviceId, String alarmId) {
        buildTemplatePath("/devices/{deviceId}/alarms/{alarmId}", deviceId,
                alarmId);
    }
}
