 ...
 * @since 1.0.0
 */
public class EnergyConsumptionResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public EnergyConsumptionResource(long context, String protocol,
     ...
     * 
     * @param EnergyConsumptionResourceResponseListener
     *            Object that implements
     *            IEnergyConsumptionResourceResponseListener interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IEnergyConsumptionResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received EnergyConsumption object through the deserializer.
     *            This object should not be re-initialized by the user.
     * @since 1.0.0
     */
    @Override
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_ENERGYCONSUMPTION)) {
                    gen.xsd.EnergyConsumption device = (gen.xsd.EnergyConsumption) respData;
                    p_respListener.onGetEnergyConsumption(clientSessionId,
                            statusCode, device);
                } else {
                    p_respListener.onGetEnergyConsumption(clientSessionId, 400,
                            null);
                }
            } else {
                p_respListener.onGetEnergyConsumption(clientSessionId,
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutEnergyConsumption(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the EnergyConsumption resource.
     * This is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.EnergyConsumptionResource.OnGetResponseReceived()
     * method.
     * 
    ...
    /**
     * This method sends a http PUT request to the EnergyConsumption resource.
     * This is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.EnergyConsumptionResource.OnPutResponseReceived()
     * method.
     * 
     * @param reqData
     *            EnergyConsumption object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putEnergyConsumption(gen.xsd.EnergyConsumption reqData) {
        try {
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/energyconsumption", deviceId);
    }
}
