 ...
 * which are sent using gen.client.resource.MessagesResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IMessagesResourceResponseListener {
    /**
     ...
     * gen.client.resource.MessagesResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.MessagesResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.MessagesResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the
     * gen.client.resource.MessagesResource.OnGetResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     *            Http status code of the response
     * @param respData
     *            Received Messages object through the deserializer. This object
     *            should not be re-initialized by the user.
     */
    boolean onGetMessages(int clientSessionId, int statusCode,
            gen.xsd.Messages respData);

    /**
     * Listener method to receive a response of PUT request.<br>
     * Please see the
     * gen.client.resource.MessagesResource.OnPutResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     *            Http status code of the response
     */
    boolean onPutMessages(int clientSessionId, int statusCode);

    /**
     * Listener method to receive a response of POST request.<br>
     * Please see the
     * gen.client.resource.MessagesResource.OnPostResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     *            should not be re-initialized by the user.
     */
    boolean onPostMessages(int clientSessionId, int statusCode, String location);

    /**
     * Listener method to receive a response of DELETE request.<br>
     * Please see the
     * gen.client.resource.MessagesResource.OnDeleteResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     *            Http status code of the response
     */
    boolean onDeleteMessages(int clientSessionId, int statusCode);
}
