 ...
 * @since 1.0.0
 */
public class TemperaturesResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public TemperaturesResource(long context, String protocol,
     ...
     * 
     * @param TemperaturesResourceResponseListener
     *            Object that implements ITemperaturesResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            ITemperaturesResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Temperatures object through the deserializer. This
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_TEMPERATURES)) {
                    gen.xsd.Temperatures device = (gen.xsd.Temperatures) respData;
                    p_respListener.onGetTemperatures(clientSessionId,
                            statusCode, device);
                } else {
                    p_respListener
                            .onGetTemperatures(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetTemperatures(clientSessionId, statusCode,
                        null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutTemperatures(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Temperatures resource. This
     * is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.TemperaturesResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Temperatures resource. This
     * is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.TemperaturesResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Temperatures object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putTemperatures(gen.xsd.Temperatures reqData) {
        try {
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/temperatures", deviceId);
    }
}
