 ...
 * which are sent using gen.client.resource.NotificationsResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface INotificationsResourceResponseListener {
    /**
     ...
     * gen.client.resource.NotificationsResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.NotificationsResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.NotificationsResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onPostNotifications(int clientSessionId, int statusCode,
            String location);
}
