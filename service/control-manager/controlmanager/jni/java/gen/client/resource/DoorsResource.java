 ...
 * @since 1.0.0
 */
public class DoorsResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public DoorsResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param DoorsResourceResponseListener
     *            Object that implements IDoorsResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(IDoorsResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Doors object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_DOORS)) {
                    gen.xsd.Doors device = (gen.xsd.Doors) respData;
                    p_respListener.onGetDoors(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetDoors(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetDoors(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutDoors(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Doors resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.DoorsResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Doors resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.DoorsResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Doors object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putDoors(gen.xsd.Doors reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Doors
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/doors", deviceId);
    }
}
