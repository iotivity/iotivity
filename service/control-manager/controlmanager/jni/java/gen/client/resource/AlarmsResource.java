 ...
 * @since 1.0.0
 */
public class AlarmsResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public AlarmsResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param AlarmsResourceResponseListener
     *            Object that implements IAlarmsResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(IAlarmsResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Alarms object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_ALARMS)) {
                    gen.xsd.Alarms device = (gen.xsd.Alarms) respData;
                    p_respListener.onGetAlarms(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetAlarms(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetAlarms(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    /**
     * This method sends a http GET request to the Alarms resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.AlarmsResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method will designate a resource path corresponds to this Alarms
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/alarms", deviceId);
    }
}
