 ...
 * which are sent using gen.client.resource.EnergyConsumptionResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IEnergyConsumptionResourceResponseListener {
    /**
     ...
     * gen.client.resource
     * .EnergyConsumptionResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource
     * .EnergyConsumptionResource.onUnSubscribeResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param status
     ...
     * gen.client.resource.EnergyConsumptionResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetEnergyConsumption(int clientSessionId, int statusCode,
            gen.xsd.EnergyConsumption respData);
     ...
     *            Http status code of the response
     */
    boolean onPutEnergyConsumption(int clientSessionId, int statusCode);
}
