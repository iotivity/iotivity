 ...
 * which are sent using gen.client.resource.VersionResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IVersionResourceResponseListener {
    /**
     ...
     * gen.client.resource.VersionResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.VersionResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.VersionResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetVersion(int clientSessionId, int statusCode,
            gen.xsd.Version respData);
     ...
     *            Http status code of the response
     */
    boolean onPutVersion(int clientSessionId, int statusCode);
}
