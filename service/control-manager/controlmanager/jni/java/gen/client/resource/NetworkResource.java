 ...
 * @since 1.0.0
 */
public class NetworkResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public NetworkResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param NetworkResourceResponseListener
     *            Object that implements INetworkResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            INetworkResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Network object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_NETWORK)) {
                    gen.xsd.Network device = (gen.xsd.Network) respData;
                    p_respListener.onGetNetwork(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetNetwork(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetNetwork(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutNetwork(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Network resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.NetworkResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Network resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.NetworkResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Network object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putNetwork(gen.xsd.Network reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Network
     * resource.
     * 
     * @param deviceId
