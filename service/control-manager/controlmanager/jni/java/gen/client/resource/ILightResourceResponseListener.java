 ...
 * which are sent using gen.client.resource.LightResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface ILightResourceResponseListener {
    /**
     ...
     * gen.client.resource.LightResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.LightResource.onUnSubscribeResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param status
     ...
     * gen.client.resource.LightResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.LightResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     */
    boolean onGetLight(int clientSessionId, int statusCode,
            gen.xsd.Light respData);

    /**
     * Listener method to receive a response of PUT request.<br>
     * Please see the gen.client.resource.LightResource.OnPutResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     */
    boolean onPutLight(int clientSessionId, int statusCode);
}
