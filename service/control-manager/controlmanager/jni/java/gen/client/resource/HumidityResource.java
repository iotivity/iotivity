 ...
 * @since 1.0.0
 */
public class HumidityResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public HumidityResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param HumidityResourceResponseListener
     *            Object that implements IHumidityResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IHumidityResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Humidity object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_HUMIDITY)) {
                    gen.xsd.Humidity device = (gen.xsd.Humidity) respData;
                    p_respListener.onGetHumidity(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetHumidity(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetHumidity(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutHumidity(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Humidity resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.HumidityResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Humidity resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.HumidityResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Humidity object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putHumidity(gen.xsd.Humidity reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Humidity
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/humidity", deviceId);
    }
}
