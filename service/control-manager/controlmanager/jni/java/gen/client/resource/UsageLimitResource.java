 ...
 * @since 1.0.0
 */
public class UsageLimitResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public UsageLimitResource(long context, String protocol,
     ...
     * 
     * @param UsageLimitResourceResponseListener
     *            Object that implements IUsageLimitResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IUsageLimitResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received UsageLimit object through the deserializer. This
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_USAGELIMIT)) {
                    gen.xsd.UsageLimit device = (gen.xsd.UsageLimit) respData;
                    p_respListener.onGetUsageLimit(clientSessionId, statusCode,
                            device);
                } else {
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutUsageLimit(clientSessionId, statusCode);
        }
    }
    ...
    public void onDeleteResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onDeleteUsageLimit(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the UsageLimit resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.UsageLimitResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the UsageLimit resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.UsageLimitResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            UsageLimit object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putUsageLimit(gen.xsd.UsageLimit reqData) {
        try {
    ...
    /**
     * This method sends a http DELETE request to the UsageLimit resource. This
     * is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.UsageLimitResource.OnDeleteResponseReceived() method.
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     *         OnDeleteResponseReceived() method.<br>
     *         (-1) In case of any error. Error description will be printed out
     *         to the console if available.
     */
    public int deleteUsageLimit() {
        try {
            return this.deleteResource(null, this);
        } catch (Exception e) {
            return -1;
        }
    }
    ...
    /**
     * This method will designate a resource path corresponds to this UsageLimit
     * resource.
     * 
     * @param usagelimitId
     *            UsagelimitId that represents [/usagelimits] resource.
     */
    public void buildPath(String usagelimitId) {
        buildTemplatePath("/energy/usagelimits/{usagelimitId}", usagelimitId);
    }
}
