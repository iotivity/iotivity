 ...
 * which are sent using gen.client.resource.DetectionResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IDetectionResourceResponseListener {
    /**
     ...
     * gen.client.resource.DetectionResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.DetectionResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.DetectionResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetDetection(int clientSessionId, int statusCode,
            gen.xsd.Detection respData);
     ...
     *            Http status code of the response
     */
    boolean onPutDetection(int clientSessionId, int statusCode);
}
