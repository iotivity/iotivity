 ...
 * @since 1.0.0
 */
public class ConfigurationResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public ConfigurationResource(long context, String protocol,
     ...
     * 
     * @param ConfigurationResourceResponseListener
     *            Object that implements IConfigurationResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IConfigurationResourceResponseListener respListener) {
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_CONFIGURATION)) {
                    gen.xsd.Configuration device = (gen.xsd.Configuration) respData;
                    p_respListener.onGetConfiguration(clientSessionId,
                            statusCode, device);
                } else {
                    p_respListener.onGetConfiguration(clientSessionId, 400,
                            null);
                }
            } else {
                p_respListener.onGetConfiguration(clientSessionId, statusCode,
                        null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutConfiguration(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Configuration resource. This
    ...
    /**
     * This method sends a http PUT request to the Configuration resource. This
     * is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.ConfigurationResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Configuration object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putConfiguration(gen.xsd.Configuration reqData) {
        try {
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/configuration", deviceId);
    }
}
