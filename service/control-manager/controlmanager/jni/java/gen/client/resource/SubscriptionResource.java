 ...
 * @since 1.0.0
 */
public class SubscriptionResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public SubscriptionResource(long context, String protocol,
     ...
     * 
     * @param SubscriptionResourceResponseListener
     *            Object that implements ISubscriptionResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            ISubscriptionResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Subscription object through the deserializer. This
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_SUBSCRIPTION)) {
                    gen.xsd.Subscription device = (gen.xsd.Subscription) respData;
                    p_respListener.onGetSubscription(clientSessionId,
                            statusCode, device);
                } else {
                    p_respListener
                            .onGetSubscription(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetSubscription(clientSessionId, statusCode,
                        null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutSubscription(clientSessionId, statusCode);
        }
    }
    ...
    public void onDeleteResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onDeleteSubscription(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Subscription resource. This
     * is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.SubscriptionResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Subscription resource. This
     * is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.SubscriptionResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Subscription object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putSubscription(gen.xsd.Subscription reqData) {
        try {
    ...
    /**
     * This method sends a http DELETE request to the Subscription resource.
     * This is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.SubscriptionResource.OnDeleteResponseReceived()
     * method.
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *            SubscriptionId that represents [/subscriptions] resource.
     */
    public void buildPath(String subscriptionId) {
        buildTemplatePath("/subscriptions/{subscriptionId}", subscriptionId);
    }
}
