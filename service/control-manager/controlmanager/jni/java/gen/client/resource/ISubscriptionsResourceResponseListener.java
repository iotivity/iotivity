 ...
 * which are sent using gen.client.resource.SubscriptionsResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface ISubscriptionsResourceResponseListener {
    /**
     ...
     * gen.client.resource.SubscriptionsResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.SubscriptionsResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.SubscriptionsResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetSubscriptions(int clientSessionId, int statusCode,
            gen.xsd.Subscriptions respData);
     ...
     *            object should not be re-initialized by the user.
     */
    boolean onPostSubscriptions(int clientSessionId, int statusCode,
            String location);
}
