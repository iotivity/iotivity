 ...
 * @since 1.0.0
 */
public class DevicesResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public DevicesResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param DevicesResourceResponseListener
     *            Object that implements IDevicesResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IDevicesResourceResponseListener respListener) {
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_DEVICES)) {
                    gen.xsd.Devices device = (gen.xsd.Devices) respData;
                    p_respListener.onGetDevices(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetDevices(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetDevices(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPostResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            ...
            p_respListener.onPostDevices(clientSessionId, statusCode, location);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Devices resource. This is an
    ...
    /**
     * This method sends a http POST request to the Devices resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.DevicesResource.OnPostResponseReceived() method.
     * 
     * @param reqData
     *            Devices object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int postDevices(gen.xsd.Device reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Devices
     * resource.
     */
