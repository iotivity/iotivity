 ...
 * which are sent using gen.client.resource.NetworksResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface INetworksResourceResponseListener {
    /**
     ...
     * gen.client.resource.NetworksResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.NetworksResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.NetworksResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetNetworks(int clientSessionId, int statusCode,
            gen.xsd.Networks respData);
     ...
     *            Http status code of the response
     */
    boolean onPutNetworks(int clientSessionId, int statusCode);
}
