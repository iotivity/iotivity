 ...
 * @since 1.0.0
 */
public class OperationResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public OperationResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param OperationResourceResponseListener
     *            Object that implements IOperationResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IOperationResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Operation object through the deserializer. This
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_OPERATION)) {
                    gen.xsd.Operation device = (gen.xsd.Operation) respData;
                    p_respListener.onGetOperation(clientSessionId, statusCode,
                            device);
                } else {
                ...
                p_respListener
                        .onGetOperation(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutOperation(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Operation resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.OperationResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Operation resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.OperationResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Operation object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putOperation(gen.xsd.Operation reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Operation
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/operation", deviceId);
    }
}
