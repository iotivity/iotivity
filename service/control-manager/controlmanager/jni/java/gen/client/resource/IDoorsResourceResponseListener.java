 ...
 * which are sent using gen.client.resource.DoorsResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IDoorsResourceResponseListener {
    /**
     ...
     * gen.client.resource.DoorsResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.DoorsResource.onUnSubscribeResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param status
     ...
     * gen.client.resource.DoorsResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.DoorsResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     */
    boolean onGetDoors(int clientSessionId, int statusCode,
            gen.xsd.Doors respData);

    /**
     * Listener method to receive a response of PUT request.<br>
     * Please see the gen.client.resource.DoorsResource.OnPutResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     */
    boolean onPutDoors(int clientSessionId, int statusCode);
}
