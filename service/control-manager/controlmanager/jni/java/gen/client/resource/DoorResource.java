 ...
 * @since 1.0.0
 */
public class DoorResource extends Resource implements IResourceResponseListener {
    /**
     ...
     * @since 1.0.0
     */
    public DoorResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param DoorResourceResponseListener
     *            Object that implements IDoorResourceResponseListener interface
     * @since 1.0.0
     */
    public void addResponseListener(IDoorResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Door object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_DOOR)) {
                    gen.xsd.Door device = (gen.xsd.Door) respData;
                    p_respListener.onGetDoor(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetDoor(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetDoor(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutDoor(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Door resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.DoorResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Door resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.DoorResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Door object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putDoor(gen.xsd.Door reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Door
     * resource.
     * 
     * @param deviceId
     *            DeviceId that represents [/devices] resource.
     * @param doorId
     *            DoorId that represents [/doors] resource.
     */
    public void buildPath(String deviceId, String doorId) {
        buildTemplatePath("/devices/{deviceId}/doors/{doorId}", deviceId,
                doorId);
    }
}
