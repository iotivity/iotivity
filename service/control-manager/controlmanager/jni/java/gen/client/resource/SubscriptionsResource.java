 ...
 * @since 1.0.0
 */
public class SubscriptionsResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public SubscriptionsResource(long context, String protocol,
     ...
     * 
     * @param SubscriptionsResourceResponseListener
     *            Object that implements ISubscriptionsResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            ISubscriptionsResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Subscriptions object through the deserializer. This
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_SUBSCRIPTIONS)) {
                    gen.xsd.Subscriptions device = (gen.xsd.Subscriptions) respData;
                    p_respListener.onGetSubscriptions(clientSessionId,
                            statusCode, device);
                } else {
                    p_respListener.onGetSubscriptions(clientSessionId, 400,
                            null);
                }
            } else {
                p_respListener.onGetSubscriptions(clientSessionId, statusCode,
                        null);
            }
        }
    }
    ...
    public void OnPostResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            ...
            p_respListener.onPostSubscriptions(clientSessionId, statusCode,
                    location);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Subscriptions resource. This
     * is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.SubscriptionsResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http POST request to the Subscriptions resource. This
     * is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.SubscriptionsResource.OnPostResponseReceived()
     * method.
     * 
     * @param reqData
     *            Subscriptions object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int postSubscriptions(gen.xsd.Subscription reqData) {
        try {
