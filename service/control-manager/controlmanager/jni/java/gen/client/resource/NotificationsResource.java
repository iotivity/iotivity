 ...
 * @since 1.0.0
 */
public class NotificationsResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public NotificationsResource(long context, String protocol,
     ...
     * 
     * @param NotificationsResourceResponseListener
     *            Object that implements INotificationsResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            INotificationsResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Notifications object through the deserializer. This
    ...
    public void OnPostResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            ...
            p_respListener.onPostNotifications(clientSessionId, statusCode,
                    location);
        }
    }
    ...
    /**
     * This method sends a http POST request to the Notifications resource. This
     * is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.NotificationsResource.OnPostResponseReceived()
     * method.
     * 
     * @param reqData
     *            Notifications object to be sent
     * 
     ...
     */
    public int postNotifications(gen.xsd.Notification reqData) {
        try {
