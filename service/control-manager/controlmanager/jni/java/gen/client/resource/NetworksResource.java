 ...
 * @since 1.0.0
 */
public class NetworksResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public NetworksResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param NetworksResourceResponseListener
     *            Object that implements INetworksResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            INetworksResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Networks object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_NETWORKS)) {
                    gen.xsd.Networks device = (gen.xsd.Networks) respData;
                    p_respListener.onGetNetworks(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetNetworks(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetNetworks(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutNetworks(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Networks resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.NetworksResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Networks resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.NetworksResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Networks object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putNetworks(gen.xsd.Networks reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Networks
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/configuration/networks",
                deviceId);
    }
}
