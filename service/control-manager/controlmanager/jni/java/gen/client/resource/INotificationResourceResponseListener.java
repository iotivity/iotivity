 ...
 * which are sent using gen.client.resource.NotificationResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface INotificationResourceResponseListener {
    /**
     ...
     * gen.client.resource.NotificationResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.NotificationResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.NotificationResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
