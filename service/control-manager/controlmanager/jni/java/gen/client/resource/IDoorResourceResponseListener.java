 ...
 * which are sent using gen.client.resource.DoorResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IDoorResourceResponseListener {
    /**
     ...
     * gen.client.resource.DoorResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.DoorResource.onUnSubscribeResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param status
     ...
     * gen.client.resource.DoorResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.DoorResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     */
    boolean onGetDoor(int clientSessionId, int statusCode, gen.xsd.Door respData);

    /**
     * Listener method to receive a response of PUT request.<br>
     * Please see the gen.client.resource.DoorResource.OnPutResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     */
    boolean onPutDoor(int clientSessionId, int statusCode);
}
