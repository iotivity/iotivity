 ...
 * which are sent using gen.client.resource.CapabilityResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface ICapabilityResourceResponseListener {
    /**
     ...
     * gen.client.resource.CapabilityResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.CapabilityResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.CapabilityResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetCapability(int clientSessionId, int statusCode,
