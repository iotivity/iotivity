 ...
 * @since 1.0.0
 */
public class AccessPointsResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public AccessPointsResource(long context, String protocol,
     ...
     * 
     * @param AccessPointsResourceResponseListener
     *            Object that implements IAccessPointsResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IAccessPointsResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received AccessPoints object through the deserializer. This
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_ACCESSPOINTS)) {
                    gen.xsd.AccessPoints device = (gen.xsd.AccessPoints) respData;
                    p_respListener.onGetAccessPoints(clientSessionId,
                            statusCode, device);
                } else {
                    p_respListener
                            .onGetAccessPoints(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetAccessPoints(clientSessionId, statusCode,
                        null);
            }
        }
    }
    ...
    /**
     * This method sends a http GET request to the AccessPoints resource. This
     * is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.AccessPointsResource.OnGetResponseReceived() method.
     * 
