 ...
 * which are sent using gen.client.resource.ThermostatResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IThermostatResourceResponseListener {
    /**
     ...
     * gen.client.resource.ThermostatResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.ThermostatResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.ThermostatResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetThermostat(int clientSessionId, int statusCode,
            gen.xsd.Thermostat respData);
     ...
     *            Http status code of the response
     */
    boolean onPutThermostat(int clientSessionId, int statusCode);
}
