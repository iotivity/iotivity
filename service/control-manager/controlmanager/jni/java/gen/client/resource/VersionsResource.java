 ...
 * @since 1.0.0
 */
public class VersionsResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public VersionsResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param VersionsResourceResponseListener
     *            Object that implements IVersionsResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IVersionsResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Versions object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_VERSIONS)) {
                    gen.xsd.Versions device = (gen.xsd.Versions) respData;
                    p_respListener.onGetVersions(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetVersions(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetVersions(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutVersions(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Versions resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.VersionsResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Versions resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.VersionsResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Versions object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putVersions(gen.xsd.Versions reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Versions
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/information/versions", deviceId);
    }
}
