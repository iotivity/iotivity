 ...
 * @since 1.0.0
 */
public class LightResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public LightResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param LightResourceResponseListener
     *            Object that implements ILightResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(ILightResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Light object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_LIGHT)) {
                    gen.xsd.Light device = (gen.xsd.Light) respData;
                    p_respListener.onGetLight(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetLight(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetLight(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutLight(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Light resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.LightResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Light resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.LightResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Light object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putLight(gen.xsd.Light reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Light
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/light", deviceId);
    }
}
