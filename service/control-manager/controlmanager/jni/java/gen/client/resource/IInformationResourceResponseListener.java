 ...
 * which are sent using gen.client.resource.InformationResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IInformationResourceResponseListener {
    /**
     ...
     * gen.client.resource.InformationResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.InformationResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.InformationResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetInformation(int clientSessionId, int statusCode,
