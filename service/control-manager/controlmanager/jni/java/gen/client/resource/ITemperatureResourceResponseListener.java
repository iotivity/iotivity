 ...
 * which are sent using gen.client.resource.TemperatureResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface ITemperatureResourceResponseListener {
    /**
     ...
     * gen.client.resource.TemperatureResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.TemperatureResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.TemperatureResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetTemperature(int clientSessionId, int statusCode,
            gen.xsd.Temperature respData);
     ...
     *            Http status code of the response
     */
    boolean onPutTemperature(int clientSessionId, int statusCode);
}
