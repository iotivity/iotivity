 ...
 * which are sent using gen.client.resource.AccessPointsResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IAccessPointsResourceResponseListener {
    /**
     ...
     * gen.client.resource.AccessPointsResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.AccessPointsResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.AccessPointsResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetAccessPoints(int clientSessionId, int statusCode,
            gen.xsd.AccessPoints respData);
}
