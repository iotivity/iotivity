 ...
 * which are sent using gen.client.resource.MovementResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IMovementResourceResponseListener {
    /**
     ...
     * gen.client.resource.MovementResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.MovementResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.MovementResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetMovement(int clientSessionId, int statusCode,
            gen.xsd.Movement respData);
     ...
     *            Http status code of the response
     */
    boolean onPutMovement(int clientSessionId, int statusCode);
}
