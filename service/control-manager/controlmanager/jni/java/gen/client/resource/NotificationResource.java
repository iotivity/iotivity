 ...
 * @since 1.0.0
 */
public class NotificationResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public NotificationResource(long context, String protocol,
     ...
     * 
     * @param NotificationResourceResponseListener
     *            Object that implements INotificationResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            INotificationResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Notification object through the deserializer. This
     ...
     *            NotificationId that represents [/notifications] resource.
     */
    public void buildPath(String notificationId) {
        buildTemplatePath("/notifications/{notificationId}", notificationId);
    }
}
