 ...
 * @since 1.0.0
 */
public class LongPollingNotificationResource extends Resource implements
        IResourceResponseListener {
    /**
     * Variable that contains ILongPollingNotificationResourceResponseListener
     * object.
     */
     ...
     * @since 1.0.0
     */
    public LongPollingNotificationResource(long context, String protocol,
     ...
     * 
     * @param LongPollingNotificationResourceResponseListener
     *            Object that implements
     *            ILongPollingNotificationResourceResponseListener interface
     * @since 1.0.0
     */
     ...
     *            Response headers
     * @param respData
     *            Received LongPollingNotification object through the
     *            deserializer. This object should not be re-initialized by the
     *            user.
     * @since 1.0.0
     */
    @Override
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName
                        .compareTo(Elements.EN_LONGPOLLINGNOTIFICATION)) {
                    gen.xsd.LongPollingNotification device = (gen.xsd.LongPollingNotification) respData;
                    p_respListener.onGetLongPollingNotification(
                            clientSessionId, statusCode, device);
                } else {
                    p_respListener.onGetLongPollingNotification(
                            clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetLongPollingNotification(clientSessionId,
                        statusCode, null);
            }
        }
    }
    ...
    /**
     * This method sends a http GET request to the LongPollingNotification
     * resource. This is an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.LongPollingNotificationResource
     * .OnGetResponseReceived() method.
     * 
     ...
     */
    public int getLongPollingNotification() {
        try {
     ...
     * LongPollingNotification resource.
     */
