 ...
 * which are sent using gen.client.resource.RemoteResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IRemoteResourceResponseListener {
    /**
     ...
     * gen.client.resource.RemoteResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.RemoteResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.RemoteResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.RemoteResource.OnPutResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     */
    boolean onPutRemote(int clientSessionId, int statusCode);
}
