 ...
 * @since 1.0.0
 */
public class LevelResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public LevelResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param LevelResourceResponseListener
     *            Object that implements ILevelResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(ILevelResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Level object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_LEVEL)) {
                    gen.xsd.Level device = (gen.xsd.Level) respData;
                    p_respListener.onGetLevel(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetLevel(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetLevel(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutLevel(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Level resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.LevelResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Level resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.LevelResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Level object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putLevel(gen.xsd.Level reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Level
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/level", deviceId);
    }
}
