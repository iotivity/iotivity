 ...
 * which are sent using gen.client.resource.SubscriptionResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface ISubscriptionResourceResponseListener {
    /**
     ...
     * gen.client.resource.SubscriptionResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.SubscriptionResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.SubscriptionResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetSubscription(int clientSessionId, int statusCode,
            gen.xsd.Subscription respData);
     ...
     *            Http status code of the response
     */
    boolean onPutSubscription(int clientSessionId, int statusCode);
     ...
     *            Http status code of the response
     */
    boolean onDeleteSubscription(int clientSessionId, int statusCode);
}
