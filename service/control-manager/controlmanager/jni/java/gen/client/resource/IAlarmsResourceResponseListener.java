 ...
 * which are sent using gen.client.resource.AlarmsResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IAlarmsResourceResponseListener {
    /**
     ...
     * gen.client.resource.AlarmsResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.AlarmsResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.AlarmsResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.AlarmsResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     */
    boolean onGetAlarms(int clientSessionId, int statusCode,
            gen.xsd.Alarms respData);
}
