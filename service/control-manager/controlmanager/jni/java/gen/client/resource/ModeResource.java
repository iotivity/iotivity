 ...
 * @since 1.0.0
 */
public class ModeResource extends Resource implements IResourceResponseListener {
    /**
     ...
     * @since 1.0.0
     */
    public ModeResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param ModeResourceResponseListener
     *            Object that implements IModeResourceResponseListener interface
     * @since 1.0.0
     */
    public void addResponseListener(IModeResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Mode object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_MODE)) {
                    gen.xsd.Mode device = (gen.xsd.Mode) respData;
                    p_respListener.onGetMode(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetMode(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetMode(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutMode(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Mode resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.ModeResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Mode resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.ModeResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Mode object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putMode(gen.xsd.Mode reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Mode
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/mode", deviceId);
    }
}
