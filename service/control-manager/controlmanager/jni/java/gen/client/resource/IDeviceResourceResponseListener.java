 ...
 * which are sent using gen.client.resource.DeviceResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IDeviceResourceResponseListener {
    /**
     ...
     * gen.client.resource.DeviceResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.DeviceResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.DeviceResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.DeviceResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     */
    boolean onGetDevice(int clientSessionId, int statusCode,
            gen.xsd.Device respData);

    /**
     * Listener method to receive a response of PUT request.<br>
     * Please see the gen.client.resource.DeviceResource.OnPutResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     */
    boolean onPutDevice(int clientSessionId, int statusCode);
     ...
     *            Http status code of the response
     */
    boolean onDeleteDevice(int clientSessionId, int statusCode);
}
