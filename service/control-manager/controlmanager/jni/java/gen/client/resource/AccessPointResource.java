 ...
 * @since 1.0.0
 */
public class AccessPointResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public AccessPointResource(long context, String protocol,
     ...
     * 
     * @param AccessPointResourceResponseListener
     *            Object that implements IAccessPointResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IAccessPointResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received AccessPoint object through the deserializer. This
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_ACCESSPOINT)) {
                    gen.xsd.AccessPoint device = (gen.xsd.AccessPoint) respData;
                    p_respListener.onGetAccessPoint(clientSessionId,
                            statusCode, device);
                } else {
                    p_respListener.onGetAccessPoint(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetAccessPoint(clientSessionId, statusCode,
                        null);
            }
        }
    }
    ...
    /**
     * This method sends a http GET request to the AccessPoint resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.AccessPointResource.OnGetResponseReceived() method.
     * 
     ...
     * @param accesspointId
     *            AccesspointId that represents [/accesspoints] resource.
     */
    public void buildPath(String deviceId, String networkId,
        ...
        buildTemplatePath(
                ...
                deviceId, networkId, accesspointId);
    }
}
