 ...
 * @since 1.0.0
 */
public class CapabilityResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public CapabilityResource(long context, String protocol,
     ...
     * 
     * @param CapabilityResourceResponseListener
     *            Object that implements ICapabilityResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            ICapabilityResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Capability object through the deserializer. This
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_CAPABILITY)) {
                    gen.xsd.Capability device = (gen.xsd.Capability) respData;
                    p_respListener.onGetCapability(clientSessionId, statusCode,
                            device);
                } else {
    ...
    /**
     * This method sends a http GET request to the Capability resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.CapabilityResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method will designate a resource path corresponds to this Capability
     * resource.
     */
