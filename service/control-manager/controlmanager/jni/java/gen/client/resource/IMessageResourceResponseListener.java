 ...
 * which are sent using gen.client.resource.MessageResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IMessageResourceResponseListener {
    /**
     ...
     * gen.client.resource.MessageResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.MessageResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.MessageResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the
     * gen.client.resource.MessageResource.OnGetResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     *            Http status code of the response
     * @param respData
     *            Received Message object through the deserializer. This object
     *            should not be re-initialized by the user.
     */
    boolean onGetMessage(int clientSessionId, int statusCode,
            gen.xsd.Message respData);

    /**
     * Listener method to receive a response of PUT request.<br>
     * Please see the
     * gen.client.resource.MessageResource.OnPutResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     *            Http status code of the response
     */
    boolean onPutMessage(int clientSessionId, int statusCode);

    /**
     * Listener method to receive a response of DELETE request.<br>
     * Please see the
     * gen.client.resource.MessageResource.OnDeleteResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     *            Http status code of the response
     */
    boolean onDeleteMessage(int clientSessionId, int statusCode);
}
