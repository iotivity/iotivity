 ...
 * @since 1.0.0
 */
public class VersionResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public VersionResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param VersionResourceResponseListener
     *            Object that implements IVersionResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IVersionResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Version object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_VERSION)) {
                    gen.xsd.Version device = (gen.xsd.Version) respData;
                    p_respListener.onGetVersion(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetVersion(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetVersion(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutVersion(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Version resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.VersionResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Version resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.VersionResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Version object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putVersion(gen.xsd.Version reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Version
     * resource.
     * 
     * @param deviceId
     *            DeviceId that represents [/devices] resource.
     * @param versionId
     *            VersionId that represents [/versions] resource.
     */
    public void buildPath(String deviceId, String versionId) {
        buildTemplatePath(
