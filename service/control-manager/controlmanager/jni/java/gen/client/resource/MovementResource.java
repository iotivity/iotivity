 ...
 * @since 1.0.0
 */
public class MovementResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public MovementResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param MovementResourceResponseListener
     *            Object that implements IMovementResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IMovementResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Movement object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_MOVEMENT)) {
                    gen.xsd.Movement device = (gen.xsd.Movement) respData;
                    p_respListener.onGetMovement(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetMovement(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetMovement(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutMovement(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Movement resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.MovementResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Movement resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.MovementResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Movement object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putMovement(gen.xsd.Movement reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Movement
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/movement", deviceId);
    }
}
