 ...
 * which are sent using gen.client.resource.HumidityResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IHumidityResourceResponseListener {
    /**
     ...
     * gen.client.resource.HumidityResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.HumidityResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.HumidityResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetHumidity(int clientSessionId, int statusCode,
            gen.xsd.Humidity respData);
     ...
     *            Http status code of the response
     */
    boolean onPutHumidity(int clientSessionId, int statusCode);
}
