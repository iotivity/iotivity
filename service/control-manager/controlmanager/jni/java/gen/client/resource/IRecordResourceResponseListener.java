 ...
 * which are sent using gen.client.resource.RecordResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IRecordResourceResponseListener {
    /**
     ...
     * gen.client.resource.RecordResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.RecordResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.RecordResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.RecordResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     * @param respData
     *            Received Record object through the deserializer. This object
     *            should not be re-initialized by the user.
     */
    boolean onGetRecord(int clientSessionId, int statusCode,
            gen.xsd.Record respData);

    /**
     * Listener method to receive a response of DELETE request.<br>
     * Please see the
     * gen.client.resource.RecordResource.OnDeleteResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     *            Http status code of the response
     */
    boolean onDeleteRecord(int clientSessionId, int statusCode);
}
