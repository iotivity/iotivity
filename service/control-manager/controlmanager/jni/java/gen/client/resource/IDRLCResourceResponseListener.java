 ...
 * which are sent using gen.client.resource.DRLCResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IDRLCResourceResponseListener {
    /**
     ...
     * gen.client.resource.DRLCResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.DRLCResource.onUnSubscribeResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param status
     ...
     * gen.client.resource.DRLCResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.DRLCResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     * @param respData
     *            Received DRLC object through the deserializer. This object
     *            should not be re-initialized by the user.
     */
    boolean onGetDRLC(int clientSessionId, int statusCode, gen.xsd.DRLC respData);

    /**
     * Listener method to receive a response of PUT request.<br>
     * Please see the gen.client.resource.DRLCResource.OnPutResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     */
    boolean onPutDRLC(int clientSessionId, int statusCode);
}
