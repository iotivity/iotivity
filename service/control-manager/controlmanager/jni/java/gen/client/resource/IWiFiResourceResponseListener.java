 ...
 * which are sent using gen.client.resource.WiFiResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IWiFiResourceResponseListener {
    /**
     ...
     * gen.client.resource.WiFiResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.WiFiResource.onUnSubscribeResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param status
     ...
     * gen.client.resource.WiFiResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.WiFiResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     */
    boolean onGetWiFi(int clientSessionId, int statusCode, gen.xsd.WiFi respData);

    /**
     * Listener method to receive a response of PUT request.<br>
     * Please see the gen.client.resource.WiFiResource.OnPutResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     */
    boolean onPutWiFi(int clientSessionId, int statusCode);
}
