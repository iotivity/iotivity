 ...
 * which are sent using gen.client.resource.UsagesResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IUsagesResourceResponseListener {
    /**
     ...
     * gen.client.resource.UsagesResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.UsagesResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.UsagesResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.UsagesResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     */
    boolean onGetUsages(int clientSessionId, int statusCode,
            gen.xsd.Usages respData);
}
