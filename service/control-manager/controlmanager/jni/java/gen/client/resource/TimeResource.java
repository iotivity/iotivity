 ...
 * @since 1.0.0
 */
public class TimeResource extends Resource implements IResourceResponseListener {
    /**
     ...
     * @since 1.0.0
     */
    public TimeResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param TimeResourceResponseListener
     *            Object that implements ITimeResourceResponseListener interface
     * @since 1.0.0
     */
    public void addResponseListener(ITimeResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Time object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_TIME)) {
                    gen.xsd.Time device = (gen.xsd.Time) respData;
                    p_respListener.onGetTime(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetTime(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetTime(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutTime(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Time resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.TimeResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Time resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.TimeResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Time object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putTime(gen.xsd.Time reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Time
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/configuration/time", deviceId);
    }
}
