 ...
 * which are sent using gen.client.resource.AlarmResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IAlarmResourceResponseListener {
    /**
     ...
     * gen.client.resource.AlarmResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.AlarmResource.onUnSubscribeResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param status
     ...
     * gen.client.resource.AlarmResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.AlarmResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     */
    boolean onGetAlarm(int clientSessionId, int statusCode,
            gen.xsd.Alarm respData);
}
