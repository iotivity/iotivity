 ...
 * @since 1.0.0
 */
public class DeviceResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public DeviceResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param DeviceResourceResponseListener
     *            Object that implements IDeviceResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(IDeviceResourceResponseListener respListener) {
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_DEVICE)) {
                    gen.xsd.Device device = (gen.xsd.Device) respData;
                    p_respListener.onGetDevice(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetDevice(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetDevice(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutDevice(clientSessionId, statusCode);
        }
    }
    ...
    public void onDeleteResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onDeleteDevice(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Device resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.DeviceResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Device resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.DeviceResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Device object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putDevice(gen.xsd.Device reqData) {
        try {
    ...
    /**
     * This method sends a http DELETE request to the Device resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.DeviceResource.OnDeleteResponseReceived() method.
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
    ...
    /**
     * This method will designate a resource path corresponds to this Device
     * resource.
     * 
     * @param deviceId
     *            DeviceId that represents [/devices] resource.
     */
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}", deviceId);
    }
}
