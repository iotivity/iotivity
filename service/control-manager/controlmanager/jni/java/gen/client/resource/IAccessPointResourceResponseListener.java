 ...
 * which are sent using gen.client.resource.AccessPointResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IAccessPointResourceResponseListener {
    /**
     ...
     * gen.client.resource.AccessPointResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.AccessPointResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.AccessPointResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetAccessPoint(int clientSessionId, int statusCode,
            gen.xsd.AccessPoint respData);
}
