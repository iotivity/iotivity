 ...
 * which are sent using gen.client.resource.VersionsResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IVersionsResourceResponseListener {
    /**
     ...
     * gen.client.resource.VersionsResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.VersionsResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.VersionsResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetVersions(int clientSessionId, int statusCode,
            gen.xsd.Versions respData);
     ...
     *            Http status code of the response
     */
    boolean onPutVersions(int clientSessionId, int statusCode);
}
