 ...
 * which are sent using gen.client.resource.TemperaturesResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface ITemperaturesResourceResponseListener {
    /**
     ...
     * gen.client.resource.TemperaturesResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.TemperaturesResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.TemperaturesResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetTemperatures(int clientSessionId, int statusCode,
            gen.xsd.Temperatures respData);
     ...
     *            Http status code of the response
     */
    boolean onPutTemperatures(int clientSessionId, int statusCode);
}
