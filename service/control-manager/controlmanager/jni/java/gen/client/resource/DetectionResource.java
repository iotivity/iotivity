 ...
 * @since 1.0.0
 */
public class DetectionResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public DetectionResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param DetectionResourceResponseListener
     *            Object that implements IDetectionResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IDetectionResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Detection object through the deserializer. This
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_DETECTION)) {
                    gen.xsd.Detection device = (gen.xsd.Detection) respData;
                    p_respListener.onGetDetection(clientSessionId, statusCode,
                            device);
                } else {
                ...
                p_respListener
                        .onGetDetection(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutDetection(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Detection resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.DetectionResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Detection resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.DetectionResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Detection object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putDetection(gen.xsd.Detection reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Detection
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/detection", deviceId);
    }
}
