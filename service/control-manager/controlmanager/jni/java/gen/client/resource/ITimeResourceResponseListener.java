 ...
 * which are sent using gen.client.resource.TimeResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface ITimeResourceResponseListener {
    /**
     ...
     * gen.client.resource.TimeResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.TimeResource.onUnSubscribeResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param status
     ...
     * gen.client.resource.TimeResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.TimeResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     */
    boolean onGetTime(int clientSessionId, int statusCode, gen.xsd.Time respData);

    /**
     * Listener method to receive a response of PUT request.<br>
     * Please see the gen.client.resource.TimeResource.OnPutResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     */
    boolean onPutTime(int clientSessionId, int statusCode);
}
