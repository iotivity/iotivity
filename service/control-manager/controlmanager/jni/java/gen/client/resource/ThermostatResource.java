 ...
 * @since 1.0.0
 */
public class ThermostatResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public ThermostatResource(long context, String protocol,
     ...
     * 
     * @param ThermostatResourceResponseListener
     *            Object that implements IThermostatResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IThermostatResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Thermostat object through the deserializer. This
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_THERMOSTAT)) {
                    gen.xsd.Thermostat device = (gen.xsd.Thermostat) respData;
                    p_respListener.onGetThermostat(clientSessionId, statusCode,
                            device);
                } else {
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutThermostat(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the Thermostat resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.ThermostatResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method sends a http PUT request to the Thermostat resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.ThermostatResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            Thermostat object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putThermostat(gen.xsd.Thermostat reqData) {
        try {
    ...
    /**
     * This method will designate a resource path corresponds to this Thermostat
     * resource.
     * 
     * @param deviceId
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/thermostat", deviceId);
    }
}
