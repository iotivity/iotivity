 ...
 * which are sent using gen.client.resource.EnergyResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IEnergyResourceResponseListener {
    /**
     ...
     * gen.client.resource.EnergyResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.EnergyResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.EnergyResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
