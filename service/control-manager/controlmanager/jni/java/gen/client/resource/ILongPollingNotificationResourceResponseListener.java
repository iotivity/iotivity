 ...
 * which are sent using gen.client.resource.LongPollingNotificationResource
 * class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface ILongPollingNotificationResourceResponseListener {
    /**
     ...
     * gen.client.resource
     * .LongPollingNotificationResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource
     * .LongPollingNotificationResource.onUnSubscribeResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param status
     ...
     * gen.client.resource.LongPollingNotificationResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.LongPollingNotificationResource.
     ...
     *            user.
     */
    boolean onGetLongPollingNotification(int clientSessionId, int statusCode,
            gen.xsd.LongPollingNotification respData);
}
