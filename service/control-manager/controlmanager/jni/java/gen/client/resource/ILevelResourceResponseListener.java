 ...
 * which are sent using gen.client.resource.LevelResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface ILevelResourceResponseListener {
    /**
     ...
     * gen.client.resource.LevelResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.LevelResource.onUnSubscribeResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param status
     ...
     * gen.client.resource.LevelResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.LevelResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     */
    boolean onGetLevel(int clientSessionId, int statusCode,
            gen.xsd.Level respData);

    /**
     * Listener method to receive a response of PUT request.<br>
     * Please see the gen.client.resource.LevelResource.OnPutResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     */
    boolean onPutLevel(int clientSessionId, int statusCode);
}
