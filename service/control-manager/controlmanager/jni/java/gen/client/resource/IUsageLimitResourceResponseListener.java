 ...
 * which are sent using gen.client.resource.UsageLimitResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IUsageLimitResourceResponseListener {
    /**
     ...
     * gen.client.resource.UsageLimitResource.onSubscribeResponseReceived()
     * method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.UsageLimitResource.onUnSubscribeResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     * gen.client.resource.UsageLimitResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     */
    boolean onGetUsageLimit(int clientSessionId, int statusCode,
            gen.xsd.UsageLimit respData);
     ...
     *            Http status code of the response
     */
    boolean onPutUsageLimit(int clientSessionId, int statusCode);
     ...
     *            Http status code of the response
     */
    boolean onDeleteUsageLimit(int clientSessionId, int statusCode);
}
