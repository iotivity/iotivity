 ...
 * @since 1.0.0
 */
public class InformationResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public InformationResource(long context, String protocol,
     ...
     * 
     * @param InformationResourceResponseListener
     *            Object that implements IInformationResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IInformationResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Information object through the deserializer. This
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_INFORMATION)) {
                    gen.xsd.Information device = (gen.xsd.Information) respData;
                    p_respListener.onGetInformation(clientSessionId,
                            statusCode, device);
                } else {
                    p_respListener.onGetInformation(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetInformation(clientSessionId, statusCode,
                        null);
            }
        }
    }
    ...
    /**
     * This method sends a http GET request to the Information resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.InformationResource.OnGetResponseReceived() method.
     * 
    ...
    public void buildPath(String deviceId) {
        buildTemplatePath("/devices/{deviceId}/information", deviceId);
    }
}
