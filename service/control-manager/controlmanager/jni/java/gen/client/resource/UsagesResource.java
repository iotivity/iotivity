 ...
 * @since 1.0.0
 */
public class UsagesResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public UsagesResource(long context, String protocol, String deviceAddress) {
     ...
     * 
     * @param UsagesResourceResponseListener
     *            Object that implements IUsagesResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(IUsagesResourceResponseListener respListener) {
     ...
     *            Response headers
     * @param respData
     *            Received Usages object through the deserializer. This object
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_USAGES)) {
                    gen.xsd.Usages device = (gen.xsd.Usages) respData;
                    p_respListener.onGetUsages(clientSessionId, statusCode,
                            device);
                } else {
                    p_respListener.onGetUsages(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetUsages(clientSessionId, statusCode, null);
            }
        }
    }
    ...
    /**
     * This method sends a http GET request to the Usages resource. This is an
     * asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.UsagesResource.OnGetResponseReceived() method.
     * 
    ...
    /**
     * This method will designate a resource path corresponds to this Usages
     * resource.
     */
