 ...
 * which are sent using gen.client.resource.ModeResource class.<br>
 * <br>
 * 
 ...
 * @since 1.0.0
 */
public interface IModeResourceResponseListener {
    /**
     ...
     * gen.client.resource.ModeResource.onSubscribeResponseReceived() method.
     * 
     ...
     * In order to make this function to be called, please see the
     * gen.client.resource.ModeResource.onUnSubscribeResponseReceived() method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param status
     ...
     * gen.client.resource.ModeResource class.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     * @param statusCode
     ...
     * Please see the gen.client.resource.ModeResource.OnGetResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     */
    boolean onGetMode(int clientSessionId, int statusCode, gen.xsd.Mode respData);

    /**
     * Listener method to receive a response of PUT request.<br>
     * Please see the gen.client.resource.ModeResource.OnPutResponseReceived()
     * method.
     * 
     * @param clientSessionId
     *            Id of the request to which current response belongs
     ...
     *            Http status code of the response
     */
    boolean onPutMode(int clientSessionId, int statusCode);
}
