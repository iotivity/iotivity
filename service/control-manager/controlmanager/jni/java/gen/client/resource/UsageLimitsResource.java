 ...
 * @since 1.0.0
 */
public class UsageLimitsResource extends Resource implements
     ...
     * @since 1.0.0
     */
    public UsageLimitsResource(long context, String protocol,
     ...
     * 
     * @param UsageLimitsResourceResponseListener
     *            Object that implements IUsageLimitsResourceResponseListener
     *            interface
     * @since 1.0.0
     */
    public void addResponseListener(
            IUsageLimitsResourceResponseListener respListener) {
    ...
    public void OnGetResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            if (respData != null) {
                ...
                if (0 == elementName.compareTo(Elements.EN_USAGELIMITS)) {
                    gen.xsd.UsageLimits device = (gen.xsd.UsageLimits) respData;
                    p_respListener.onGetUsageLimits(clientSessionId,
                            statusCode, device);
                } else {
                    p_respListener.onGetUsageLimits(clientSessionId, 400, null);
                }
            } else {
                p_respListener.onGetUsageLimits(clientSessionId, statusCode,
                        null);
            }
        }
    }
    ...
    public void OnPutResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onPutUsageLimits(clientSessionId, statusCode);
        }
    }
    ...
    public void OnPostResponseReceived(int clientSessionId, int statusCode,
        ...
        if (p_respListener != null) {
            ...
            p_respListener.onPostUsageLimits(clientSessionId, statusCode,
                    location);
        }
    }
    ...
    public void onDeleteResponseReceived(int clientSessionId, int statusCode,
            HeadersList headers, ISerializable respData) {
        if (p_respListener != null) {
            p_respListener.onDeleteUsageLimits(clientSessionId, statusCode);
        }
    }
    ...
    /**
     * This method sends a http GET request to the UsageLimits resource. This is
    ...
    /**
     * This method sends a http PUT request to the UsageLimits resource. This is
     * an asynchronous method.<br>
     * Response of this request can be achieved through the
     * gen.client.resource.UsageLimitsResource.OnPutResponseReceived() method.
     * 
     * @param reqData
     *            UsageLimits object to be sent
     * 
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     ...
     *         to the console if available.
     */
    public int putUsageLimits(gen.xsd.UsageLimits reqData) {
        try {
    ...
    /**
     * This method sends a http POST request to the UsageLimits resource. This
     ...
     * @return (clientSessionId) Id of the request to which current request
     *         belongs. This value is equivalent to the first argument of the
     *         OnPostResponseReceived() method.<br>
     *         (-1) In case of any error. Error description will be printed out
     *         to the console if available.
     */
    public int postUsageLimits(gen.xsd.UsageLimit reqData) {
        try {
            return this.post(null, (OC.Cm.Serialization.ISerializable) reqData,
                    this);
        } catch (Exception e) {
            return -1;
        }
    ...
    /**
     * This method sends a http DELETE request to the UsageLimits resource. This
     * is an asynchronous method.<br>
     * Response of this request can be achieved through the
