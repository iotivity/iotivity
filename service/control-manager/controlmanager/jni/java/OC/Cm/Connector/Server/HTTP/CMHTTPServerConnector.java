...
package OC.Cm.Connector.Server.HTTP;

import OC.Cm.Connector.Server.NativeServerConnector;

public class CMHTTPServerConnector extends NativeServerConnector {

    private static native long constructNative(String ipaddress, String port);

    public CMHTTPServerConnector(String ipaddress, String port) {
