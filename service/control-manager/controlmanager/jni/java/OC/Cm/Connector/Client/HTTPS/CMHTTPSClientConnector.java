...
package OC.Cm.Connector.Client.HTTPS;

import OC.Cm.Connector.IConnectorConfiguration;
import OC.Cm.Connector.SSLConfiguration;
import OC.Cm.Connector.Client.NativeClientConnector;

public class CMHTTPSClientConnector extends NativeClientConnector {
    private static native long constructNative();

    public CMHTTPSClientConnector() {
