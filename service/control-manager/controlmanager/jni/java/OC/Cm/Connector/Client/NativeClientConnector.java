...
public class NativeClientConnector extends IClientConnector {
    ...
    public NativeClientConnector(long nativeHandle) {
    ...
    // used from java..
    @Override
    public boolean init(int clientId) {
        return false;
    }
    ...
    @Override
    public int sendRequest(ClientSession client_session) {
        return 0;
    }

    @Override
    public ClientSession createNewSession(String deviceAddress) {
        return null;
    }
