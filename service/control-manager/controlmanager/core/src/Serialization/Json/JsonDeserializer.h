        ...
        namespace Core
        {
            namespace Serialization
            {
                namespace Json
                {
                     ...
                     *
                     */
                    class CMAPI JsonDeserializer : public OC::Cm::Serialization::IDeserializer
                    {
                        ...
                        public:
                            ...
                            bool getArrayPropertyValue(std::string arrayName, std::string propertyName, int index,
                                                       std::string &value) ;
