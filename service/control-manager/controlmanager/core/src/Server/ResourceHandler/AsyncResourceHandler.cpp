    ...
    namespace Cm
    {
        namespace Server
        {
            namespace ResourceHandler
            {
                ...
                bool
                AsyncResourceHandler::sendResponse( int statusCode,
                                                    ...
                                                    OC::Cm::Serialization::ISerializable  *response)
                {
                    ...
                    return pContext->m_engine.sendResponse(statusCode, response, session);
                }

                bool
                AsyncResourceHandler::handleResource( OC::Cm::Connector::Server::ServerSession &session,
                                                      std::string methodId,
                ...
                bool
                AsyncResourceHandler::onInit()
                {
                    return true ;
                }

                bool
                AsyncResourceHandler::onDeinit()
                {
                    return true ;
                }
