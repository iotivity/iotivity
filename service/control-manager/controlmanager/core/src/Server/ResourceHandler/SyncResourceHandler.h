        ...
        namespace Server
        {
            namespace ResourceHandler
            {
                ...
                */
                 ...
                 * @brief       Defines methods required to handle Control Manager requests synchronously
                 *
                 * @since       1.0
                 *
                 * This interface defines methods to handle Control Manager requests synchronously
                 *
                 */
                class CMAPI SyncResourceHandler : public IResourceHandler
                {
                    public:
                         ...
                         *                  @c false in case of any error
                         */
                        virtual bool handleResource( OC::Cm::Connector::Server::ServerSession &session,
                                                     std::string methodId,
                         ...
                         *                  @c false in case of any error
                         */
                        virtual bool validateRepresentation( OC::Cm::Serialization::ISerializable  *data,
                                                             const std::string elementName ) ;

                    protected:
                        IContext *p_context
                        ;   /**< Represents the instance of the Control Manager Context where Control Manager has started */
