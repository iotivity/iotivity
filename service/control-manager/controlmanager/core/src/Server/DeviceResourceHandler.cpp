...
DeviceResourceHandler::DeviceResourceHandler(OC::Cm::IContext *pContext)
...
bool
DeviceResourceHandler::handleSyncResource( OC::Cm::Connector::Server::ServerSession &session,
        std::string methodId,
        int &statusCode,
        ...
        OC::Cm::Serialization::ISerializable *response)
{
    ...
    { statusCode = 405 ; session.getResponse().m_headers.setHeader( "Allow", "GET, PUT, DELETE") ;}

    return true ;
}

bool
DeviceResourceHandler::onGET( OC::Cm::Connector::Server::ServerSession &session, int &statusCode,
                              ::Device *respData)
{
    return MyDevice::getInstance()->getDevice(respData);
}

bool
DeviceResourceHandler::onPUT( OC::Cm::Connector::Server::ServerSession &session, int &statusCode,
                              ::Device *reqData)
{
...
bool
DeviceResourceHandler::onDELETE( OC::Cm::Connector::Server::ServerSession &session, int &statusCode)
{
    // TODO: Autogenerated code. Add Resource implementation here
    // TODO: Default Status Code is: 501 - Not Implemented.  Replace Default Status Code based on implementation!
    statusCode = 501;
