...
namespace OC
{
    namespace Cm
    {
        namespace Connector
        {
            namespace Server
            {
                ServerSession::ServerSession(int serverId, std::string clientProtocol, std::string clientAddress)
                    : Session(serverId)
                {
                ...
                int
                ServerSession::getServerId() const
                {
                    return m_Id ;
                }

                std::string
                ServerSession::getClientProtocol() const
                {
                    return m_clientProtocol ;
                }

                std::string
                ServerSession::getClientAddress() const
                {
                ...
                {
                    // ToDo: Ranjith - implement ServerSession::getClientDevice()
                    return NULL ;
                }
