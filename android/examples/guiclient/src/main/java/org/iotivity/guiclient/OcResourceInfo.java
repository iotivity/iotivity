...
import static org.iotivity.guiclient.OcProtocolStrings.*;
...
public class OcResourceInfo
            ...
            if (null != this.mResource) {
                ...
                switch (attribute.getType()) {
                    ...
                    case ROOM_TEMPERATURE_SENSOR_READING:
                        break;
                    default:
                        Log.e(TAG, "doOcPut(): unrecognized attribute type.");
                        break;
                }
                try {
    ...
    /**
     * TODO Developer Note:
     * The choice to use a static Object here as a Lock, in order to serialize the entire
     * callback across OcResourceInfo objects, was intentional.
     * The reason is that because this is an example project, it was desirable for the
     * Log messages to correspond clearly with the execution of the code.
     * In actual product, the "static" would be removed, and the execution would still
     * be correct, even though the Log messages and such might be confusing during debugging.
     */
