...
include $(CLEAR_VARS)
OIC_LIB_PATH := ../../../../resource/csdk/connectivity/lib/android
LOCAL_MODULE := libandroid-gthread-2.40.2
LOCAL_SRC_FILES := $(OIC_LIB_PATH)/libgthread-2.40.2.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
OIC_LIB_PATH := ../../../../resource/csdk/connectivity/lib/android
LOCAL_MODULE := libandroid-glib-2.40.2
LOCAL_SRC_FILES := $(OIC_LIB_PATH)/libglib-2.40.2.so
include $(PREBUILT_SHARED_LIBRARY)
...
LOCAL_STATIC_LIBRARIES += android-glib-2.40.2
LOCAL_STATIC_LIBRARIES += android-gthread-2.40.2
...
LOCAL_C_INCLUDES += $(OIC_SRC_PATH)/../extlibs/boost/boost_1_57_0
