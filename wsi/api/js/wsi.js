...
(function(root) {
    ...
    */
     ...
     * @param  {function} successCallback
     */
    WSISDK.deleteService = function(id, successCallback) {
        var url = WSISDK.config.serverURL + "/wsi/service/" + id;
        var xhr = new XMLHttpRequest();;
        xhr.open('GET', url, true);
        xhr.onload = function() {
            if (xhr.status >= 200 && xhr.status < 300) {
    ...
    /**
     * Provide A&A info to access a capability
     * @param  {function} body
     * @param  {function} successCallback
     */
     ...
     * @param  {function} successCallback
     */
    WSISDK.exec = function(id, body, successCallback) {
        var url = WSISDK.config.serverURL + "/wsi/cap/post/" + id;
        var xhr = new XMLHttpRequest();;
        xhr.open('POST', url, true);
        xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
        xhr.onload = function() {
