...
# Keep packageRevision in sync with extlibs/libwebsockets/SConscript's setting
...
packageUrl="https://github.com/warmcat/libwebsockets.git"
packageDir="./extlibs/libwebsockets/libwebsockets"
packageRevision="v2.2-stable"
