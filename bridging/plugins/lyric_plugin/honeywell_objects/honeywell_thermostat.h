...
#ifndef __HONEYWELL_THERMOSTAT_H__
#define __HONEYWELL_THERMOSTAT_H__
...
public:
    ...
    {
        bool result = false;
        result = (m_changeableValues == ht.m_changeableValues);
        return result;
    }
    ...
    GW_RESULT setTemperature(const THERMOSTAT data);
