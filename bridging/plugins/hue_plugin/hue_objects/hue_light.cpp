...
HueLight::HueLight(std::string uri, std::string bridge_ip, std::string bridge_mac, std::string short_id, std::string json) :
...
GW_RESULT HueLight::get()
{
    CurlClient cc = CurlClient(CURL_GET, m_uri)
...
GW_RESULT HueLight::parseJsonResponse(std::string json)
{
...
GW_RESULT HueLight::put(rapidjson::Document &doc)
{
...
GW_RESULT HueLight::getInternalState(rapidjson::Document &doc)
{
...
GW_RESULT HueLight::getInternalConfig(rapidjson::Document &doc)
{
...
GW_RESULT HueLight::getState(light_state_t &state, bool refresh)
{
...
GW_RESULT HueLight::setState(light_state_t &state)
{
...
GW_RESULT HueLight::getConfig(light_config_t &config)
{
