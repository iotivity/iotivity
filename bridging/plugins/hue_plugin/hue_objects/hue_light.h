...
public:
    ...
    HueLight(std::string uri, std::string bridge_ip, std::string bridge_mac, std::string short_id, std::string json);
     ...
     */
    GW_RESULT getState(light_state_t &state, bool refresh = false);
     ...
     * @return  GW_RESULT_OK on success, or another GW_RESULT_XXX on error.
     */
    GW_RESULT setState(light_state_t &state);
     ...
     * @return GW_RESULT_OK on success, or another GW_RESULT_XXX on error.
     */
    GW_RESULT getConfig(light_config_t &config);
...
private:
     ...
     * @return GW_RESULT_OK on success, or another GW_RESULT_XXX code on error.
     */
    GW_RESULT put(rapidjson::Document &doc);
     ...
     * @return GW_RESULT_OK on success, or another GW_RESULT_XXX on error.
     */
    GW_RESULT getInternalState(rapidjson::Document &doc);
     ...
     * @return GW_RESULT_OK on success, or another GW_RESULT_XXX on error.
     */
    GW_RESULT getInternalConfig(rapidjson::Document &doc);


    GW_RESULT parseJsonResponse(std::string json);
