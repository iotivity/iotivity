                                        ...
                                        OCClientResponse *clientResponse)
{
    ...
    std::cout << "Discovery response received" << std::endl;
    ...
    if (clientResponse)
    {
        ...
        if (clientResponse->result == OC_STACK_OK)
        {
            ...
            {
                std::cout << "Found secure resource --> "<< std::endl;
                std::cout << "Uri: " << coapServerResource << std::endl;
                std::cout << "Host: " << clientResponse->devAddr.addr << ":" << clientResponse->devAddr.port << std::endl;
                std::cout << "Adapter: " << clientResponse->devAddr.adapter << std::endl;
                switch (TestCase)
                {
