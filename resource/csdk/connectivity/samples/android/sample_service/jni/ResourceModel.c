...
CAResult_t get_remote_address(CAConnectivityType_t connectivityType, CAAddress_t addressInfo);
...
Java_com_iotivity_service_RMInterface_setNativeResponseListener(JNIEnv *env, jobject obj,
                                                                jobject listener)
{
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMInitialize(JNIEnv *env, jobject obj, jobject context)
{
    LOGI("RMInitialize");
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMTerminate(JNIEnv *env, jobject obj)
{
    LOGI("RMTerminate");
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMStartListeningServer(JNIEnv *env, jobject obj)
{
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMStartDiscoveryServer(JNIEnv *env, jobject obj)
{
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMRegisterHandler(JNIEnv *env, jobject obj)
{
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMFindResource(JNIEnv *env, jobject obj, jstring uri)
{
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMSendRequest(JNIEnv *env, jobject obj, jstring uri,
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMSendReqestToAll(JNIEnv *env, jobject obj, jstring uri,
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMSendResponse(JNIEnv *env, jobject obj,
                                                     jint selectedNetwork,
                                                     jint isSecured, jint msgType,
                                                     jint responseValue)
{
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMAdvertiseResource(JNIEnv *env, jobject obj, jstring uri)
{
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMSendNotification(JNIEnv *env, jobject obj, jstring uri,
                                                         jstring payload, jint selectedNetwork,
                                                         jint isSecured, jint msgType,
                                                         jint responseValue)
{
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMSelectNetwork(JNIEnv *env, jobject obj, jint networkType)
{
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMUnSelectNetwork(JNIEnv *env, jobject obj, jint networkType)
{
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMGetNetworkInfomation(JNIEnv *env, jobject obj)
{
...
JNIEXPORT void JNICALL
Java_com_iotivity_service_RMInterface_RMHandleRequestResponse(JNIEnv *env, jobject obj)
{
...
void request_handler(const CARemoteEndpoint_t* object, const CARequestInfo_t* requestInfo)
{
    ...
    CAResult_t res = get_remote_address(object->connectivityType, object->addressInfo);
    if (CA_STATUS_OK != res)
    {
        return;
    }
    ...
    if (requestInfo->info.payload && CA_WIFI == object->connectivityType)
    {
...
void response_handler(const CARemoteEndpoint_t* object, const CAResponseInfo_t* responseInfo)
{
    ...
    //Check if this has secure communication information
    if (responseInfo->info.payload && CA_WIFI == object->connectivityType)
    {
...
CAResult_t get_remote_address(CAConnectivityType_t connectivityType, CAAddress_t addressInfo)
{
    ...
    else if (CA_EDR == connectivityType)
    {
    ...
    else if (CA_LE == connectivityType)
    {
