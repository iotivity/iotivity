 ...
 */
JNIEXPORT void JNICALL Java_com_iotivity_service_RMInterface_RMSendReqestToAll
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_iotivity_service_RMInterface_RMUnSelectNetwork
  (JNIEnv *, jobject, jint);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_iotivity_service_RMInterface_RMGetNetworkInfomation
  (JNIEnv *, jobject);
