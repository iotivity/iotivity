...
/**
 * API to creates link list and initializes the elements.
 ...
 * Linklist elements are deleted, Calling function must take care of free
 ...
 * @return CAResult_t
 * CA_STATUS_OK if Success, CA_STATUS_INVALID_PARAM if iterator is NULL.
 */
 ...
 */
uint32_t u_linklist_length(u_linklist_t *list);
 ...
 * @return NONE
 */
void u_linklist_init_iterator(u_linklist_t *list, u_linklist_iterator_t **iter);
 ...
 */
void *u_linklist_get_data(u_linklist_iterator_t *iter);
