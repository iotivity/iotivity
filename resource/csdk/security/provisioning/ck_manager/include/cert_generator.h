 ...
 *
 * @param subjectName pointer to serial subject's common name
 * @param issuerName pointer to issuer's common name
 * @param notBefore pointer to certificate validity limit
 * @param notAfter pointer to certificate validity limit
 * @param subjectPublicKey pointer to subject's public key to be signed
 * @param issuerPrivateKey pointer to issuer's private key to sign certificate
 * @param encodedCertificate pointer to allocated memory for DER encoded certificate
