 ...
 *
 * @param subjectName pointer to subject's common name
 * @param subjectPublicKey pointer to subject's public key to be signed
 * @param subjectPrivateKey pointer to subject's private key to be signed
 ...
 * @param subjectName pointer to allocated memory for subject's common name extraction
 *          (CSR_MAX_NAME_SIZE bytes should be allocated)
 * @param subjectPublicKey pointer to allocated memory for subject's public key extraction
