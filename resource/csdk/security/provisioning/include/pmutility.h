 ...
 * @param isOwned       bool flag for owned / unowned discovery
 * @param ppList        List of OCProvisionDev_t.
 *
 ...
 *
 * @param pList         List of OCProvisionDev_t.
 */
 ...
 *
 * @param  waittime  Timeout in seconds.
 * @param waitForStackResponse if true timeout function will call OCProcess while waiting.
 * @return OC_STACK_OK on success otherwise error.
 */
 ...
 *
 * @param src pointer of OCProvisionDev_t to be copied.
 *
 ...
 *
 * @param isSeucre Choose whether to encrypt the payload.
 * @param address Network address of remote device
 * @param port Port number
 * @param connType Connectivity type of remote device
 * @param buffer A buffer to save the query.
 ...
 *
 * @param pDev Pointer to OCProvisionDev_t. It's information will be printed by OC_LOG_XX
 *
 */
 ...
 *
 * @param pUuidList a pointer to UUID list.
 * @param targetId  a pointer to UUID to be deleted in the list.
 *
