 ...
 * @param pDev1 Pointer to PMOwnedDeviceInfo_t instance,respresenting resource to be provsioned.
   @param pDev2 Pointer to PMOwnedDeviceInfo_t instance,respresenting resource to be provsioned.
 * @param resultCallback callback provided by API user, callback will be called when
 ...
 * @param pTargetDev1 first device information to be unlinked.
