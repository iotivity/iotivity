 ...
 * @param ptDeviceId     Device ID of provisioning tool.
 * @param firstDeviceId  DeviceID of the first device.
 * @param secondDeviceId DeviceID of the second device.
 * @param firstCred      Generated credential for first device.
 * @param secondCred     Generated credential for second device.
 ...
 * @param cred           Generated credential for device.
 * @return  OC_STACK_OK on success
 */
