 ...
 * @param selectedDeviceList linked list of ownership transfer candidate devices.
 * @param resultCB Result callback function to be invoked when ownership transfer finished.
 ...
 * @param callbackData the implementation of the ownership transfer function for each step.
 * @return OC_STACK_OK in case of success and other value otherwise.
 */
