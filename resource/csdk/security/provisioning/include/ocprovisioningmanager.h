 ...
 * OCMode.
 *
 * @param timeout Timeout in seconds, value till which function will listen to responses from
 *                    client before returning the list of devices.
 * @param ppList List of candidate devices to be provisioned
 ...
 *
 * @param ctx Application context would be returned in result callback
 * @param targetDevices List of devices to perform ownership transfer.
 * @param resultCallback Result callback function to be invoked when ownership transfer finished.
 * @return OC_STACK_OK in case of success and other value otherwise.
 */
 ...
 *
 * @param Ownership transfer method.
 * @param Implementation of callback functions for owership transfer.
 * @return OC_STACK_OK in case of success and other value otherwise.
 */
 ...
 * @param timeout Timeout in seconds, value till which function will listen to responses from
 *                    client before returning the list of devices.
 * @param ppList List of device owned by provisioning tool.
 * @return OTM_SUCCESS in case of success and other value otherwise.
 */
 ...
 *
 * @param ctx Application context would be returned in result callback.
 * @param type Type of credentials to be provisioned to the device.
 * @param pDev1 Pointer to OCProvisionDev_t instance,respresenting device to be provisioned.
 * @param acl ACL for device 1. If this is not required set NULL.
 * @param pDev2 Pointer to OCProvisionDev_t instance,respresenting device to be provisioned.
 * @param acl ACL for device 2. If this is not required set NULL.
 ...
 *
 * @param ctx Application context would be returned in result callback.
 * @param selectedDeviceInfo Selected target device.
 * @param acl ACL to provision.
 * @param resultCallback callback provided by API user, callback will be called when provisioning
 ...
 * @param ctx Application context would be returned in result callback.
 * @param type Type of credentials to be provisioned to the device.
 * @param pDev1 Pointer to OCProvisionDev_t instance,respresenting resource to be provsioned.
   @param pDev2 Pointer to OCProvisionDev_t instance,respresenting resource to be provsioned.
 * @param resultCallback callback provided by API user, callback will be called when
 *            provisioning request recieves a response from first resource server.
 * @return OC_STACK_OK in case of success and other value otherwise.
 */
 ...
 *
 * @param ctx Application context would be returned in result callback
 * @param pTargetDev1 fitst device information to be unlinked.
 * @param pTargetDev2 second device information to be unlinked.
 * @param resultCallback callback provided by API user, callback will be called when
 ...
 *
 * @param ctx Application context would be returned in result callback
 * @param waitTimeForOwnedDeviceDiscovery Maximum wait time for owned device discovery.(seconds)
 * @param pTargetDev Device information to be revoked.
 * @param resultCallback callback provided by API user, callback will be called when
 ...
 *
 * @param waitime Wait time for the API. The wait time will be divided by 2, and half of wait time
 * will be used for unowned discovery and remaining half for owned discovery.
 * @param pOwnedDevList  list of owned devices.
 * @param pUnownedDevList  list of unowned devices.
 * @return OC_STACK_OK in case of success and other value otherwise.
 */
 ...
 *
 * @param pList Pointer to OCProvisionDev_t which should be deleted.
 */
 ...
 *
 * @param pList Pointer to OicUuid_t list which should be deleted.
 */
