...
{
    EXPECT_EQ(OC_STACK_INVALID_PARAM, SRMRegisterHandler(NULL, UTResponseHandler));
}

TEST(RegisterHandlerTest, RegisterNullResponseHandler)
{
    EXPECT_EQ(OC_STACK_INVALID_PARAM, SRMRegisterHandler(UTRequestHandler, NULL));
}

TEST(RegisterHandlerTest, RegisterNullHandler)
{
    EXPECT_EQ(OC_STACK_INVALID_PARAM, SRMRegisterHandler(NULL, NULL));
}
