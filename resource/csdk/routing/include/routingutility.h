...
/**
 * Tag used by routing manager to print routing table and processing
 * of packet.
 */
#define RM_TAG "RAP"
...
/**
 * Copies the Device address of OCDevAddr type to endpoint address of CAEndpoint_t type.
 * @param[in]    in     Address in the form of OCDevAddr structure.
 * @param[out]   out    Address in the form of CAEndpoint_t structure.
 * @return  NONE.
 */
