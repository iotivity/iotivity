...
/**
 * Frees the gateway table memory.
 * @param[in/out] gatewayTable      Gateway Routing Table.
 * @return  ::OC_STACK_OK or Appropriate error code.
 */
...
/**
 * Frees the gateway ID list memory.
...
/**
 * Frees the endpoint table memory.
 * @param[in/out] endpointTable     Endpoint Routing Table.
 * @return  ::OC_STACK_OK or Appropriate error code.
 */
...
OCStackResult RTMAddGatewayEntry(uint32_t gatewayId, uint32_t nextHop, uint32_t routeCost,
                                 RTMDestIntfInfo_t *destInterfaces, u_linklist_t **gatewayTable);
 ...
 * @return  ::OC_STACK_OK or Appropriate error code.
 */
OCStackResult RTMAddEndpointEntry(uint16_t *endpointId, CAEndpoint_t *destAddr,
 ...
 * @return  NONE.
 */
void RTMGetNeighbours(u_linklist_t **neighbourNodes, u_linklist_t *gatewayTable);
 ...
 */
RTMGatewayId_t *RTMGetNextHop(uint32_t gatewayId, u_linklist_t *gatewayTable);
 ...
 */
CAEndpoint_t *RTMGetEndpointEntry(uint16_t endpointId, u_linklist_t *endpointTable);
 ...
 * @return  NONE.
 */
void RTMPrintTable(u_linklist_t *gatewayTable, u_linklist_t *endpointTable);
 ...
 * @return  NONE.
 */
void RTMGetObserverList(OCObservationId **obsList, uint8_t *obsListLen, u_linklist_t *gatewayTable);

/**
 * Gets the list of observer IDs for a Gateway ID.
 * @param[in]        gatewayId              Gateway ID.
 * @param[in/out]    obsList                List of Observation IDs.
 * @param[in]        obsListLen             Length if Observation ID list.
 * @param[in]        gatewayTable           Gateway Routing Table.
 * @return  NONE.
 */
void RTMGetGatewayObserverIds(uint32_t gatewayId, OCObservationId *obsList, uint8_t *obsListLen,
                              u_linklist_t *gatewayTable);
 ...
 * @return  NONE
 */
bool RTMIsObserverPresent(CAEndpoint_t devAddr, OCObservationId *obsID, u_linklist_t *gatewayTable);
...
OCStackResult RTMUpdateEntryParameters(uint32_t gatewayId, uint32_t seqNum,
                                       RTMDestIntfInfo_t *destAdr, u_linklist_t **gatewayTable,
                                       bool forceUpdate);
