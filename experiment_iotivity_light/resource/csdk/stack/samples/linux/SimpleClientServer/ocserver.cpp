...
void *presenceNotificationGenerator(void *param)
{
    sleep(10);
    (void)param;
OCResourceHandle presenceNotificationHandles[numPresenceResources];
    ...
    const char *firmwareVersion, const char* supportUrl, const char* systemTime)
{
    ...
    strncpy(platformInfo.platformID, platformID,
                                sizeof (platformInfo.platformID));
    strncpy(platformInfo.manufacturerName, manufacturerName,
                                sizeof (platformInfo.manufacturerName));
    strncpy(platformInfo.manufacturerUrl, manufacturerUrl,
                                sizeof (platformInfo.manufacturerUrl));
    strncpy(platformInfo.modelNumber, modelNumber,
                                sizeof (platformInfo.modelNumber));
    strncpy(platformInfo.dateOfManufacture, dateOfManufacture,
                                sizeof (platformInfo.dateOfManufacture));
    strncpy(platformInfo.platformVersion, platformVersion,
                                sizeof (platformInfo.platformVersion));
    strncpy(platformInfo.operatingSystemVersion, operatingSystemVersion,
                                sizeof (platformInfo.operatingSystemVersion));
    strncpy(platformInfo.hardwareVersion, hardwareVersion,
                                sizeof (platformInfo.hardwareVersion));
    strncpy(platformInfo.firmwareVersion, firmwareVersion,
                                sizeof (platformInfo.firmwareVersion));
    strncpy(platformInfo.supportUrl, supportUrl,
                                sizeof (platformInfo.supportUrl));
    strncpy(platformInfo.systemTime, systemTime,
...
{
    strncpy(deviceInfo.deviceName, deviceName,
