...
#ifdef WITH_PRESENCE
typedef struct ocresourcetypecb_t
{
    struct ocresourcetypecb_t *next;
    char name[URI_RESOURCE_LENGTH];
} OCResourceTypeCB;
#endif
...
typedef struct ClientCB {
    ...
    char requestUri[URI_RESOURCE_LENGTH];
    ...
    #ifdef WITH_PRESENCE
    OCPresence *presence;
    OCResourceTypeCB *filterResourceType;
    #endif
