 ...
 */
typedef void (*CASendThreadFunc)(CAMessageInfo_t *data);

/**
 * Callback to notify received data from the remote endpoint.
 * @param[in]   data    received data.
 */
typedef void (*CAReceiveThreadFunc)(CAMessageInfo_t *data);
...
typedef struct
{
    ...
    CAMessageInfo_t *sentData;          /**< sent request or response data information. */
 ...
 * @return ::CASTATUS_OK or ERROR CODES (::CAResult_t error codes in cacommon.h).
 */
CAResult_t CAAddSendThreadQueue(const CAMessageInfo_t *messageInfo, const CABlockDataID_t *blockID);
 ...
 * @return ::CASTATUS_OK or ERROR CODES (::CAResult_t error codes in cacommon.h).
 */
CAResult_t CAAddBlockOption(coap_pdu_t **pdu, const CAMessageInfo_t *message);
 ...
 * @return ::CASTATUS_OK or ERROR CODES (::CAResult_t error codes in cacommon.h).
 */
CAResult_t CAUpdatePayloadToCAMessageInfo(CAMessageInfo_t *data, const CAPayload_t payload,
                                   size_t payloadLen);
