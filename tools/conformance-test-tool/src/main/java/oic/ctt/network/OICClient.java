...
public class OICClient {
     ...
     *            Port of the recipient
     */
    public OICResponseData observeResource(OICClient.Protocol protocol,
     ...
     */
    public ArrayList<OICResponseData> getNotifications(
            OICClient.Protocol protocol, String href) {
    ...
    public OICResponseData cancelObserveWithGetMessage(
            OICClient.Protocol protocol, OICHelper.MessageType type,
    ...
    public OICRequestData getLastRequest(OICClient.Protocol protocol) {
