 ...
 */
public final class LogFilterSettingsDialog extends TitleAreaDialog {
    private static final String TITLE           = "Log View Message Filter Settings";
    private static final String DEFAULT_MESSAGE = "Filter log messages by the text or minimum log level.\n"
     ...
     *            .
     */
    public LogFilterSettingsDialog(Shell parentShell) {
        super(parentShell);
        setDefaults("", "", "", LogLevel.DEBUG);
    }
     ...
     *            name for the filter.
     * @param tag
     *            value for filter by tag
     * @param text
     *            value for filter by text
     * @param pid
     *            value for filter by pid
     * @param appName
     *            value for filter by app name
     * @param level
     *            value for filter by log level
     */
    public void setDefaults(String filterName, String tag, String text,
            LogLevel level) {
    ...
    public static List<String> getLogLevels() {
        ...
        for (LogLevel l : LogLevel.values()) {
            if (l == LogLevel.DEBUG || l == LogLevel.ERROR
                    || l == LogLevel.INFO || l == LogLevel.WARN)
