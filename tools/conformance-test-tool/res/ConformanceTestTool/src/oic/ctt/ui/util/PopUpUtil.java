...
public class PopUpUtil {
    ...
    public static final Shell   ACTIVE_WORKBENCH_WINDOW_SHELL = PlatformUI
                                                                      ...
                                                                      .getShell();
    public static final Shell   ACTIVE_SHELL                  = Display
                                                                      .getDefault()
                                                                      .getActiveShell();
    ...
    public static void displayMessageBox(Shell shell, String message,
     ...
     */
    public static void openMessageBox(MessageBox messageBox) {
        messageBox.open();
    }
