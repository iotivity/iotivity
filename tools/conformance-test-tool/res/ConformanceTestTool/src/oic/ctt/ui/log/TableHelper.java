...
public final class TableHelper {
     ...
     *
     * @param parent
     *            The Table parent object
     * @param header
     *            The header string
     * @param style
     *            The column style
     * @param sample_text
     *            A sample text to figure out column width if preference value
     *            is missing
     * @param pref_name
     *            The preference entry name for column width
     * @param prefs
     ...
     *            The column style
     * @param width
     *            the width of the column if the preference value is missing
     * @param pref_name
     *            The preference entry name for column width
     * @param prefs
     *            The preference store
     */
    public static void createTreeColumn(Tree parent, String header, int style,
            int width, final String pref_name, final IPreferenceStore prefs) {
        // create the column
        TreeColumn col = new TreeColumn(parent, style);
        // if there is no pref store or the entry is missing, we use the sample
        // text and pack the column.
