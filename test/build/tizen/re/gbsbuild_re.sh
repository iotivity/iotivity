#----------------------------------------------------------------------
# Main Script For Building RE for Tizen
#----------------------------------------------------------------------
...
rpmPath=$2
target=$4
rpmName="org.tizen.RE_UTC_ITC-0.0.1-1.armv7l.rpm"
targetDir=$secTestDir'/bin/tizen'
buildScriptDir='tizen/re'
isFailed=false
...
mkdir $homeDir/$targetDir

echo $buildScriptDir
echo $homeDir
cp $buildScriptDir/RE_UTC_ITC.spec $tmpDir/packaging
...
cp -R $homeDir/extlibs/cereal/* $tmpDir/iotivity/extlibs/cereal
