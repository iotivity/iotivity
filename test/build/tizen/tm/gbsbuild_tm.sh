#----------------------------------------------------------------------
# Main Script For Building TM for Tizen
#----------------------------------------------------------------------

echo "Creating Temporary Directory TM"
...
rpmPath=$2
target=$4
rpmName="org.tizen.TM_UTC_ITC-0.0.1-1.armv7l.rpm"
targetDir=$secTestDir'/bin/tizen'
buildScriptDir='tizen/tm'
isFailed=false
...
cp $buildScriptDir/TM_UTC_ITC.spec $tmpDir/packaging
