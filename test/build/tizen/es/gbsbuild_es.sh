#----------------------------------------------------------------------
# Main Script For Building ES for Tizen
#----------------------------------------------------------------------

echo "Creating Temporary Directory ES"
...
rpmPath=$2
target=$4
rpmName="org.tizen.ES_UTC_ITC-0.0.1-1.armv7l.rpm"
targetDir=$secTestDir'/bin/tizen'
buildScriptDir='tizen/es'
isFailed=false
...
cp $buildScriptDir/ES_UTC_ITC.spec $tmpDir/packaging
