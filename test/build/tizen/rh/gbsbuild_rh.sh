#----------------------------------------------------------------------
# Main Script For Building RH for Tizen
#----------------------------------------------------------------------

echo "Creating Temporary Directory RH"
...
rpmPath=$2
target=$4
rpmName="org.tizen.RH_UTC_ITC-0.0.1-1.armv7l.rpm"
targetDir=$secTestDir'/bin/tizen'
buildScriptDir='tizen/rh'
isFailed=false
...
cp $buildScriptDir/RH_UTC_ITC.spec $tmpDir/packaging
