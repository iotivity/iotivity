...
class TempHumidResource
{
    ...
    public:
        TempHumidResource() :
            m_temp(100), m_humid(0), m_uri("/a/TempHumSensor3")
        {
        }

        void createResource()
        {
            std::string resourceURI = "/a/TempHumSensor3/nonHostable";
            ...
            {
                m_Rep = get();
                cout << m_temp << " : " << m_humid << " ----------------------" <<endl;
                int temp = 0;
                m_Rep.getValue("temperature", temp);
                cout << "representation temperature = "<< temp << " ----------------------" <<endl;
            }
        }
        ...
        OCStackResult createResource1()
        {
            ...
            std::string resourceTypeName =
                "oic.r.resourcehosting"; // resource type name. In this case, it is light
...
//        }
        ...
        if (requestType == "GET" || requestType == "PUT")
        {
            ...
            if (requestType == "GET")
            {
                ...
                OCRepresentation myRep = myResource.get();
                cout << "representation temperature = "<< myRep.getValue<int>("temperature") << " ----------------------" <<endl;
                pResponse->setResourceRepresentation(myRep);
