...
{
    fprintf(stdout, "===GeneratePinCB===\n");
    fflush(stdout);
    if (NULL == pin || pinSize <= 0)
    {
        fprintf(stdout, "Invalid PIN\n");
        fflush(stdout);
        return;
    }

    fprintf(stdout, "============================\n");
    fprintf(stdout, "    PIN CODE : %s\n", pin);
    fprintf(stdout, "============================");
    fflush(stdout);
    create_file(pin);
}
...
int main()
{
    ...
    fprintf(stdout, "OCServer Random Pin is starting...\n");
    fflush(stdout);
...
int createLEDResource (char *uri, LEDResource *ledResource, bool resourceState, int resourcePower)
{
    ...
    fprintf(stdout, "Created LED resource with result: %s\n", getResult(res));
    fflush(stdout);
