...
public class PMConstants {
    ...
    public static final int RANDOM_PIN_DEFAULT_SIZE = 8;

    public static final int DELAY_SHORT = 1000;                                  // millisecond
    public static final int DISCOVERY_TIMEOUT_05 = 10;
    ...
    public static final String OIC_MOT_CLIENT_CBOR_DB_FILE = "oic_svr_db_subowner_client.dat";
    ...
    public static final String OIC_MOT_SQL_DB_FILE = "MOT_Pdm.db";
    ...
    public static final String ERROR_NOT_SUFFICIENT_DEVICES = "ERROR_NOT_SUFFICIENT_DEVICES";
    public static final String ERROR_ERROR = "ERROR";

    // MOT DEVICES
    public static final int EXPECTED_MOT_DEVICE_COUNT = 1;
    public static final String PRE_CONFIG_PIN = "12341234";

    // Others
    public static final int DEVICE_INDEX_ZERO = 0;
    public static final int DEVICE_INDEX_ONE = 1;
    public static final int EXPECTED_DEVICE_COUNT = 2;
    ...
    public static final String ALL_SERVER_STARTED = "allServerStarted";
}
