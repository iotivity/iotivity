 ...
 *                  5. call OCDiscoverUnownedDevices
 *                  6. call OCDoOwnershipTransfer
 *                  7. call OCDoOwnershipTransfer
 * @post_condition  None
 * @expected        OCDoOwnershipTransfer will return OC_STACK_INVALID_PARAM while calling it second time
 */
#if defined(__LINUX__)
