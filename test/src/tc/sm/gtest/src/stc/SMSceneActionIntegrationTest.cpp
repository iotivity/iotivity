...
TEST_F(SMSceneActionIntegrationTest_stc, ResetWithAttributeAndGetExecutionParameter_GSRV_P)
{
	...
	attribute1[attributeKey] = attributeValue;
	...
	string attributeKey2 = "power";
	string attributeValue2 = "off";
	attribute2[attributeKey2] = attributeValue2;
	try
	{
