...
TEST_F(RICsdkServerTest_btc, OCInit_USV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCInit failed for server. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCInit1Server_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCInit1 failed for server. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCInit1ClientServer_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCInit1 failed for client-server. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCInit1Server_USV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCInit1 failed for server. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCStop_SRC_P)
{
    ...
    m_result = OCStop();
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCStop failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCSetPlatformInfo_SRC_FSV_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCSetPlatformInfo failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCSetPlatformInfo_USV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCSetPlatformInfo failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCCreateResourceTypeName_ESV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCCreateResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCCreateResourceURI_ESV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_URI,m_result) << "OCCreateResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCDeleteResource_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCDeleteResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCDeleteResourceResourceHandle_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCDeleteResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCBindResourceTypeToResource_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCBindResourceTypeToResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCBindResourceTypeToResourceResourceHandle_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_ERROR,m_result) << "OCBindResourceTypeToResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCBindResourceTypeToResourceResourceType_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCBindResourceTypeToResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCBindResourceInterfaceToResource_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCBindResourceInterfaceToResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCBindResourceInterfaceToResourceResourceHandle_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_ERROR,m_result) << "OCBindResourceInterfaceToResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCBindResourceInterfaceToResourceResourceType_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCBindResourceInterfaceToResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCBindResourceCollectionHandle_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_ERROR,m_result) << "OCBindResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCBindResourceSameHandle_ECRC_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCBindResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCUnBindResource_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCUnBindResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCUnBindResourceCollectionHandle_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_ERROR,m_result) << "OCUnBindResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCUnBindResourceSameHandle_ECRC_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCUnBindResource failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCStartPresence_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCStartPresence failed for time 0. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);

    const uint32_t ttl2 = 50;
    m_result = OCStartPresence(ttl2);
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCStartPresence failed for time 10. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCStopPresence_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCStopPresence failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCNotifyAllObserversNON_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_NO_OBSERVERS,m_result) << "OCNotifyAllObservers failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCNotifyAllObserversResourceHandle_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_ERROR,m_result) << "OCNotifyAllObservers failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCNotifyListOfObserversNON_SRC_P)
{
    ...
    m_result = OCNotifyListOfObservers(m_handle,obsIdList,numberOfIds,payload,qos);
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCNotifyListOfObservers failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCNotifyListOfObserversResourceHandle_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_ERROR,m_result) << "OCNotifyListOfObservers failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCDoResponse_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCDoResponse failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCProcess_SRC_P)
{
    ...
    m_result = OCProcess();
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCProcess failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCRegisterPersistentStorageHandler_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCRegisterPersistentStorageHandler failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCRegisterPersistentStorageHandler_USV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCRegisterPersistentStorageHandler failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCBindResourceHandler_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCBindResourceHandler failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCBindResourceHandlerResourceHandle_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCBindResourceHandler failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCGetNumberOfResources_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCGetNumberOfResources failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCGetNumberOfResources_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCGetNumberOfResources failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCGetNumberOfResourceTypes_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCGetNumberOfResourceTypes failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCGetNumberOfResourceTypesResourceHandle_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCGetNumberOfResourceTypes failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCGetNumberOfResourceInterfaces_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCGetNumberOfResourceInterfaces failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCGetNumberOfResourceInterfacesResourceHandle_NV_N)
{
    ...
    ASSERT_EQ(OC_STACK_INVALID_PARAM,m_result) << "OCGetNumberOfResourceInterfaces failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCStartMulticastServer_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCStartMulticastServer failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
...
TEST_F(RICsdkServerTest_btc, OCStopMulticastServer_SRC_P)
{
    ...
    ASSERT_EQ(OC_STACK_OK,m_result) << "OCStopMulticastServer failed. Actual m_result : " << CommonUtil::s_OCStackResultString.at(m_result);
}
#endif
