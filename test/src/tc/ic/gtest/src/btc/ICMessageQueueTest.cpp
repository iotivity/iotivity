 ...
 * @post_condition None
 * @expected createMQTopic that's provide OC_STACK_OK
 **/
...
{
    EXPECT_ANY_THROW(m_OCResource->createMQTopic(m_rep, INVALID_INPUT, m_queryParametersMap, &foundResource, m_qos))<<"CreateMQTopic is creating Topic into MQ Broker with invalid string as topic uri";
}
#endif
 ...
 * @post_condition None
 * @expected requestMQPublish that's provide OC_STACK_OK
 **/
#if defined(__LINUX__) || defined(__TIZEN__)
 ...
 * @post_condition None
 * @expected subscribeMQTopic that's provide OC_STACK_OK
 **/
#if defined(__LINUX__) || defined(__TIZEN__)
 ...
 * @post_condition None
 * @expected unsubscribeMQTopic that's provide OC_STACK_OK
 **/
#if defined(__LINUX__) || defined(__TIZEN__)
 ...
 * @post_condition None
 * @expected publishMQTopic that's provide OC_STACK_OK
 **/
#if defined(__LINUX__) || defined(__TIZEN__)
