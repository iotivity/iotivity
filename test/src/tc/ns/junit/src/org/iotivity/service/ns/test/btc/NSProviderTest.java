...
public class NSProviderTest extends InstrumentationTestCase {
    ...
    public void testStartProviderWithProviderAcceptor_SRC_P() {
        try {
            int result = mProviderService.start(mHelper, mHelper, true,
    ...
    public void testStartProviderWithConsumerAcceptor_SRC_P() {
        try {
            int result = mProviderService.start(mHelper, mHelper, false,
                    USER_INFO, IS_SECURED);
    ...
    public void testUnregisterTopic_USV_N() {
        try {
            ...
            mHelper.setProviderStartStatus(true);
            assertNotSame(
                    "Should not return NS_OK when the topic is not registered.",
                    NS_OK, mProviderService.unregisterTopic(TOPIC_NAME));
        } catch (NSException e) {
            fail("Exception occurs when calling unregisterTopic() API");
        }
    }
    ...
    public void testAcceptSubscription_SRC_P() {
        ...
        try {
            assertEquals("Should throw NS_OK", NS_OK,
    ...
    public void testSetTopic_SRC_P() {
        ...
        try {
            assertEquals("Should return NS_OK", NS_OK,
    ...
    public void testSetTopic_USV_N() {
        ...
        try {
            assertNotSame("Should not return NS_OK", NS_OK,
                    consumer.setTopic(TOPIC_NAME));
        } catch (Exception e) {
            fail("Exception occurs when calling setTopic() API. Exception is : "
                    + e.getLocalizedMessage());
