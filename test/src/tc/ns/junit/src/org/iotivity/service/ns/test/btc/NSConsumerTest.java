...
public class NSConsumerTest extends InstrumentationTestCase {
  ...
  public void testGetProviderID_SRC_P() {
    ...
    try {
      assertNotSame("ProviderID should not be empty", 0, provider
          .getProviderId().length());
    } catch (Exception e) {
   ...
   *                5. Wait for Provider Discovered Callback
   *                6. Get Provider from callback
   *                7. Register Topic ("TestTopic")
   * @procedure Perform getTopicList() API
   * @post_condition None
   * @expected 1. No exception occurs 2. Should get the topic list which is not
   *           empty
   */
  public void testGetTopicList_SRC_P() {
    ...
    try {
      ...
      assertNotSame("TopicList should not empty.", 0, topicList.mTopicsList.size());
    } catch (Exception e) {
      fail("Exception occurs when calling getProviderId() API. Exception is : "
          + e.getLocalizedMessage());
    }
  ...
  public void testGetProviderState_SRC_P() {
    ...
    try {
      ...
      if (providerState == ProviderState.ALLOW || providerState == ProviderState.DENY || providerState == ProviderState.TOPIC) {
  ...
  public void testIsSubscribe_SRC_P() {
    ...
    try {
      assertEquals("Should not subscribed, before subscription", false, provider.isSubscribed());
    } catch (Exception e) {
      fail("Exception occurs when calling subscribe() API. Exception is : "
          + e.getLocalizedMessage());
    }
   ...
   * @test_data OnProviderStateListener, OnMessageReceivedListner, OnSyncInfoReceivedListner
   * @pre_condition 1. Get Provider Service Instance
   *                2. Start Provider with consumer acceptor
   *                3. Get Consumer Service Instance
   *                4. Start Consumer Service
   ...
   * @since 2016-10-03
   * @see none
   * @objective Test 'setListener()' function with null OnProviderStateListener
   * @target void setListener(OnProviderStateListener onProviderStateListener,
   *                        OnMessageReceivedListner onMessageReceivedListner,
   *                        OnSyncInfoReceivedListner onSyncInfoReceivedListner)
   * @test_data OnProviderStateListener = null, OnMessageReceivedListner, OnSyncInfoReceivedListner
   * @pre_condition 1. Get Provider Service Instance
   *                2. Start Provider with consumer acceptor
   *                3. Get Consumer Service Instance
   *                4. Start Consumer Service
   ...
   * @since 2016-10-03
   * @see none
   * @objective Test 'setListener()' function with null OnMessageReceivedListner
   * @target void setListener(OnProviderStateListener onProviderStateListener,
   *                        OnMessageReceivedListner onMessageReceivedListner,
   *                        OnSyncInfoReceivedListner onSyncInfoReceivedListner)
   * @test_data OnProviderStateListener, OnMessageReceivedListner = null, OnSyncInfoReceivedListner
   * @pre_condition 1. Get Provider Service Instance
   *                2. Start Provider with consumer acceptor
   *                3. Get Consumer Service Instance
   *                4. Start Consumer Service
   ...
   * @since 2016-10-03
   * @see none
   * @objective Test 'setListener()' function with null OnSyncInfoReceivedListner
   * @target void setListener(OnProviderStateListener onProviderStateListener,
   *                        OnMessageReceivedListner onMessageReceivedListner,
   *                        OnSyncInfoReceivedListner onSyncInfoReceivedListner)
   * @test_data OnProviderStateListener, OnMessageReceivedListner, OnSyncInfoReceivedListner = null
   * @pre_condition 1. Get Provider Service Instance
   *                2. Start Provider with consumer acceptor
   *                3. Get Consumer Service Instance
   *                4. Start Consumer Service
  ...
  public void testUpdateTopicList_SRC_P() {
    ...
    try {
      ...
      assertEquals("Should return NS_OK(100)", NS_OK, provider.updateTopicList(topicList));
    } catch (Exception e) {
      fail("Exception occurs when calling getProviderId() API. Exception is : "
          + e.getLocalizedMessage());
    }
