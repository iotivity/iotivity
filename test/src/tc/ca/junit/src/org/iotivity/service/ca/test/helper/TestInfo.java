...
public class TestInfo {
	...
	public static final int CA_GET = 0;
	public static final int CA_POST = 1;
	public static final int CA_PUT = 2;
	public static final int CA_DELETE = 3;
	...
	public static final int URI_TYPE_WRONG_ENDPOINT = -2;
	...
	public static final int TOTAL_MESSAGE = 0;
	...
	public static final int NETWORK_TYPE_LOBV_INVALID = -1;
	public static final long NETWORK_TYPE_UOBV_INVALID = 4294967296L;
	public static final int NETWORK_TYPE_CA_DEFAULT_ADAPTER = 2;
	public static final int NETWORK_TYPE_CA_ALL_ADAPTERS = 3;
	public static final int NETWORK_TYPE_DEFAULT_VALUE = 0;

	public static final int Get_NETWORK_INFO_WITHOUT_INIT = 0;
	public static final int Get_NETWORK_INFO_UFV_SIZE = 1;
	public static final int Get_NETWORK_INFO_UFV_INFO = 2;

	public static final int CREATE_ENDPOINT_INVALID_FLAG = 0;
	public static final int CREATE_ENDPOINT_INVALID_ADAPTER = 1;
	public static final int CREATE_ENDPOINT_INVALID_ADDRESS = 2;
	public static final int CREATE_ENDPOINT_INVALID_PORT = 3;
	public static final int CREATE_ENDPOINT_INVALID_ENDPOINT = 4;
	public static final int CREATE_ENDPOINT_ESV_ADDRESS = 5;
	public static final int CREATE_ENDPOINT_URV_ENDPOINT = 6;
