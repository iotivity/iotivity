...
public class CATest extends AndroidTestCase {
	...
	public void testCAInitialize_P() {
		boolean status = MainActivity.RM.initialize();
	...
	public void testCARegisterHandler_P() {
		...
		if (!MainActivity.RM.registerServerHandler()) {
			fail();
		}
	...
	public void testCAGenerateToken_P() {
		...
		if (!MainActivity.RM.generateToken()) {
			fail();
			MainActivity.RM.terminate();
			return;
		}

		MainActivity.RM.destroyToken();
		MainActivity.RM.terminate();
	}
	...
	public void testCAGenerateToken_LBV_P() {
		...
		if (!MainActivity.RM.generateCustomToken(TOKEN_LENGTH_LBV_VALID,
				CA_STATUS_OK)) {
			fail();
		} else {
			MainActivity.RM.destroyToken();
	...
	public void testCAGenerateToken_LOBV_N() {
		...
		if (!MainActivity.RM.generateCustomToken(TOKEN_LENGTH_LOBV_INVALID,
	...
	public void testCAGenerateToken_UOBV_N() {
		...
		if (!MainActivity.RM.generateCustomToken(TOKEN_LENGTH_UOBV_INVALID,
				CA_STATUS_INVALID_PARAM)) {
			fail();
		}
	...
	public void testCAGenerateToken_UFRV_N() {
		...
		if (!MainActivity.RM.generateCustomToken(TOKEN_TYPE_INVALID_REFERENCE,
				CA_STATUS_INVALID_PARAM)) {
			fail();
		}
	...
	public void testCASelectNetwork_LBV_P() {
		...
		if (!MainActivity.RM.selectNetworkWithExpectedResult(
				NETWORK_TYPE_CA_DEFAULT_ADAPTER, CA_NOT_SUPPORTED)) {
			fail();
		}
	...
	public void testCASelectNetwork_UBV_P() {
		...
		if (!MainActivity.RM.selectNetworkWithExpectedResult(
				NETWORK_TYPE_CA_ALL_ADAPTERS, CA_STATUS_OK)) {
			fail();
		}
	...
	public void testCASelectNetwork_N() {
		...
		if (MainActivity.RM.selectCustomNetwork(NETWORK_TYPE_DEFAULT_VALUE)) {
			fail();
		}
	...
	public void testCASelectNetwork_LOBV_N() {
		...
		if (!MainActivity.RM.selectNetworkWithExpectedResult(-1, CA_STATUS_OK)) {
			fail();
		}
	...
	public void testCASelectNetwork_UOBV_N() {
		...
		if (!MainActivity.RM.selectNetworkWithExpectedResult(4294967296L,
				CA_NOT_SUPPORTED)) {
			fail();
		}
	...
	public void testCAUnSelectNetwork_UBV_P() {
		...
		if (!MainActivity.RM.unSelectNetworkWithExpectedResult(
				NETWORK_TYPE_CA_ALL_ADAPTERS, CA_STATUS_OK)) {
			fail();
		}
	...
	public void testCAUnSelectNetwork_N() {
		...
		if (MainActivity.RM.unSelectCustomNetwork(NETWORK_TYPE_DEFAULT_VALUE)) {
			fail();
		}
	...
	public void testCAHandleRequestResponse_P() {
		...
		if (!MainActivity.RM.handleRequestResponse()) {
			fail();
		}
	...
	public void testCAStartListeningServerWithoutSelectingNetwork_ECRC_N() {
		...
		if (!MainActivity.RM.startListeningServerCustom(CA_STATUS_FAILED)) {
			fail();
		}
	...
	public void testCAStopListeningServerWithoutSelectingNetwork_ECRC_N() {
		...
		if (!MainActivity.RM.stopListeningServer(CA_STATUS_FAILED)) {
			fail();
		}
	...
	public void testCAStartDiscoveryServerWithoutSelectingNetwork_ECRC_N() {
		...
		if (!MainActivity.RM.startDiscoveryWithExpectedResult(CA_STATUS_FAILED)) {
			fail();
		}
	...
	public void testCACreateEndpoint_Adapter_ECRC_N() {
		if (!MainActivity.RM.createEndpointWithExpectedResult(
				CREATE_ENDPOINT_INVALID_ADAPTER, CA_STATUS_FAILED)) {
			fail();
		}
	}
}
