...
public class CALeClientTest extends AndroidTestCase {

	private static final int NETWORK = 2;
	private static final String ADDRESS = "E8:0A:E2:87:D5:06";
	private static final String[] addressSet = { "68:05:71:C3:EA:03",
			"E8:0A:E2:87:D5:06" };

	public CALeClientTest() {
	}
	...
	public void testLeSelectNetworkForIncomingMessages_P() {
		MainActivity.RM.setRemoteAddressSet(addressSet);
		if (!MainActivity.RM.establishConnectionWithServer()) {
			fail();
			return;
		}
