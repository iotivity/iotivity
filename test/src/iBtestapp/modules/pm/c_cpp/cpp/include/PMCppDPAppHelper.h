...
#ifndef PMCppDPAppHelper_H_
#define PMCppDPAppHelper_H_
...
void resultCallback(std::shared_ptr< OCDirectPairing > ptr, OCStackResult result);
...
std::string getDpOCStackResult(OCStackResult ocstackresult);
